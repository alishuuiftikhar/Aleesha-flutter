...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m2(length) =>
      "Media lagt til i spillelisten. ${length} nytt element(er) lagt til.";

  static String m3(attribute) => "Hvilken som helst ${attribute}";

  static String m4(point) => "Tilgjengelige poeng: ${point}";

  static String m5(name) => "Du har lagt inn et bud på \'${name}\'";

  static String m6(id) => "Bestilling #${id}";

  static String m7(date) => "Bestilling forespurt: ${date}";

  static String m8(amount) => "Kjøp nå for ${amount}";

  static String m9(author) => "Av: ${author}";

  static String m10(fieldName) => "${fieldName} må være minst 3 tegn lang.";

  static String m11(currency) => "Endret valuta til ${currency}";

  static String m12(number) => "${number} tegn gjenstår";

  static String m13(date) => "Innsjekking: ${date}";

  static String m14(date) => "Utsjekking: ${date}";

  static String m15(priceRate, pointRate) =>
      "${priceRate} = ${pointRate} poeng";

  static String m16(count) => "${count} gjest";

  static String m17(count) => "${count} gjester";

  static String m18(count) => "${count} vare";

  static String m19(count) => "${count} varer";

  static String m20(count) => "${count} produkt";

  static String m21(count) => "${count} produkter";

  static String m22(count) => "${count} billett";

  static String m23(count) => "${count} billetter";

  static String m24(country) => "Landet ${country} støttes ikke";

  static String m25(currency) => "${currency} støttes ikke";
  ...
  static String m29(captcha) => "Skriv inn ${captcha} for å bekrefte";

  static String m30(message) => "Feil: ${message}";

  static String m31(message) => "Feil: ${message}";

  static String m32(error) => "En feil oppstod: ${error}";

  static String m33(date) => "Arrangementdato: ${date}";

  static String m34(time) => "Utløper om ${time}";
  ...
  static String m40(count) => "Maksimalt ${count} gjester tillatt";

  static String m41(maxQuantity) =>
      "Maksimalt tillatt antall i handlekurven er ${maxQuantity}";
  ...
  static String m44(count) => "Minimum ${count} tegn kreves";
  ...
  static String m46(day) => "Minimumsopphold er ${day} dager";

  static String m47(amount) =>
      "Denne kupongen krever et minimumskjøp på ${amount}.";

  static String m48(value) => "Min. transaksjon: ${value}";

  static String m49(count) => "Minimum ${count} gjest(er) kreves";

  static String m50(store) => "Mer fra ${store}";

  static String m51(number) => "Må kjøpes i grupper på ${number}";

  static String m52(itemCount) => "${itemCount} varer";

  static String m53(amount) => "Betal ${amount}";

  static String m54(date) => "Betaling forfaller: ${date}";

  static String m55(name) => "${name} er lagt til i handlekurven";

  static String m56(total) => "Antall: ${total}";

  static String m57(name) => "Mottok penger fra ${name}";

  static String m58(count) =>
      "Vil du fjerne ${count} element(er) fra ønskelisten din?";

  static String m59(percent) => "Salg ${percent}%";

  static String m60(keyword, count) => "${keyword} (${count} element)";

  static String m61(keyword, count) => "${keyword} (${count} elementer)";
  ...
  static String m64(price) => "Fra ${price}";

  static String m65(fieldName) => "Feltet ${fieldName} er påkrevd";

  static String m66(total) => "${total} produkter";

  static String m67(name) => "Overfør penger til ${name}";

  static String m68(price) => "Opptil ${price}";

  static String m69(amount) => "Bruk ${amount} poeng";
  ...
  static String m71(time) => "Gyldig til: ${time}";

  static String m72(date) => "Gyldig til ${date}";

  static String m73(number) => "Versjon ${number}";
  ...
  static String m77(week) => "Uke ${week}";

  static String m78(name) => "Velkommen ${name}";

  static String m79(count) => "Du har valgt ${count} element(er)";

  static String m80(type) => "Du har bestått ${type}";

  static String m81(point) => "Du har ${point} poeng";

  static String m82(price) => "Du sparte ${price}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "approvedPaid": MessageLookupByLibrary.simpleMessage("Godkjent - Betalt"),
    ...
    "auctionItemDidNotMakeItToReservePrice":
        MessageLookupByLibrary.simpleMessage(
          "Auksjonsobjektet nådde ikke reserveprisen",
        ),
    ...
    "bookingDate": MessageLookupByLibrary.simpleMessage("Bestillingsdato"),
    ...
    "bookingID": m6,
    "bookingLocation": MessageLookupByLibrary.simpleMessage("Bestillingssted"),
    ...
    "cancelBookingFailed": MessageLookupByLibrary.simpleMessage(
      "Kunne ikke kansellere bestillingen.",
    ),
    ...
    "catalogVisibilityTooltip": MessageLookupByLibrary.simpleMessage(
      "Denne innstillingen bestemmer hvilke butikksider produktene vil bli listet på.",
    ),
    ...
    "characterRemain": m12,
    "chargeBack": MessageLookupByLibrary.simpleMessage("Tilbakebetaling"),
    ...
    "couponRemove": MessageLookupByLibrary.simpleMessage("Kupong fjernet"),
    ...
    "createIndex": MessageLookupByLibrary.simpleMessage("Opprett indeks"),
    ...
    "deleteBooking": MessageLookupByLibrary.simpleMessage("Slett bestilling"),
    "deleteBookingFailed": MessageLookupByLibrary.simpleMessage(
      "Kunne ikke slette bestillingen.",
    ),
    ...
    "denied": MessageLookupByLibrary.simpleMessage("Avslått"),
    ...
    "failedToCreateReview": MessageLookupByLibrary.simpleMessage(
      "Kunne ikke opprette anmeldelse",
    ),
    ...
    "featureImage": MessageLookupByLibrary.simpleMessage("Fremhevet bilde"),
    ...
    "finalCost": MessageLookupByLibrary.simpleMessage("Endelig kostnad"),
    ...
    "getTicket": MessageLookupByLibrary.simpleMessage("Hent billett"),
    ...
    "messageToListingOwner": MessageLookupByLibrary.simpleMessage(
      "Din korte melding til annonsens eier (valgfritt)",
    ),
    ...
    "missingFirestoreIndexDescription": MessageLookupByLibrary.simpleMessage(
      "Denne forespørselen krever en indeks. Logg inn på Firebase-konsollen og opprett indeksen ved å klikke på knappen nedenfor. Du må vente et øyeblikk før den blir aktivert.",
    ),
    ...
    "network": MessageLookupByLibrary.simpleMessage("Nettverk"),
    ...
    "noMembershipPlans": MessageLookupByLibrary.simpleMessage(
      "Ingen medlemsplaner tilgjengelig",
    ),
    ...
    "onHold": MessageLookupByLibrary.simpleMessage("På vent"),
    ...
    "pendingPayment": MessageLookupByLibrary.simpleMessage("Avventer betaling"),
    ...
    "pleaseAdjustYourCart": MessageLookupByLibrary.simpleMessage(
      "Vennligst juster handlekurven før du går til betaling.",
    ),
    ...
    "quantityMustBeGreaterThanZero": MessageLookupByLibrary.simpleMessage(
      "Antallet må være større enn null",
    ),
    ...
    "refunded": MessageLookupByLibrary.simpleMessage("Refundert"),
    ...
    "reversed": MessageLookupByLibrary.simpleMessage("Reversert"),
    ...
    "sale": m59,
    "saleFromDate": MessageLookupByLibrary.simpleMessage("Salgsdato fra"),
    "salePrice": MessageLookupByLibrary.simpleMessage("Salgspris"),
    "saleToDate": MessageLookupByLibrary.simpleMessage("Salgsdato til"),
    "saleToDateCannotBeEarlier": MessageLookupByLibrary.simpleMessage(
      "Salgsdato til kan ikke være tidligere enn salgsdato fra.",
    ),
    ...
    "scheduleSale": MessageLookupByLibrary.simpleMessage("Planlegg salg"),
    ...
    "totalCost": MessageLookupByLibrary.simpleMessage("Total kostnad"),
    ...
    "voided": MessageLookupByLibrary.simpleMessage("Annullert"),
    ...
    "waitingOwnerConfirmation": MessageLookupByLibrary.simpleMessage(
      "Venter på bekreftelse fra eier",
    ),
    ...
    "writeTitleOptional": MessageLookupByLibrary.simpleMessage(
      "Skriv inn tittelen din (valgfritt)",
    ),
    ...
    "yourRating": MessageLookupByLibrary.simpleMessage("Din vurdering"),
