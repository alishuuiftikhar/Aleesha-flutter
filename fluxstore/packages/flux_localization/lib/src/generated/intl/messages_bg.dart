...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m2(length) =>
      "Медията беше добавена към плейлиста. ${length} нови елемента добавени.";

  static String m3(attribute) => "Всякакъв ${attribute}";

  static String m4(point) => "Налични точки: ${point}";

  static String m5(name) => "Успешно направихте оферта за \'${name}\'";

  static String m6(id) => "Резервация №${id}";

  static String m7(date) => "Заявка за резервация на: ${date}";

  static String m8(amount) => "Купете сега за ${amount}";

  static String m9(author) => "От ${author}";

  static String m10(fieldName) =>
      "Дължината на ${fieldName} не трябва да е по-малка от 3.";

  static String m11(currency) => "Валутата е променена на ${currency}";

  static String m12(number) => "Остават ${number} знака";

  static String m13(date) => "Настаняване: ${date}";

  static String m14(date) => "Освобождаване: ${date}";

  static String m15(priceRate, pointRate) =>
      "${priceRate} = ${pointRate} точки";

  static String m16(count) => "${count} гост";

  static String m17(count) => "${count} гости";

  static String m18(count) => "${count} артикул";

  static String m19(count) => "${count} артикула";

  static String m20(count) => "${count} продукт";

  static String m21(count) => "${count} продукта";

  static String m22(count) => "${count} билет";

  static String m23(count) => "${count} билета";

  static String m24(country) => "${country} не се поддържа";

  static String m25(currency) => "${currency} не се поддържа";
  ...
  static String m28(timeLeft) => "Завършва след ${timeLeft}";

  static String m29(captcha) => "Въведете ${captcha} за потвърждение:";

  static String m30(message) => "Грешка: ${message}";

  static String m31(message) => "Грешка: ${message}";

  static String m32(error) => "Възникна грешка: ${error}";

  static String m33(date) => "Дата на събитието: ${date}";

  static String m34(time) => "Изтича след ${time}";
  ...
  static String m39(size) => "Максимален размер на файла: ${size} MB";

  static String m40(count) => "Позволени са максимум ${count} гости";

  static String m41(maxQuantity) =>
      "Максималното позволено количество в количката е ${maxQuantity}";
  ...
  static String m44(count) => "Изискват се минимум ${count} знака";
  ...
  static String m46(day) => "Минималният престой е ${day} дни";

  static String m47(amount) =>
      "Този купон изисква минимална покупка от ${amount}.";

  static String m48(value) => "Минимална транзакция: ${value}";

  static String m49(count) => "Изискват се минимум ${count} гост(и)";

  static String m50(store) => "Още от ${store}";

  static String m51(number) => "трябва да се купува в групи по ${number}";

  static String m52(itemCount) => "${itemCount} продукта";

  static String m53(amount) => "Платете ${amount}";

  static String m54(date) => "Плащане до: ${date}";

  static String m55(name) => "${name} е добавен успешно в количката";

  static String m56(total) => "Количество: ${total}";

  static String m57(name) => "Получени пари от ${name}";

  static String m58(count) =>
      "Искате ли да премахнете ${count} артикула от вашия списък с желания?";

  static String m59(percent) => "Разпродажба ${percent}%";

  static String m60(keyword, count) => "${keyword} (${count} резултат)";

  static String m61(keyword, count) => "${keyword} (${count} резултата)";

  static String m62(totalCartQuantity) =>
      "Количка, ${totalCartQuantity} продукта";

  static String m63(numberOfUnitsSold) => "Продадени: ${numberOfUnitsSold}";

  static String m64(price) => "Започва от ${price}";

  static String m65(fieldName) => "Полето ${fieldName} е задължително";

  static String m66(total) => "${total} продукта";

  static String m67(name) => "Прехвърляне на пари към ${name}";

  static String m68(price) => "До ${price}";

  static String m69(amount) => "Използвайте ${amount} точки";
  ...
  static String m71(time) => "Валидно до: ${time}";

  static String m72(date) => "Валиден до ${date}";

  static String m73(number) => "Версия ${number}";

  static String m74(balance) => "Баланс в портфейла: ${balance}";

  static String m75(message) => "Предупреждение: ${message}";
  ...
  static String m77(week) => "Седмица ${week}";

  static String m78(name) => "Добре дошли, ${name}";

  static String m79(count) => "Избирате ${count} артикул(а)";

  static String m80(type) => "Вие преминахте ${type}";

  static String m81(point) => "Имате ${point} точки";

  static String m82(price) => "Спестихте ${price}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "approvedPaid": MessageLookupByLibrary.simpleMessage("Одобрено - платено"),
    ...
    "auctionItemDidNotMakeItToReservePrice":
        MessageLookupByLibrary.simpleMessage(
          "Артикулът на търга не достигна резервната цена",
        ),
    ...
    "bookingDate": MessageLookupByLibrary.simpleMessage("Дата на резервацията"),
    "bookingDeletedSuccessfully": MessageLookupByLibrary.simpleMessage(
      "Резервацията беше успешно изтрита",
    ),
    ...
    "cancelBookingFailed": MessageLookupByLibrary.simpleMessage(
      "Неуспешно анулиране на резервацията.",
    ),
    ...
    "cannotGetPaymentURL": MessageLookupByLibrary.simpleMessage(
      "Не може да се получи URL за плащане",
    ),
    ...
    "catalogVisibilityTooltip": MessageLookupByLibrary.simpleMessage(
      "Тази настройка определя на кои страници на магазина ще бъдат показвани продуктите.",
    ),
    ...
    "characterRemain": m12,
    "chargeBack": MessageLookupByLibrary.simpleMessage("Обратно начисление"),
    ...
    "completed": MessageLookupByLibrary.simpleMessage("Завършено"),
    ...
    "couponRemove": MessageLookupByLibrary.simpleMessage(
      "Купонът беше премахнат успешно",
    ),
    ...
    "createIndex": MessageLookupByLibrary.simpleMessage("Създай индекс"),
    ...
    "deleteBookingFailed": MessageLookupByLibrary.simpleMessage(
      "Неуспешно изтриване на резервацията.",
    ),
    ...
    "denied": MessageLookupByLibrary.simpleMessage("Отказано"),
    ...
    "failed": MessageLookupByLibrary.simpleMessage("Неуспешно"),
    "failedToCreateReview": MessageLookupByLibrary.simpleMessage(
      "Неуспешно създаване на ревю",
    ),
    ...
    "featureImage": MessageLookupByLibrary.simpleMessage("Избрано изображение"),
    ...
    "finalCost": MessageLookupByLibrary.simpleMessage("Крайна цена"),
    ...
    "getTicket": MessageLookupByLibrary.simpleMessage("Вземи билет"),
    ...
    "haveACoupon": MessageLookupByLibrary.simpleMessage("Имате купон?"),
    "haveYouGotQuestion": MessageLookupByLibrary.simpleMessage(
      "Имате въпрос? Пишете ни!",
    ),
    "hidden": MessageLookupByLibrary.simpleMessage("Скрито"),
    ...
    "messageToListingOwner": MessageLookupByLibrary.simpleMessage(
      "Вашето кратко съобщение до собственика на обявата (по избор)",
    ),
    ...
    "missingFirestoreIndexDescription": MessageLookupByLibrary.simpleMessage(
      "Тази заявка изисква индекс. Моля, влезте в Firebase конзолата и създайте индекса, като натиснете бутона по-долу. Трябва да изчакате малко, докато бъде активиран.",
    ),
    "missingFirestoreIndexTitle": MessageLookupByLibrary.simpleMessage(
      "Открит липсващ Firestore индекс!",
    ),
    ...
    "noMembershipPlans": MessageLookupByLibrary.simpleMessage(
      "Няма налични абонаментни планове",
    ),
    ...
    "onHold": MessageLookupByLibrary.simpleMessage("Задържан"),
    ...
    "pendingPayment": MessageLookupByLibrary.simpleMessage("Изчаква плащане"),
    ...
    "pleaseAdjustYourCart": MessageLookupByLibrary.simpleMessage(
      "Моля, коригирайте количката си преди да продължите към плащане.",
    ),
    ...
    "processed": MessageLookupByLibrary.simpleMessage("Обработено"),
    ...
    "quantityMustBeGreaterThanZero": MessageLookupByLibrary.simpleMessage(
      "Количество трябва да е по-голямо от нула",
    ),
    "quantityProductExceedInStock": MessageLookupByLibrary.simpleMessage(
      "Избраното количество надвишава наличното",
    ),
    "quoteLabel": MessageLookupByLibrary.simpleMessage("Оферта"),
    ...
    "refunded": MessageLookupByLibrary.simpleMessage("Възстановено"),
    ...
    "reversed": MessageLookupByLibrary.simpleMessage("Обратно"),
    ...
    "shopAndSearchResults": MessageLookupByLibrary.simpleMessage(
      "Магазин и резултати от търсенето",
    ),
    ...
    "shopOnly": MessageLookupByLibrary.simpleMessage("Само магазин"),
    ...
    "totalCost": MessageLookupByLibrary.simpleMessage("Обща цена"),
    ...
    "verifiedListing": MessageLookupByLibrary.simpleMessage("Проверена обява"),
    ...
    "voided": MessageLookupByLibrary.simpleMessage("Анулирано"),
    ...
    "waitingOwnerConfirmation": MessageLookupByLibrary.simpleMessage(
      "Изчаква потвърждение от собственика",
    ),
    ...
    "writeTitleOptional": MessageLookupByLibrary.simpleMessage(
      "Напишете заглавието си (по избор)",
    ),
    ...
    "yourRating": MessageLookupByLibrary.simpleMessage("Вашата оценка"),
