...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m2(length) =>
      "Medya oynatma listesine eklendi. ${length} yeni öğe eklendi.";

  static String m3(attribute) => "Herhangi bir ${attribute}";

  static String m4(point) => "Mevcut puanlarınız: ${point}";

  static String m5(name) => "\'${name}\' için teklif başarıyla verildi";

  static String m6(id) => "Rezervasyon #${id}";

  static String m7(date) => "Rezervasyon talebi: ${date}";

  static String m8(amount) => "Şimdi ${amount}karşılığında satın alın";

  static String m9(author) => "Yazar: ${author}";

  static String m10(fieldName) => "${fieldName} en az 3 karakter olmalıdır";

  static String m11(currency) => "Para birimi ${currency} olarak değiştirildi";

  static String m12(number) => "${number} karakter kaldı";

  static String m13(date) => "Giriş: ${date}";

  static String m14(date) => "Çıkış: ${date}";

  static String m15(priceRate, pointRate) => "${priceRate} = ${pointRate} Puan";

  static String m16(count) => "${count} Misafir";

  static String m17(count) => "${count} Misafir";

  static String m18(count) => "${count} ürün";

  static String m19(count) => "${count} ürün";

  static String m20(count) => "${count} ürün";
  ...
  static String m24(country) => "${country} desteklenmiyor";

  static String m25(currency) => "${currency} desteklenmiyor";
  ...
  static String m28(timeLeft) => "Biter: ${timeLeft}";

  static String m29(captcha) => "Doğrulamak için ${captcha} girin:";

  static String m30(message) => "Hata: ${message}";

  static String m31(message) => "Hata: ${message}";

  static String m32(error) => "Bir hata oluştu: ${error}";

  static String m33(date) => "Etkinlik Tarihi: ${date}";

  static String m34(time) => "${time} içinde sona eriyor";
  ...
  static String m39(size) => "Maksimum dosya boyutu: ${size} MB";

  static String m40(count) => "En fazla ${count} misafir kabul edilir";

  static String m41(maxQuantity) =>
      "Sepette izin verilen maksimum adet ${maxQuantity}";
  ...
  static String m44(count) => "En az ${count} karakter gerekli";
  ...
  static String m46(day) => "Minimum konaklama süresi ${day} gündür";

  static String m47(amount) =>
      "Bu kuponu kullanabilmek için minimum ${amount}tutarında alışveriş yapmanız gerekiyor.";

  static String m48(value) => "Min işlem: ${value}";

  static String m49(count) => "En az ${count} misafir gereklidir";

  static String m50(store) => "${store} mağazasından daha fazlası";

  static String m51(number) =>
      "${number} adetlik gruplar halinde satın alınmalıdır";

  static String m52(itemCount) => "${itemCount} ürün";

  static String m53(amount) => "${amount} ile öde";

  static String m54(date) => "Ödeme tarihi: ${date}";

  static String m55(name) => "${name} sepete eklendi";

  static String m56(total) => "Adet: ${total}";

  static String m57(name) => "${name} tarafından para alındı";

  static String m58(count) =>
      "İstek listenizden ${count} ürünü kaldırmak istiyor musunuz?";

  static String m59(percent) => "%${percent} İndirim";

  static String m60(keyword, count) => "${keyword} (${count} ürün)";

  static String m61(keyword, count) => "${keyword} (${count} ürün)";

  static String m62(totalCartQuantity) => "Sepet, ${totalCartQuantity} ürün";

  static String m63(numberOfUnitsSold) => "Satıldı: ${numberOfUnitsSold}";

  static String m64(price) => "${price} başlangıç fiyatı";

  static String m65(fieldName) => "${fieldName} alanı zorunludur";

  static String m66(total) => "${total} ürün";

  static String m67(name) => "${name} hesabına para transferi";

  static String m68(price) => "En fazla ${price}";

  static String m69(amount) => " ${amount} puan kullan";
  ...
  static String m71(time) => "Geçerlilik tarihi: ${time}";

  static String m72(date) => "${date} tarihine kadar geçerli";

  static String m73(number) => "Sürüm ${number}";

  static String m74(balance) => "Cüzdan bakiyesi: ${balance}";

  static String m75(message) => "Uyarı: ${message}";
  ...
  static String m78(name) => "Hoş geldin ${name}";

  static String m79(count) => "${count} ürün seçiyorsunuz";

  static String m80(type) => " ${type}geçtiniz";

  static String m81(point) => "${point} Puanınız Var";

  static String m82(price) => "${price} kadar tasarruf ettiniz";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "approvedPaid": MessageLookupByLibrary.simpleMessage("Onaylandı - Ödendi"),
    ...
    "auctionItemDidNotMakeItToReservePrice":
        MessageLookupByLibrary.simpleMessage(
          "Açık artırma ürünü rezerv fiyatına ulaşamadı",
        ),
    ...
    "banner": MessageLookupByLibrary.simpleMessage("Afiş"),
    ...
    "bookingDate": MessageLookupByLibrary.simpleMessage("Rezervasyon Tarihi"),
    ...
    "catalogVisibilityTooltip": MessageLookupByLibrary.simpleMessage(
      "Bu ayar, ürünlerin hangi mağaza sayfalarında listeleneceğini belirler.",
    ),
    ...
    "characterRemain": m12,
    "chargeBack": MessageLookupByLibrary.simpleMessage("Geri Ödeme Talebi"),
    ...
    "createIndex": MessageLookupByLibrary.simpleMessage("Dizin Oluştur"),
    ...
    "deleteBooking": MessageLookupByLibrary.simpleMessage("Rezervasyonu Sil"),
    ...
    "denied": MessageLookupByLibrary.simpleMessage("Reddedildi"),
    ...
    "featureImage": MessageLookupByLibrary.simpleMessage("Öne Çıkan Görsel"),
    ...
    "finalCost": MessageLookupByLibrary.simpleMessage("Son fiyat"),
    ...
    "getTicket": MessageLookupByLibrary.simpleMessage("Bilet Al"),
    ...
    "haveACoupon": MessageLookupByLibrary.simpleMessage("Kuponunuz var mı?"),
    ...
    "messageToListingOwner": MessageLookupByLibrary.simpleMessage(
      "İlan sahibine kısa mesajınız (isteğe bağlı)",
    ),
    ...
    "missingFirestoreIndexDescription": MessageLookupByLibrary.simpleMessage(
      "Bu sorgu bir dizin gerektirir. Lütfen Firebase konsoluna giriş yapın ve aşağıdaki düğmeye tıklayarak dizini oluşturun. Etkinleşmesi için bir süre beklemeniz gerekebilir.",
    ),
    "missingFirestoreIndexTitle": MessageLookupByLibrary.simpleMessage(
      "Eksik Firestore dizini tespit edildi!",
    ),
    ...
    "network": MessageLookupByLibrary.simpleMessage("Ağ"),
    ...
    "noMembershipPlans": MessageLookupByLibrary.simpleMessage(
      "Kullanılabilir üyelik planı yok",
    ),
    ...
    "onHold": MessageLookupByLibrary.simpleMessage("Beklemede"),
    ...
    "pendingPayment": MessageLookupByLibrary.simpleMessage("Ödeme Bekleniyor"),
    ...
    "pleaseAdjustYourCart": MessageLookupByLibrary.simpleMessage(
      "Lütfen ödeme işlemine geçmeden önce sepetinizi düzenleyin.",
    ),
    ...
    "processed": MessageLookupByLibrary.simpleMessage("İşlendi"),
    ...
    "quantityMustBeGreaterThanZero": MessageLookupByLibrary.simpleMessage(
      "Adet sıfırdan büyük olmalı",
    ),
    "quantityProductExceedInStock": MessageLookupByLibrary.simpleMessage(
      "Mevcut miktar stok miktarından fazla",
    ),
    "quoteLabel": MessageLookupByLibrary.simpleMessage("Teklif"),
    ...
    "refunded": MessageLookupByLibrary.simpleMessage("İade Edildi"),
    ...
    "reversed": MessageLookupByLibrary.simpleMessage("Tersine Çevrildi"),
    ...
    "saleToDate": MessageLookupByLibrary.simpleMessage("İndirim Bitiş Tarihi"),
    "saleToDateCannotBeEarlier": MessageLookupByLibrary.simpleMessage(
      "İndirim bitiş tarihi, indirim başlangıç tarihinden önce olamaz.",
    ),
    ...
    "scheduleSale": MessageLookupByLibrary.simpleMessage("İndirim Planla"),
    ...
    "thisIsSealedBidAuction": MessageLookupByLibrary.simpleMessage(
      "Bu gizli teklif açık artırmasıdır.",
    ),
    ...
    "totalCost": MessageLookupByLibrary.simpleMessage("Toplam maliyet"),
    ...
    "verifiedListing": MessageLookupByLibrary.simpleMessage("Doğrulanmış İlan"),
    ...
    "voided": MessageLookupByLibrary.simpleMessage("Geçersiz Kılındı"),
    ...
    "writeTitleOptional": MessageLookupByLibrary.simpleMessage(
      "Başlığınızı yazın (İsteğe bağlı)",
    ),
    ...
    "yourRating": MessageLookupByLibrary.simpleMessage("Puanınız"),
