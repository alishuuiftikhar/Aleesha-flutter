...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m16(count) => "${count} 位客人";

  static String m17(count) => "${count} 位客人";

  static String m18(count) => "${count}个商品";

  static String m19(count) => "${count}个商品";
  ...
  static String m29(captcha) => "输入${captcha}以确认：";
  ...
  static String m37(message) => "请求数据时应用出现问题，请联系管理员解决：${message}";
  ...
  static String m51(number) => "必须以${number}为一组购买";
  ...
  static String m55(name) => "${name}已添加到购物车";

  static String m56(total) => "数量：${total}";

  static String m57(name) => "已收到来自${name}的款项";

  static String m58(count) => "是否要从愿望清单中删除 ${count} 件商品？";

  static String m59(percent) => "促销 ${percent}%";

  static String m60(keyword, count) => "${keyword}（${count}个结果）";

  static String m61(keyword, count) => "${keyword}（${count}个结果）";
  ...
  static String m66(total) => "${total}件商品";
  ...
  static String m79(count) => "您正在选择 ${count} 个项目";
