...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m16(count) => "${count} gäst";

  static String m17(count) => "${count} gäster";

  static String m18(count) => "${count} artikel";

  static String m19(count) => "${count} artiklar";

  static String m20(count) => "${count} artikel";

  static String m21(count) => "${count} artiklar";

  static String m22(count) => "${count} biljett";

  static String m23(count) => "${count} biljetter";

  static String m24(country) => "${country} stöds inte";

  static String m25(currency) => "${currency} stöds inte";
  ...
  static String m28(timeLeft) => "Slutar om ${timeLeft}";

  static String m29(captcha) => "Ange ${captcha} för att bekräfta:";

  static String m30(message) => "Fel: ${message}";

  static String m31(message) => "Fel: ${message}";

  static String m32(error) => "Ett fel inträffade: ${error}";

  static String m33(date) => "Eventdatum: ${date}";

  static String m34(time) => "Går ut om ${time}";
  ...
  static String m39(size) => "Maximal filstorlek: ${size} MB";

  static String m40(count) => "Högst ${count} gäster tillåtna";
  ...
  static String m44(count) => "Minst ${count} tecken krävs";
  ...
  static String m46(day) => "Minsta vistelse är ${day} dagar";

  static String m47(amount) =>
      "Denna kupong kräver ett köp på minst ${amount}.";

  static String m48(value) => "Minsta transaktion: ${value}";

  static String m49(count) => "Minst ${count} gäst(er) krävs";

  static String m50(store) => "Mer från ${store}";

  static String m51(number) => "Måste köpas i grupper om ${number}";

  static String m52(itemCount) => "${itemCount} artiklar";

  static String m53(amount) => "Betala ${amount}";

  static String m54(date) => "Betalning förfaller: ${date}";

  static String m55(name) => "${name} har lagts till i kundvagnen";

  static String m56(total) => "Antal: ${total}";

  static String m57(name) => "Tog emot pengar från ${name}";

  static String m58(count) =>
      "Vill du ta bort ${count} artikel/artiklar från din önskelista?";

  static String m59(percent) => "Rea ${percent}%";

  static String m60(keyword, count) => "${keyword} (${count} objekt)";

  static String m61(keyword, count) => "${keyword} (${count} objekt)";

  static String m62(totalCartQuantity) =>
      "Kundvagn, ${totalCartQuantity} artiklar";

  static String m63(numberOfUnitsSold) => "Såld: ${numberOfUnitsSold}";

  static String m64(price) => "Startar från ${price}";

  static String m65(fieldName) => "Fältet ${fieldName} är obligatoriskt";

  static String m66(total) => "${total} produkter";

  static String m67(name) => "Överför pengar till ${name}";

  static String m68(price) => "Upp till ${price}";

  static String m69(amount) => "Använd ${amount} poäng";
  ...
  static String m71(time) => "Giltig till: ${time}";

  static String m72(date) => "Giltig till ${date}";

  static String m73(number) => "Version ${number}";

  static String m74(balance) => "Plånbokssaldo: ${balance}";

  static String m75(message) => "Varning: ${message}";
  ...
  static String m77(week) => "Vecka ${week}";

  static String m78(name) => "Välkommen ${name}";

  static String m79(count) => "Du väljer ${count} artikel/artiklar";

  static String m80(type) => "Du har klarat ${type}";

  static String m81(point) => "Du har ${point} poäng";

  static String m82(price) => "Du sparade ${price}";
