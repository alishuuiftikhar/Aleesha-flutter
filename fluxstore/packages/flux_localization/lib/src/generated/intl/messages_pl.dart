...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m2(length) =>
      "Media zostały dodane do playlisty. Dodano ${length} nowych element(ów).";

  static String m3(attribute) => "Dowolny ${attribute}";

  static String m4(point) => "Twoje dostępne punkty: ${point}";

  static String m5(name) => "Pomyślnie złożono ofertę na \'${name}\'";

  static String m6(id) => "Rezerwacja nr ${id}";

  static String m7(date) => "Rezerwacja złożona: ${date}";

  static String m8(amount) => "Kup teraz za ${amount}";
  ...
  static String m11(currency) => "Zmieniono walutę na ${currency}";

  static String m12(number) => "Pozostało znaków: ${number}";

  static String m13(date) => "Zameldowanie: ${date}";

  static String m14(date) => "Wymeldowanie: ${date}";

  static String m15(priceRate, pointRate) =>
      "${priceRate} = ${pointRate} punktów";

  static String m16(count) => "${count} gość";

  static String m17(count) => "${count} gości";

  static String m18(count) => "${count} element";

  static String m19(count) => "${count} elementów";

  static String m20(count) => "${count} produkt";

  static String m21(count) => "${count} produktów";

  static String m22(count) => "${count} bilet";

  static String m23(count) => "${count} bilety";

  static String m24(country) => "Kraj ${country} nie jest obsługiwany";

  static String m25(currency) => "${currency} nie jest obsługiwana";
  ...
  static String m28(timeLeft) => "Kończy się za ${timeLeft}";

  static String m29(captcha) => "Wpisz ${captcha}, aby potwierdzić:";

  static String m30(message) => "Błąd: ${message}";

  static String m31(message) => "Błąd: ${message}";

  static String m32(error) => "Wystąpił błąd: ${error}";

  static String m33(date) => "Data wydarzenia: ${date}";

  static String m34(time) => "Wygasa za ${time}";
  ...
  static String m39(size) => "Maksymalny rozmiar pliku: ${size} MB";

  static String m40(count) => "Maksymalnie dozwolonych jest ${count} gości";

  static String m41(maxQuantity) =>
      "Maksymalna dozwolona ilość w koszyku to ${maxQuantity}";
  ...
  static String m44(count) => "Wymagane minimum ${count} znaków";
  ...
  static String m46(day) => "Minimalny pobyt to ${day} dni";

  static String m47(amount) =>
      "Ten kupon wymaga zakupu za minimalną kwotę ${amount}.";

  static String m48(value) => "Minimalna transakcja: ${value}";

  static String m49(count) => "Wymaganych jest co najmniej ${count} gości";

  static String m50(store) => "Więcej od ${store}";

  static String m51(number) => "Musi być kupowane w grupach po ${number}";

  static String m52(itemCount) => "${itemCount} elementów";

  static String m53(amount) => "Zapłać ${amount}";

  static String m54(date) => "Płatność do: ${date}";

  static String m55(name) => "Produkt ${name} został dodany do koszyka";

  static String m56(total) => "Ilość: ${total}";

  static String m57(name) => "Otrzymano środki od ${name}";

  static String m58(count) =>
      "Czy chcesz usunąć ${count} pozycji z listy życzeń?";

  static String m59(percent) => "Wyprzedaż ${percent}%";

  static String m60(keyword, count) => "${keyword} (${count} element)";

  static String m61(keyword, count) => "${keyword} (${count} elementów)";

  static String m62(totalCartQuantity) =>
      "Koszyk, ${totalCartQuantity} pozycji";

  static String m63(numberOfUnitsSold) => "Sprzedane: ${numberOfUnitsSold}";

  static String m64(price) => "Cena od ${price}";

  static String m65(fieldName) => "Pole ${fieldName} jest wymagane";

  static String m66(total) => "${total} produktów";

  static String m67(name) => "Przelej pieniądze do ${name}";

  static String m68(price) => "Do ${price}";

  static String m69(amount) => "Użyj ${amount} punktów";
  ...
  static String m71(time) => "Ważne do: ${time}";

  static String m72(date) => "Ważne do ${date}";

  static String m73(number) => "Wersja ${number}";

  static String m74(balance) => "Saldo portfela: ${balance}";

  static String m75(message) => "Ostrzeżenie: ${message}";
  ...
  static String m77(week) => "Tydzień ${week}";

  static String m78(name) => "Witaj ${name}";

  static String m79(count) => "Wybierasz ${count} produktów";

  static String m80(type) => "Zdałeś ${type}";

  static String m81(point) => "Masz ${point} punktów";

  static String m82(price) => "Zaoszczędziłeś ${price}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "auctionItemDidNotMakeItToReservePrice":
        MessageLookupByLibrary.simpleMessage(
          "Przedmiot aukcji nie osiągnął ceny minimalnej",
        ),
    ...
    "bookingDate": MessageLookupByLibrary.simpleMessage("Data rezerwacji"),
    ...
    "bookingNotFound": MessageLookupByLibrary.simpleMessage(
      "Rezerwacja nie została znaleziona.",
    ),
    ...
    "cancelBooking": MessageLookupByLibrary.simpleMessage("Anuluj rezerwację"),
    ...
    "cannotGetPaymentURL": MessageLookupByLibrary.simpleMessage(
      "Nie można uzyskać adresu URL płatności",
    ),
    ...
    "catalogVisibilityTooltip": MessageLookupByLibrary.simpleMessage(
      "To ustawienie określa, na których stronach sklepu będą wyświetlane produkty.",
    ),
    ...
    "characterRemain": m12,
    "chargeBack": MessageLookupByLibrary.simpleMessage("Obciążenie zwrotne"),
    ...
    "couponRemove": MessageLookupByLibrary.simpleMessage(
      "Kupon został usunięty pomyślnie",
    ),
    ...
    "createIndex": MessageLookupByLibrary.simpleMessage("Utwórz indeks"),
    ...
    "deleteBooking": MessageLookupByLibrary.simpleMessage("Usuń rezerwację"),
    ...
    "denied": MessageLookupByLibrary.simpleMessage("Odrzucono"),
    ...
    "failedToCreateReview": MessageLookupByLibrary.simpleMessage(
      "Nie udało się utworzyć recenzji",
    ),
    ...
    "featureImage": MessageLookupByLibrary.simpleMessage("Obraz wyróżniający"),
    ...
    "finalCost": MessageLookupByLibrary.simpleMessage("Koszt końcowy"),
    ...
    "getTicket": MessageLookupByLibrary.simpleMessage("Pobierz bilet"),
    ...
    "haveACoupon": MessageLookupByLibrary.simpleMessage("Masz kupon?"),
    ...
    "messageToListingOwner": MessageLookupByLibrary.simpleMessage(
      "Twoja krótka wiadomość do właściciela ogłoszenia (opcjonalnie)",
    ),
    ...
    "missingFirestoreIndexDescription": MessageLookupByLibrary.simpleMessage(
      "To zapytanie wymaga indeksu. Zaloguj się do konsoli Firebase i utwórz indeks, klikając przycisk poniżej. Musisz chwilę poczekać, aż zostanie aktywowany.",
    ),
    "missingFirestoreIndexTitle": MessageLookupByLibrary.simpleMessage(
      "Wykryto brakujący indeks Firestore!",
    ),
    ...
    "noMembershipPlans": MessageLookupByLibrary.simpleMessage(
      "Brak dostępnych planów członkostwa",
    ),
    ...
    "onHold": MessageLookupByLibrary.simpleMessage("Wstrzymane"),
    ...
    "pleaseAdjustYourCart": MessageLookupByLibrary.simpleMessage(
      "Proszę dostosować zawartość koszyka przed przejściem do kasy.",
    ),
    ...
    "processed": MessageLookupByLibrary.simpleMessage("Przetworzono"),
    ...
    "quantityMustBeGreaterThanZero": MessageLookupByLibrary.simpleMessage(
      "Ilość musi być większa niż zero",
    ),
    "quantityProductExceedInStock": MessageLookupByLibrary.simpleMessage(
      "Bieżąca ilość przekracza ilość w magazynie",
    ),
    "quoteLabel": MessageLookupByLibrary.simpleMessage("Zapytanie o wycenę"),
    ...
    "refunded": MessageLookupByLibrary.simpleMessage("Zwrócono"),
    ...
    "reversed": MessageLookupByLibrary.simpleMessage("Cofnięto"),
    ...
    "scheduleSale": MessageLookupByLibrary.simpleMessage("Zaplanuj wyprzedaż"),
    ...
    "thisIsSealedBidAuction": MessageLookupByLibrary.simpleMessage(
      "To jest aukcja z ofertami ukrytymi.",
    ),
    ...
    "totalCost": MessageLookupByLibrary.simpleMessage("Całkowity koszt"),
    ...
    "voided": MessageLookupByLibrary.simpleMessage("Unieważniono"),
    ...
    "waitingOwnerConfirmation": MessageLookupByLibrary.simpleMessage(
      "Oczekiwanie na potwierdzenie właściciela",
    ),
