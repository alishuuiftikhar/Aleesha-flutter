...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m2(length) =>
      "Medio agregado a la lista de reproducción. ${length} nuevo(s) elemento(s) añadido(s).";

  static String m3(attribute) => "Cualquier ${attribute}";

  static String m4(point) => "Tus puntos disponibles: ${point}";

  static String m5(name) => "Se realizó una oferta exitosa para \'${name}\'";

  static String m6(id) => "Reserva n.º ${id}";

  static String m7(date) => "Reserva solicitada el: ${date}";

  static String m8(amount) => "Compra ahora por ${amount}";

  static String m9(author) => "Por: ${author}";

  static String m10(fieldName) =>
      "${fieldName} no puede tener menos de 3 caracteres";

  static String m11(currency) => "Moneda cambiada a ${currency}";
  ...
  static String m16(count) => "${count} huésped";

  static String m17(count) => "${count} huéspedes";

  static String m18(count) => "${count} artículo";

  static String m19(count) => "${count} artículos";

  static String m20(count) => "${count} artículo";

  static String m21(count) => "${count} artículos";

  static String m22(count) => "${count} entrada";

  static String m23(count) => "${count} entradas";

  static String m24(country) => "${country} no está soportado";

  static String m25(currency) => "${currency} no está soportado";
  ...
  static String m28(timeLeft) => "Termina en ${timeLeft}";

  static String m29(captcha) => "Ingresa ${captcha} para confirmar:";

  static String m30(message) => "Error: ${message}";

  static String m31(message) => "Error: ${message}";

  static String m32(error) => "Ocurrió un error: ${error}";

  static String m33(date) => "Fecha del evento: ${date}";

  static String m34(time) => "Expira en ${time}";
  ...
  static String m39(size) => "Tamaño máximo del archivo: ${size} MB";

  static String m40(count) => "Se permiten como máximo ${count} huéspedes";

  static String m41(maxQuantity) =>
      "La cantidad máxima permitida en el carrito es ${maxQuantity}";
  ...
  static String m44(count) => "Se requieren al menos ${count} caracteres";
  ...
  static String m46(day) => "La estancia mínima es de ${day} días";

  static String m47(amount) =>
      "Este cupón requiere una compra mínima de ${amount}.";

  static String m48(value) => "Transacción mínima: ${value}";

  static String m49(count) => "Se requiere un mínimo de ${count} huésped(es)";

  static String m50(store) => "Más de ${store}";

  static String m51(number) => "Debe comprarse en grupos de ${number}";

  static String m52(itemCount) => "${itemCount} artículos";

  static String m53(amount) => "Pagar ${amount}";

  static String m54(date) => "Pago pendiente para: ${date}";

  static String m55(name) => "${name} agregado al carrito";

  static String m56(total) => "Cantidad: ${total}";

  static String m57(name) => "Recibiste dinero de ${name}";

  static String m58(count) =>
      "¿Quieres eliminar ${count} artículo(s) de tu lista de deseos?";

  static String m59(percent) => "Descuento ${percent}%";

  static String m60(keyword, count) => "${keyword} (${count} elemento)";

  static String m61(keyword, count) => "${keyword} (${count} elementos)";
  ...
  static String m64(price) => "Desde ${price}";

  static String m65(fieldName) => "El campo ${fieldName} es obligatorio";

  static String m66(total) => "${total} productos";

  static String m67(name) => "Transferir dinero a ${name}";

  static String m68(price) => "Hasta ${price}";

  static String m69(amount) => "Utiliza ${amount} puntos";
  ...
  static String m71(time) => "Válido hasta: ${time}";

  static String m72(date) => "Válido hasta ${date}";

  static String m73(number) => "Versión ${number}";

  static String m74(balance) => "Saldo de la billetera: ${balance}";

  static String m75(message) => "Advertencia: ${message}";
  ...
  static String m78(name) => "Bienvenido ${name}";

  static String m79(count) => "Estás seleccionando ${count} artículo(s)";

  static String m80(type) => "Has superado ${type}";

  static String m81(point) => "Tienes ${point} puntos";

  static String m82(price) => "Has ahorrado ${price}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "addMediaToPlaylist": MessageLookupByLibrary.simpleMessage(
      "Agregar medio a la lista de reproducción",
    ),
    "addMediaToPlaylistFailed": MessageLookupByLibrary.simpleMessage(
      "No se pudo agregar el medio a la lista de reproducción.",
    ),
    "addMediaToPlaylistSuccess": MessageLookupByLibrary.simpleMessage(
      "El medio se agregó exitosamente a la lista de reproducción.",
    ),
    ...
    "approvedPaid": MessageLookupByLibrary.simpleMessage("Aprobado - Pagado"),
    ...
    "auctionItemDidNotMakeItToReservePrice":
        MessageLookupByLibrary.simpleMessage(
          "El artículo de la subasta no alcanzó el precio de reserva",
        ),
    ...
    "bookingDate": MessageLookupByLibrary.simpleMessage("Fecha de la reserva"),
    ...
    "cannotGetPaymentURL": MessageLookupByLibrary.simpleMessage(
      "No se puede obtener la URL de pago",
    ),
    ...
    "catalogVisibilityTooltip": MessageLookupByLibrary.simpleMessage(
      "Esta configuración determina en qué páginas de la tienda se mostrarán los productos.",
    ),
    ...
    "characterRemain": m12,
    "chargeBack": MessageLookupByLibrary.simpleMessage("Contracargo"),
    ...
    "createIndex": MessageLookupByLibrary.simpleMessage("Crear índice"),
    ...
    "denied": MessageLookupByLibrary.simpleMessage("Denegado"),
    ...
    "featureImage": MessageLookupByLibrary.simpleMessage("Imagen destacada"),
    ...
    "finalCost": MessageLookupByLibrary.simpleMessage("Costo final"),
    ...
    "getTicket": MessageLookupByLibrary.simpleMessage("Obtener entrada"),
    ...
    "haveACoupon": MessageLookupByLibrary.simpleMessage("¿Tienes un cupón?"),
    ...
    "messageToListingOwner": MessageLookupByLibrary.simpleMessage(
      "Tu breve mensaje al propietario del anuncio (opcional)",
    ),
    ...
    "missingFirestoreIndexDescription": MessageLookupByLibrary.simpleMessage(
      "Esta consulta requiere un índice. Por favor, inicia sesión en la consola de Firebase y crea el índice haciendo clic en el botón de abajo. Debes esperar un momento para que se habilite.",
    ),
    "missingFirestoreIndexTitle": MessageLookupByLibrary.simpleMessage(
      "¡Índice de Firestore faltante detectado!",
    ),
    ...
    "paymentCancelled": MessageLookupByLibrary.simpleMessage("Pago cancelado"),
    ...
    "pendingPayment": MessageLookupByLibrary.simpleMessage("Pago pendiente"),
    ...
    "pleaseAdjustYourCart": MessageLookupByLibrary.simpleMessage(
      "Por favor, ajusta tu carrito antes de continuar con el pago.",
    ),
    ...
    "quoteLabel": MessageLookupByLibrary.simpleMessage("Cotización"),
    ...
    "reservePriceHasBeenMet": MessageLookupByLibrary.simpleMessage(
      "El precio de reserva ha sido alcanzado",
    ),
    "reservePriceHasNotBeenMet": MessageLookupByLibrary.simpleMessage(
      "El precio de reserva no ha sido alcanzado",
    ),
    ...
    "saleToDateCannotBeEarlier": MessageLookupByLibrary.simpleMessage(
      "La fecha de fin de la oferta no puede ser anterior a la fecha de inicio de la oferta.",
    ),
    ...
    "shopAndSearchResults": MessageLookupByLibrary.simpleMessage(
      "Tienda y resultados de búsqueda",
    ),
    ...
    "shopOnly": MessageLookupByLibrary.simpleMessage("Solo tienda"),
    ...
    "thisIsSealedBidAuction": MessageLookupByLibrary.simpleMessage(
      "Esta es una subasta de oferta sellada.",
    ),
    ...
    "yourRating": MessageLookupByLibrary.simpleMessage("Tu calificación"),
