...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m16(count) => "${count}名様";

  static String m17(count) => "${count}名様";

  static String m18(count) => "${count}個のアイテム";

  static String m19(count) => "${count}個のアイテム";

  static String m20(count) => "${count}個の商品";

  static String m21(count) => "${count}個の商品";

  static String m22(count) => "${count}枚のチケット";

  static String m23(count) => "${count}枚のチケット";

  static String m24(country) => "${country}はサポートされていません";

  static String m25(currency) => "${currency}はサポートされていません";
  ...
  static String m28(timeLeft) => "残り${timeLeft}";

  static String m29(captcha) => "${captcha}を入力して確認してください";

  static String m30(message) => "エラー：${message}";

  static String m31(message) => "エラー：${message}";

  static String m32(error) => "エラーが発生しました: ${error}";

  static String m33(date) => "イベント日：${date}";

  static String m34(time) => "有効期限：${time}";

  static String m35(total) => "${total}km以上";

  static String m36(currentBalance) => "ウォレット残高が不足しています（残高：${currentBalance}）";

  static String m37(message) => "データの取得中に問題が発生しました。管理者に連絡してください：${message}";

  static String m38(currency, amount) => "この支払いの上限額は${currency} ${amount}です";

  static String m39(size) => "最大ファイルサイズ：${size} MB";

  static String m40(count) => "最大${count}名まで宿泊可能です";

  static String m41(maxQuantity) => "カートに追加できる最大数量は${maxQuantity}です";

  static String m42(name, formattedPrice) => "${name}：${formattedPrice}";

  static String m43(currency, amount) => "この支払いの最低額は${currency} ${amount}です";

  static String m44(count) => "最低${count}文字が必要です";

  static String m45(storeName, minOrderAmount) =>
      " ${storeName} の最低注文金額は ${minOrderAmount}です。このストアからさらに商品を追加してください。";

  static String m46(day) => "最低宿泊日数は${day}日です";

  static String m47(amount) => "このクーポンは最低 ${amount}の購入が必要です。";

  static String m48(value) => "最小取引: ${value}";

  static String m49(count) => "最低${count}名の宿泊が必要です";

  static String m50(store) => "${store}の他の商品";

  static String m51(number) => "${number}個単位で購入する必要があります";

  static String m52(itemCount) => "${itemCount}点";

  static String m53(amount) => "${amount}を支払う";

  static String m54(date) => "支払期日：${date}";

  static String m55(name) => "${name}をカートに追加しました";

  static String m56(total) => "数量：${total}";

  static String m57(name) => "${name}から入金がありました";

  static String m58(count) => "${count}個の商品をお気に入りから削除しますか？";

  static String m59(percent) => "セール ${percent}%オフ";

  static String m60(keyword, count) => "${keyword}（${count}件）";

  static String m61(keyword, count) => "${keyword}（${count}件）";

  static String m62(totalCartQuantity) => "カート内の商品：${totalCartQuantity}点";

  static String m63(numberOfUnitsSold) => "売れた数：${numberOfUnitsSold}";

  static String m64(price) => "${price}から開始";

  static String m65(fieldName) => "${fieldName}は必須項目です";

  static String m66(total) => "商品数：${total}";

  static String m67(name) => "${name}に送金";

  static String m68(price) => "最大${price}まで";

  static String m69(amount) => " ${amount} ポイントを使用する";

  static String m70(maxPointDiscount, maxPriceDiscount) =>
      "この注文で最大${maxPointDiscount}ポイントを使用すると、${maxPriceDiscount}の割引が適用されます。";

  static String m71(time) => "有効期限: ${time}";

  static String m72(date) => "${date}まで有効";

  static String m73(number) => "バージョン ${number}";

  static String m74(balance) => "ウォレット残高：${balance}";

  static String m75(message) => "警告：${message}";

  static String m76(defaultCurrency) =>
      "現在選択されている通貨はウォレット機能では利用できません。${defaultCurrency}に変更してください";

  static String m77(week) => "週 ${week}";

  static String m78(name) => "ようこそ、${name}さん";

  static String m79(count) => "${count}個の商品を選択中";

  static String m80(type) => " ${type}に合格しました";

  static String m81(point) => "${point}ポイントあります";

  static String m82(price) => "${price}節約できました";
