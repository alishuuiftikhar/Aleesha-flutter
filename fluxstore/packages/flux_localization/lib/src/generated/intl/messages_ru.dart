...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m2(length) =>
      "Медиа добавлено в плейлист. Добавлено ${length} новых элементов.";

  static String m3(attribute) => "Любой ${attribute}";

  static String m4(point) => "Доступные баллы: ${point}";

  static String m5(name) => "Успешно размещена ставка на \'${name}\'";

  static String m6(id) => "Бронирование №${id}";

  static String m7(date) => "Запрос на бронирование: ${date}";

  static String m8(amount) => "Купить сейчас за ${amount}";
  ...
  static String m11(currency) => "Валюта изменена на ${currency}";

  static String m12(number) => "Осталось символов: ${number}";

  static String m13(date) => "Заезд: ${date}";

  static String m14(date) => "Выезд: ${date}";

  static String m15(priceRate, pointRate) =>
      "${priceRate} = ${pointRate} баллов";

  static String m16(count) => "${count} гость";

  static String m17(count) => "${count} гостей";

  static String m18(count) => "${count} товар";

  static String m19(count) => "${count} товаров";

  static String m20(count) => "${count} товар";

  static String m21(count) => "${count} товаров";

  static String m22(count) => "${count} билет";

  static String m23(count) => "${count} билетов";

  static String m24(country) => "Страна ${country} не поддерживается.";

  static String m25(currency) => "${currency} не поддерживается";
  ...
  static String m28(timeLeft) => "Заканчивается через ${timeLeft}";

  static String m29(captcha) => "Введите ${captcha} для подтверждения:";

  static String m30(message) => "Ошибка: ${message}";

  static String m31(message) => "Ошибка: ${message}";

  static String m32(error) => "Произошла ошибка: ${error}";

  static String m33(date) => "Дата мероприятия: ${date}";

  static String m34(time) => "Истекает через ${time}";
  ...
  static String m39(size) => "Максимальный размер файла: ${size} МБ";

  static String m40(count) => "Разрешено максимум ${count} гостей";

  static String m41(maxQuantity) =>
      "Максимальное количество товаров в корзине — ${maxQuantity}";
  ...
  static String m44(count) => "Требуется минимум ${count} символов";
  ...
  static String m46(day) => "Минимальный срок проживания — ${day} дней";

  static String m47(amount) =>
      "Для использования этого купона требуется минимальная сумма покупки ${amount}.";

  static String m48(value) => "Минимальная транзакция: ${value}";

  static String m49(count) => "Требуется минимум ${count} гостя(ей)";

  static String m50(store) => "Еще из ${store}";

  static String m51(number) => "Необходимо покупать группами по ${number}";

  static String m52(itemCount) => "${itemCount} товаров";

  static String m53(amount) => "Оплатить ${amount}";

  static String m54(date) => "Оплата до: ${date}";

  static String m55(name) => "Товар ${name} добавлен в корзину";

  static String m56(total) => "Кол-во: ${total}";

  static String m57(name) => "Получены деньги от ${name}";

  static String m58(count) => "Удалить ${count} товар(ов) из списка желаний?";

  static String m59(percent) => "Скидка ${percent}%";

  static String m60(keyword, count) => "${keyword} (${count} товар)";

  static String m61(keyword, count) => "${keyword} (${count} товаров)";
  ...
  static String m64(price) => "От ${price}";

  static String m65(fieldName) =>
      "Поле ${fieldName} обязательно для заполнения";

  static String m66(total) => "${total} товаров";

  static String m67(name) => "Перевести деньги пользователю ${name}";

  static String m68(price) => "До ${price}";

  static String m69(amount) => "Используйте ${amount} баллов";
  ...
  static String m71(time) => "Действительно до: ${time}";

  static String m72(date) => "Действительно до ${date}";

  static String m73(number) => "Версия ${number}";

  static String m74(balance) => "Баланс кошелька: ${balance}";
  ...
  static String m77(week) => "Неделя ${week}";

  static String m78(name) => "Добро пожаловать, ${name}";

  static String m79(count) => "Вы выбираете ${count} товар(ов)";

  static String m80(type) => "Вы прошли ${type}";

  static String m81(point) => "У вас есть ${point} баллов";

  static String m82(price) => "Вы сэкономили ${price}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "addMediaToPlaylistFailed": MessageLookupByLibrary.simpleMessage(
      "Не удалось добавить медиа в плейлист.",
    ),
    "addMediaToPlaylistSuccess": MessageLookupByLibrary.simpleMessage(
      "Медиа успешно добавлено в плейлист.",
    ),
    ...
    "auctionItemDidNotMakeItToReservePrice":
        MessageLookupByLibrary.simpleMessage(
          "Лот на аукционе не достиг резервной цены",
        ),
    ...
    "bookingDate": MessageLookupByLibrary.simpleMessage("Дата бронирования"),
    ...
    "canceledReversal": MessageLookupByLibrary.simpleMessage("Отмена возврата"),
    ...
    "catalogVisibilityTooltip": MessageLookupByLibrary.simpleMessage(
      "Этот параметр определяет, на каких страницах магазина будут отображаться товары.",
    ),
    ...
    "characterRemain": m12,
    "chargeBack": MessageLookupByLibrary.simpleMessage("Чарджбэк"),
    ...
    "createIndex": MessageLookupByLibrary.simpleMessage("Создать индекс"),
    ...
    "denied": MessageLookupByLibrary.simpleMessage("Отклонено"),
    ...
    "finalCost": MessageLookupByLibrary.simpleMessage("Итоговая стоимость"),
    ...
    "getTicket": MessageLookupByLibrary.simpleMessage("Получить билет"),
    ...
    "haveACoupon": MessageLookupByLibrary.simpleMessage("Есть купон?"),
    ...
    "messageToListingOwner": MessageLookupByLibrary.simpleMessage(
      "Ваше короткое сообщение владельцу объявления (необязательно)",
    ),
    ...
    "missingFirestoreIndexDescription": MessageLookupByLibrary.simpleMessage(
      "Для этого запроса требуется индекс. Пожалуйста, войдите в консоль Firebase и создайте индекс, нажав на кнопку ниже. Необходимо немного подождать, пока он будет активирован.",
    ),
    "missingFirestoreIndexTitle": MessageLookupByLibrary.simpleMessage(
      "Обнаружен отсутствующий индекс Firestore!",
    ),
    ...
    "onHold": MessageLookupByLibrary.simpleMessage("В ожидании"),
    ...
    "paymentCancelled": MessageLookupByLibrary.simpleMessage("Платёж отменён"),
    ...
    "pendingPayment": MessageLookupByLibrary.simpleMessage("Ожидание оплаты"),
    ...
    "pleaseAdjustYourCart": MessageLookupByLibrary.simpleMessage(
      "Пожалуйста, скорректируйте корзину перед оформлением заказа.",
    ),
    ...
    "quoteLabel": MessageLookupByLibrary.simpleMessage("Запросить цену"),
    ...
    "refunded": MessageLookupByLibrary.simpleMessage("Возвращено"),
    ...
    "reversed": MessageLookupByLibrary.simpleMessage("Отменено"),
    ...
    "saleToDateCannotBeEarlier": MessageLookupByLibrary.simpleMessage(
      "Дата окончания распродажи не может быть раньше даты начала распродажи.",
    ),
    ...
    "shopOnly": MessageLookupByLibrary.simpleMessage("Только магазин"),
    ...
    "thisIsSealedBidAuction": MessageLookupByLibrary.simpleMessage(
      "Это аукцион с закрытыми ставками.",
    ),
    ...
    "voided": MessageLookupByLibrary.simpleMessage("Аннулировано"),
    ...
    "writeTitleOptional": MessageLookupByLibrary.simpleMessage(
      "Напишите заголовок (необязательно)",
    ),
    ...
    "yourRating": MessageLookupByLibrary.simpleMessage("Ваша оценка"),
