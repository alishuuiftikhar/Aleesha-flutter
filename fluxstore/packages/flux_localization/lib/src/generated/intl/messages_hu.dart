...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m2(length) =>
      "A média hozzáadva a lejátszási listához. ${length} új elem került hozzá.";

  static String m3(attribute) => "Bármely ${attribute}";

  static String m4(point) => "Elérhető pontok: ${point}";

  static String m5(name) => "Sikeresen licitált a(z) \'${name}\' termékre.";

  static String m6(id) => "Foglalás #${id}";

  static String m7(date) => "Foglalás kérve: ${date}";

  static String m8(amount) => "Vásároljon most ennyiért: ${amount}";

  static String m9(author) => "Szerző: ${author}";

  static String m10(fieldName) =>
      "A(z) ${fieldName} nem lehet rövidebb 3 karakternél.";

  static String m11(currency) => "Pénznem módosítva erre: ${currency}";

  static String m12(number) => "Még ${number} karakter";

  static String m13(date) => "Bejelentkezés: ${date}";

  static String m14(date) => "Kijelentkezés: ${date}";

  static String m15(priceRate, pointRate) => "${priceRate} = ${pointRate} pont";

  static String m16(count) => "${count} vendég";

  static String m17(count) => "${count} vendég";

  static String m18(count) => "${count} tétel";

  static String m19(count) => "${count} tétel";

  static String m20(count) => "${count} termék";

  static String m21(count) => "${count} termék";

  static String m22(count) => "${count} jegy";

  static String m23(count) => "${count} jegy";

  static String m24(country) => "${country} nem támogatott";

  static String m25(currency) => "A(z) ${currency} nem támogatott";
  ...
  static String m28(timeLeft) => "Hátralévő idő: ${timeLeft}";

  static String m29(captcha) => "A megerősítéshez írja be ezt: ${captcha}";

  static String m30(message) => "Hiba: ${message}";

  static String m31(message) => "Hiba: ${message}";

  static String m32(error) => "Hiba történt: ${error}";

  static String m33(date) => "Esemény dátuma: ${date}";

  static String m34(time) => "Lejárat ideje: ${time}";
  ...
  static String m39(size) => "Maximális fájlméret: ${size} MB";

  static String m40(count) => "Legfeljebb ${count} vendég engedélyezett";

  static String m41(maxQuantity) =>
      "A kosárban engedélyezett maximális mennyiség: ${maxQuantity}";
  ...
  static String m44(count) => "Legalább ${count} karakter szükséges";
  ...
  static String m46(day) => "A minimális tartózkodás ${day} nap";

  static String m47(amount) =>
      "Ez a kupon legalább ${amount} értékű vásárlás esetén használható fel.";

  static String m48(value) => "Minimális tranzakció: ${value}";

  static String m49(count) => "Legalább ${count} vendég szükséges";

  static String m50(store) => "További termékek innen: ${store}";

  static String m51(number) => "${number} darabos csomagban vásárolható";

  static String m52(itemCount) => "${itemCount} termék";

  static String m53(amount) => "Fizetés: ${amount}";

  static String m54(date) => "Fizetés esedékes: ${date}";

  static String m55(name) => "A(z) ${name} sikeresen a kosárba került";

  static String m56(total) => "Mennyiség: ${total}";

  static String m57(name) => "Pénz érkezett tőle: ${name}";

  static String m58(count) =>
      "Eltávolít ${count} terméket a kívánságlistájáról?";

  static String m59(percent) => "${percent}% kedvezmény";

  static String m60(keyword, count) => "${keyword} (${count} találat)";

  static String m61(keyword, count) => "${keyword} (${count} találat)";

  static String m62(totalCartQuantity) => "Kosár, ${totalCartQuantity} termék";

  static String m63(numberOfUnitsSold) => "Eladva: ${numberOfUnitsSold}";

  static String m64(price) => "Kezdőár: ${price}";

  static String m65(fieldName) => "A(z) ${fieldName} mező kötelező";

  static String m66(total) => "${total} termék";

  static String m67(name) => "Pénz küldése neki: ${name}";

  static String m68(price) => "Legfeljebb ${price}";

  static String m69(amount) => "Használjon ${amount} pontot";
  ...
  static String m71(time) => "Érvényes eddig: ${time}";

  static String m72(date) => "Érvényes: ${date}";

  static String m73(number) => "Verzió: ${number}";

  static String m74(balance) => "Egyenleg: ${balance}";

  static String m75(message) => "Figyelmeztetés: ${message}";
  ...
  static String m77(week) => "${week}. hét";

  static String m78(name) => "Üdvözöljük, ${name}!";

  static String m79(count) => "${count} terméket választott ki";

  static String m80(type) => "Lejárt ${type}";

  static String m81(point) => "Jelenleg ${point} pontja van";

  static String m82(price) => "Ön ${price} összeget spórolt meg";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "addMediaToPlaylist": MessageLookupByLibrary.simpleMessage(
      "Média hozzáadása a lejátszási listához",
    ),
    "addMediaToPlaylistFailed": MessageLookupByLibrary.simpleMessage(
      "Nem sikerült hozzáadni a médiát a lejátszási listához.",
    ),
    "addMediaToPlaylistSuccess": MessageLookupByLibrary.simpleMessage(
      "A média sikeresen hozzáadva a lejátszási listához.",
    ),
    ...
    "auctionItemDidNotMakeItToReservePrice":
        MessageLookupByLibrary.simpleMessage(
          "Az aukciós tétel nem érte el a minimálárat.",
        ),
    ...
    "bookingDate": MessageLookupByLibrary.simpleMessage("Foglalás dátuma"),
    ...
    "cancelBooking": MessageLookupByLibrary.simpleMessage("Foglalás lemondása"),
    "cancelBookingFailed": MessageLookupByLibrary.simpleMessage(
      "A foglalás lemondása nem sikerült.",
    ),
    ...
    "cannotGetPaymentURL": MessageLookupByLibrary.simpleMessage(
      "Nem sikerült lekérni a fizetési URL-t",
    ),
    ...
    "catalogVisibility": MessageLookupByLibrary.simpleMessage(
      "Katalógus láthatósága",
    ),
    "catalogVisibilityTooltip": MessageLookupByLibrary.simpleMessage(
      "Ez a beállítás határozza meg, melyik boltoldalakon jelenjenek meg a termékek.",
    ),
    ...
    "characterRemain": m12,
    "chargeBack": MessageLookupByLibrary.simpleMessage("Visszaterhelés"),
    ...
    "createIndex": MessageLookupByLibrary.simpleMessage("Index létrehozása"),
    ...
    "deleteBooking": MessageLookupByLibrary.simpleMessage("Foglalás törlése"),
    "deleteBookingFailed": MessageLookupByLibrary.simpleMessage(
      "A foglalás törlése nem sikerült.",
    ),
    ...
    "denied": MessageLookupByLibrary.simpleMessage("Elutasítva"),
    ...
    "failedToCreateReview": MessageLookupByLibrary.simpleMessage(
      "Nem sikerült létrehozni az értékelést.",
    ),
    ...
    "featureImage": MessageLookupByLibrary.simpleMessage("Kiemelt kép"),
    ...
    "finalCost": MessageLookupByLibrary.simpleMessage("Végső ár"),
    ...
    "getTicket": MessageLookupByLibrary.simpleMessage("Jegy megszerzése"),
    ...
    "haveACoupon": MessageLookupByLibrary.simpleMessage("Van kuponod?"),
    ...
    "instantBooking": MessageLookupByLibrary.simpleMessage("Azonnali foglalás"),
    ...
    "messageToListingOwner": MessageLookupByLibrary.simpleMessage(
      "Rövid üzeneted a hirdetés tulajdonosának (opcionális)",
    ),
    ...
    "missingFirestoreIndexDescription": MessageLookupByLibrary.simpleMessage(
      "Ehhez a lekérdezéshez index szükséges. Jelentkezzen be a Firebase konzolba, és hozza létre az indexet az alábbi gombra kattintva. Várjon egy pillanatot, amíg engedélyezik.",
    ),
    "missingFirestoreIndexTitle": MessageLookupByLibrary.simpleMessage(
      "Hiányzó Firestore index észlelve!",
    ),
    ...
    "noMembershipPlans": MessageLookupByLibrary.simpleMessage(
      "Nincsenek elérhető tagsági csomagok",
    ),
    ...
    "onHold": MessageLookupByLibrary.simpleMessage("Függőben"),
    ...
    "paymentCancelled": MessageLookupByLibrary.simpleMessage("Fizetés törölve"),
    ...
    "pendingPayment": MessageLookupByLibrary.simpleMessage("Fizetésre vár"),
    ...
    "pleaseAdjustYourCart": MessageLookupByLibrary.simpleMessage(
      "Kérjük, módosítsa a kosarát, mielőtt továbblép a fizetéshez.",
    ),
    ...
    "processed": MessageLookupByLibrary.simpleMessage("Feldolgozva"),
    ...
    "quantityMustBeGreaterThanZero": MessageLookupByLibrary.simpleMessage(
      "A mennyiségnek nagyobbnak kell lennie nullánál",
    ),
    "quantityProductExceedInStock": MessageLookupByLibrary.simpleMessage(
      "A kért mennyiség meghaladja a készleten lévő mennyiséget",
    ),
    "quoteLabel": MessageLookupByLibrary.simpleMessage("Árajánlat"),
    ...
    "refunded": MessageLookupByLibrary.simpleMessage("Visszatérítve"),
    ...
    "reversed": MessageLookupByLibrary.simpleMessage("Visszafordítva"),
    ...
    "sale": m59,
    "saleFromDate": MessageLookupByLibrary.simpleMessage("Akció kezdete"),
    "salePrice": MessageLookupByLibrary.simpleMessage("Akciós ár"),
    "saleToDate": MessageLookupByLibrary.simpleMessage("Akció vége"),
    "saleToDateCannotBeEarlier": MessageLookupByLibrary.simpleMessage(
      "Az akció vége nem lehet korábbi, mint az akció kezdete.",
    ),
    ...
    "scheduleSale": MessageLookupByLibrary.simpleMessage("Akció ütemezése"),
    ...
    "totalCost": MessageLookupByLibrary.simpleMessage("Teljes költség"),
    ...
    "voided": MessageLookupByLibrary.simpleMessage("Érvénytelenítve"),
    ...
    "yourRating": MessageLookupByLibrary.simpleMessage("Az Ön értékelése"),
