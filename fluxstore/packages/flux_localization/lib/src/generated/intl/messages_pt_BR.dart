...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m2(length) =>
      "Mídia adicionada à playlist. ${length} novo(s) item(ns) adicionado(s).";

  static String m3(attribute) => "Qualquer ${attribute}";

  static String m4(point) => "Seus pontos disponíveis: ${point}";

  static String m5(name) => "Lance realizado com sucesso para \'${name}\'";

  static String m6(id) => "Reserva nº${id}";
  ...
  static String m22(count) => "${count} ingresso";

  static String m23(count) => "${count} ingressos";
  ...
  static String m29(captcha) => "Digite ${captcha} para confirmar:";
  ...
  static String m34(time) => "Expira em ${time}";
  ...
  static String m39(size) => "Tamanho máximo do arquivo: ${size} MB";

  static String m40(count) => "Máximo de ${count} hóspedes permitidos";
  ...
  static String m44(count) => "É necessário no mínimo ${count} caracteres";
  ...
  static String m49(count) => "Mínimo de ${count} hóspede(s) necessário(s)";
  ...
  static String m59(percent) => "${percent}% de desconto";
  ...
  static String m69(amount) => "Usar ${amount} pontos";
  ...
  static String m78(name) => "Bem-vindo(a), ${name}";

  static String m79(count) => "Você está selecionando ${count} item(ns)";
  ...
  static String m81(point) => "Você tem ${point} pontos";

  static String m82(price) => "Você economizou ${price}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "addMediaToPlaylistFailed": MessageLookupByLibrary.simpleMessage(
      "Falha ao adicionar mídia à playlist.",
    ),
    "addMediaToPlaylistSuccess": MessageLookupByLibrary.simpleMessage(
      "Mídia adicionada à playlist com sucesso.",
    ),
    ...
    "auctionItemDidNotMakeItToReservePrice":
        MessageLookupByLibrary.simpleMessage(
          "O item do leilão não atingiu o preço de reserva",
        ),
    ...
    "catalogVisibilityTooltip": MessageLookupByLibrary.simpleMessage(
      "Esta configuração determina em quais páginas da loja os produtos serão exibidos.",
    ),
    ...
    "deleteBooking": MessageLookupByLibrary.simpleMessage("Excluir reserva"),
    ...
    "getTicket": MessageLookupByLibrary.simpleMessage("Obter ingresso"),
    ...
    "messageToListingOwner": MessageLookupByLibrary.simpleMessage(
      "Sua mensagem curta para o proprietário do anúncio (opcional)",
    ),
    ...
    "missingFirestoreIndexDescription": MessageLookupByLibrary.simpleMessage(
      "Esta consulta requer um índice. Faça login no console do Firebase e crie o índice clicando no botão abaixo. Aguarde um momento para que ele seja habilitado.",
    ),
    "missingFirestoreIndexTitle": MessageLookupByLibrary.simpleMessage(
      "Índice do Firestore ausente detectado!",
    ),
    ...
    "pleaseAdjustYourCart": MessageLookupByLibrary.simpleMessage(
      "Por favor, ajuste seu carrinho antes de finalizar a compra.",
    ),
    ...
    "quoteLabel": MessageLookupByLibrary.simpleMessage("Orçamento"),
    ...
    "reservePriceHasBeenMet": MessageLookupByLibrary.simpleMessage(
      "O preço de reserva foi alcançado",
    ),
    "reservePriceHasNotBeenMet": MessageLookupByLibrary.simpleMessage(
      "O preço de reserva não foi alcançado",
    ),
    ...
    "saleToDateCannotBeEarlier": MessageLookupByLibrary.simpleMessage(
      "A data de término da promoção não pode ser anterior à data de início da promoção.",
    ),
    ...
    "thisIsSealedBidAuction": MessageLookupByLibrary.simpleMessage(
      "Este é um leilão de lance fechado.",
    ),
    ...
    "yourRating": MessageLookupByLibrary.simpleMessage("Sua Avaliação"),
