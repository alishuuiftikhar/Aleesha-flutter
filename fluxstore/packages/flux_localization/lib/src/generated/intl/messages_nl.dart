...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m2(length) =>
      "Media toegevoegd aan de afspeellijst. ${length} nieuw(e) item(s) toegevoegd.";

  static String m3(attribute) => "Elke ${attribute}";

  static String m4(point) => "Je beschikbare punten: ${point}";

  static String m5(name) => "Met succes een bod geplaatst op \'${name}\'";

  static String m6(id) => "Boeking #${id}";

  static String m7(date) => "Boeking aangevraagd op: ${date}";

  static String m8(amount) => "Koop nu voor ${amount}";

  static String m9(author) => "Door: ${author}";

  static String m10(fieldName) =>
      "${fieldName} mag niet korter zijn dan 3 tekens.";

  static String m11(currency) => "Valuta gewijzigd naar ${currency}";

  static String m12(number) => "${number} tekens resterend";

  static String m13(date) => "Inchecken: ${date}";

  static String m14(date) => "Uitchecken: ${date}";

  static String m15(priceRate, pointRate) =>
      "${priceRate} = ${pointRate} punten";

  static String m16(count) => "${count} gast";

  static String m17(count) => "${count} gasten";

  static String m18(count) => "${count} artikel";

  static String m19(count) => "${count} artikelen";

  static String m20(count) => "${count} artikel";

  static String m21(count) => "${count} artikelen";

  static String m22(count) => "${count} ticket";

  static String m23(count) => "${count} tickets";

  static String m24(country) => "${country} wordt niet ondersteund";

  static String m25(currency) => "${currency} wordt niet ondersteund";
  ...
  static String m28(timeLeft) => "Eindigt over ${timeLeft}";

  static String m29(captcha) => "Voer ${captcha} in om te bevestigen:";

  static String m30(message) => "Fout: ${message}";

  static String m31(message) => "Fout: ${message}";

  static String m32(error) => "Er is een fout opgetreden: ${error}";

  static String m33(date) => "Evenementdatum: ${date}";

  static String m34(time) => "Verloopt over ${time}";
  ...
  static String m39(size) => "Maximale bestandsgrootte: ${size} MB";

  static String m40(count) => "Maximaal ${count} gasten toegestaan";

  static String m41(maxQuantity) =>
      "De maximale hoeveelheid die is toegestaan in de winkelwagen is ${maxQuantity}";
  ...
  static String m44(count) => "Minimaal ${count} tekens vereist";
  ...
  static String m46(day) => "Minimale verblijfsduur is ${day} dagen";

  static String m47(amount) =>
      "Voor deze coupon is een minimale aankoop van ${amount}vereist.";

  static String m48(value) => "Minimale transactie: ${value}";

  static String m49(count) => "Minimaal ${count} gast(en) vereist";

  static String m50(store) => "Meer van ${store}";

  static String m51(number) => "Moet worden gekocht in groepen van ${number}";

  static String m52(itemCount) => "${itemCount} items";

  static String m53(amount) => "Betaal ${amount}";

  static String m54(date) => "Betaling verschuldigd op: ${date}";

  static String m55(name) =>
      "${name} is succesvol aan de winkelwagen toegevoegd";

  static String m56(total) => "Aantal: ${total}";

  static String m57(name) => "Geld ontvangen van ${name}";

  static String m58(count) =>
      "Wilt u ${count} item(s) van uw verlanglijst verwijderen?";

  static String m59(percent) => "Aanbieding ${percent}%";

  static String m60(keyword, count) => "${keyword} (${count} artikel)";

  static String m61(keyword, count) => "${keyword} (${count} artikelen)";

  static String m62(totalCartQuantity) =>
      "Winkelwagen, ${totalCartQuantity} items";

  static String m63(numberOfUnitsSold) => "Verkocht: ${numberOfUnitsSold}";

  static String m64(price) => "Vanaf ${price}";

  static String m65(fieldName) => "Het veld ${fieldName} is verplicht";

  static String m66(total) => "${total} producten";

  static String m67(name) => "Geld overmaken naar ${name}";

  static String m68(price) => "Tot ${price}";

  static String m69(amount) => "Gebruik ${amount} punten";
  ...
  static String m71(time) => "Geldig tot: ${time}";

  static String m72(date) => "Geldig tot ${date}";

  static String m73(number) => "Versie ${number}";

  static String m74(balance) => "Saldo portemonnee: ${balance}";

  static String m75(message) => "Waarschuwing: ${message}";
  ...
  static String m77(week) => "Week ${week}";

  static String m78(name) => "Welkom ${name}";

  static String m79(count) => "U selecteert ${count} item(s)";

  static String m80(type) => "Je bent geslaagd voor ${type}";

  static String m81(point) => "Je hebt ${point} punten";

  static String m82(price) => "Je hebt ${price} bespaard";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "addMediaToPlaylist": MessageLookupByLibrary.simpleMessage(
      "Voeg media toe aan afspeellijst",
    ),
    "addMediaToPlaylistFailed": MessageLookupByLibrary.simpleMessage(
      "Toevoegen van media aan de afspeellijst mislukt.",
    ),
    "addMediaToPlaylistSuccess": MessageLookupByLibrary.simpleMessage(
      "Media succesvol toegevoegd aan de afspeellijst.",
    ),
    ...
    "auctionItemDidNotMakeItToReservePrice":
        MessageLookupByLibrary.simpleMessage(
          "Veilingitem heeft de minimale prijs niet gehaald",
        ),
    ...
    "cancelBooking": MessageLookupByLibrary.simpleMessage("Boeking annuleren"),
    "cancelBookingFailed": MessageLookupByLibrary.simpleMessage(
      "Annuleren van de boeking mislukt.",
    ),
    ...
    "cannotGetPaymentURL": MessageLookupByLibrary.simpleMessage(
      "Kan betalings-URL niet ophalen",
    ),
    ...
    "characterRemain": m12,
    "chargeBack": MessageLookupByLibrary.simpleMessage("Terugvordering"),
    ...
    "createIndex": MessageLookupByLibrary.simpleMessage("Index aanmaken"),
    ...
    "deleteBookingFailed": MessageLookupByLibrary.simpleMessage(
      "Verwijderen van de boeking mislukt.",
    ),
    ...
    "denied": MessageLookupByLibrary.simpleMessage("Geweigerd"),
    ...
    "finalCost": MessageLookupByLibrary.simpleMessage("Eindkosten"),
    ...
    "getTicket": MessageLookupByLibrary.simpleMessage("Ticket ophalen"),
    ...
    "instantBooking": MessageLookupByLibrary.simpleMessage("Direct boeken"),
    ...
    "messageToListingOwner": MessageLookupByLibrary.simpleMessage(
      "Uw korte bericht aan de eigenaar van de vermelding (optioneel)",
    ),
    ...
    "missingFirestoreIndexDescription": MessageLookupByLibrary.simpleMessage(
      "Deze query vereist een index. Log in op de Firebase-console en maak de index aan door op de onderstaande knop te klikken. Je moet even wachten tot deze is ingeschakeld.",
    ),
    "missingFirestoreIndexTitle": MessageLookupByLibrary.simpleMessage(
      "Ontbrekende Firestore-index gedetecteerd!",
    ),
    ...
    "noMembershipPlans": MessageLookupByLibrary.simpleMessage(
      "Geen lidmaatschapsplannen beschikbaar",
    ),
    ...
    "onHold": MessageLookupByLibrary.simpleMessage("In de wacht"),
    ...
    "pleaseAdjustYourCart": MessageLookupByLibrary.simpleMessage(
      "Pas je winkelwagen aan voordat je doorgaat naar afrekenen.",
    ),
    ...
    "quoteLabel": MessageLookupByLibrary.simpleMessage("Offerte"),
    ...
    "refunded": MessageLookupByLibrary.simpleMessage("Terugbetaald"),
    ...
    "reversed": MessageLookupByLibrary.simpleMessage("Teruggedraaid"),
    ...
    "sale": m59,
    "saleFromDate": MessageLookupByLibrary.simpleMessage("Verkoop vanaf datum"),
    "salePrice": MessageLookupByLibrary.simpleMessage("Aanbiedingsprijs"),
    "saleToDate": MessageLookupByLibrary.simpleMessage("Verkoop tot datum"),
    "saleToDateCannotBeEarlier": MessageLookupByLibrary.simpleMessage(
      "De einddatum van de verkoop kan niet eerder zijn dan de begindatum van de verkoop.",
    ),
    ...
    "scheduleSale": MessageLookupByLibrary.simpleMessage("Verkoop plannen"),
    ...
    "shopOnly": MessageLookupByLibrary.simpleMessage("Alleen winkel"),
    ...
    "thisIsSealedBidAuction": MessageLookupByLibrary.simpleMessage(
      "Dit is een gesloten biedingsveiling.",
    ),
    ...
    "totalCost": MessageLookupByLibrary.simpleMessage("Totale kosten"),
    ...
    "voided": MessageLookupByLibrary.simpleMessage("Ongeldig gemaakt"),
    ...
    "waitingOwnerConfirmation": MessageLookupByLibrary.simpleMessage(
      "Wachten op bevestiging van eigenaar",
    ),
    ...
    "yourRating": MessageLookupByLibrary.simpleMessage("Jouw beoordeling"),
