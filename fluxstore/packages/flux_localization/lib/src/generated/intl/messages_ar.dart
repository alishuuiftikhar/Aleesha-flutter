...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m2(length) =>
      "تمت إضافة الوسائط إلى قائمة التشغيل. تم إضافة ${length} عنصر(عناصر) جديد.";

  static String m3(attribute) => "أي ${attribute}";

  static String m4(point) => "نقاطك المتاحة: ${point}";

  static String m5(name) => "تم وضع عرض سعر بنجاح لـ \'${name}\'";

  static String m6(id) => "الحجز رقم #${id}";

  static String m7(date) => "تم طلب الحجز في: ${date}";

  static String m8(amount) => "اشتري الآن مقابل ${amount}";

  static String m9(author) => "الكاتب: ${author}";

  static String m10(fieldName) => "يجب ألا يقل طول ${fieldName} عن 3 أحرف";

  static String m11(currency) => "تم تغيير العملة إلى ${currency}";

  static String m12(number) => "متبقي ${number} حرف";

  static String m13(date) => "تسجيل الوصول: ${date}";

  static String m14(date) => "تسجيل المغادرة: ${date}";

  static String m15(priceRate, pointRate) => "${priceRate} = ${pointRate} نقطة";

  static String m16(count) => "ضيف واحد";

  static String m17(count) => "${count} ضيوف";

  static String m18(count) => "${count} عنصر";

  static String m19(count) => "${count} عنصر";

  static String m20(count) => "${count} منتج";

  static String m21(count) => "${count} منتجات";

  static String m22(count) => "تذكرة واحدة";

  static String m23(count) => "${count} تذاكر";

  static String m24(country) => "البلد ${country} غير مدعوم";

  static String m25(currency) => "العملة ${currency} غير مدعومة";
  ...
  static String m27(total) => "~${total} كم";

  static String m28(timeLeft) => "ينتهي في ${timeLeft}";

  static String m29(captcha) => "أدخل ${captcha} للتأكيد:";

  static String m30(message) => "خطأ: ${message}";

  static String m31(message) => "خطأ: ${message}";

  static String m32(error) => "حدث خطأ: ${error}";

  static String m33(date) => "تاريخ الفعالية: ${date}";

  static String m34(time) => "تنتهي الصلاحية في ${time}";

  static String m35(total) => "أكثر من ${total} كم";

  static String m36(currentBalance) => "لديك فقط ${currentBalance} في محفظتك";
  ...
  static String m39(size) => "الحد الأقصى لحجم الملف: ${size} ميجابايت";

  static String m40(count) => "الحد الأقصى المسموح به هو ${count} من الضيوف";

  static String m41(maxQuantity) =>
      "أقصى كمية مسموح بها في السلة هي ${maxQuantity}";
  ...
  static String m44(count) => "مطلوب على الأقل ${count} أحرف";
  ...
  static String m46(day) => "الحد الأدنى للإقامة هو ${day} أيام";

  static String m47(amount) =>
      "تتطلب هذه القسيمة شراء الحد الأدنى بقيمة ${amount}.";

  static String m48(value) => "الحد الأدنى للمعاملة: ${value}";

  static String m49(count) => "الحد الأدنى المطلوب هو ${count} من الضيوف";

  static String m50(store) => "المزيد من ${store}";

  static String m51(number) => "يجب الشراء بمجموعات من ${number}";

  static String m52(itemCount) => "${itemCount} عنصر";

  static String m53(amount) => "ادفع ${amount}";

  static String m54(date) => "الدفع مستحق في: ${date}";

  static String m55(name) => "تمت إضافة ${name} إلى السلة بنجاح";

  static String m56(total) => "الكمية: ${total}";

  static String m57(name) => "استلمت مبلغاً من ${name}";

  static String m58(count) => "هل تريد إزالة ${count} عنصر من قائمة رغباتك؟";

  static String m59(percent) => "خصم ${percent}٪";

  static String m60(keyword, count) => "${keyword} (${count} عنصر)";

  static String m61(keyword, count) => "${keyword} (${count} عنصر)";

  static String m62(totalCartQuantity) =>
      "سلة التسوق، ${totalCartQuantity} عنصر";

  static String m63(numberOfUnitsSold) => "تم البيع: ${numberOfUnitsSold}";

  static String m64(price) => "يبدأ من ${price}";

  static String m65(fieldName) => "حقل ${fieldName} مطلوب";

  static String m66(total) => "${total} منتج";

  static String m67(name) => "تحويل مبلغ إلى ${name}";

  static String m68(price) => "حتى ${price}";

  static String m69(amount) => "استخدم ${amount} نقطة";
  ...
  static String m71(time) => "صالحة حتى: ${time}";

  static String m72(date) => "صالح حتى ${date}";

  static String m73(number) => "الإصدار ${number}";

  static String m74(balance) => "رصيد المحفظة: ${balance}";

  static String m75(message) => "تحذير: ${message}";

  static String m76(defaultCurrency) =>
      "العملة المحددة حالياً غير متاحة لميزة المحفظة، الرجاء تغييرها إلى ${defaultCurrency}";

  static String m77(week) => "الأسبوع ${week}";

  static String m78(name) => "مرحباً ${name}";

  static String m79(count) => "أنت تختار ${count} عنصر";

  static String m80(type) => "لقد اجتزت ${type}";

  static String m81(point) => "لديك ${point} نقطة";

  static String m82(price) => "لقد وفرت ${price}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "addNewAttribute": MessageLookupByLibrary.simpleMessage("إضافة سمة جديدة"),
    ...
    "auctionItemDidNotMakeItToReservePrice":
        MessageLookupByLibrary.simpleMessage(
          "لم يصل عنصر المزاد إلى سعر الحد الأدنى",
        ),
    ...
    "bookingID": m6,
    "bookingLocation": MessageLookupByLibrary.simpleMessage("موقع الحجز"),
    ...
    "canceledReversal": MessageLookupByLibrary.simpleMessage("إلغاء العكس"),
    ...
    "catalogVisibility": MessageLookupByLibrary.simpleMessage("إظهار الكتالوج"),
    "catalogVisibilityTooltip": MessageLookupByLibrary.simpleMessage(
      "يحدد هذا الإعداد صفحات المتجر التي ستظهر فيها المنتجات.",
    ),
    ...
    "characterRemain": m12,
    "chargeBack": MessageLookupByLibrary.simpleMessage("استرجاع المبلغ"),
    ...
    "createIndex": MessageLookupByLibrary.simpleMessage("إنشاء فهرس"),
    ...
    "deleteBooking": MessageLookupByLibrary.simpleMessage("حذف الحجز"),
    ...
    "eventsCategories": MessageLookupByLibrary.simpleMessage("فئات الفعاليات"),
    ...
    "featureImage": MessageLookupByLibrary.simpleMessage("الصورة المميزة"),
    ...
    "finalCost": MessageLookupByLibrary.simpleMessage("التكلفة النهائية"),
    ...
    "getTicket": MessageLookupByLibrary.simpleMessage("احصل على التذكرة"),
    ...
    "hidden": MessageLookupByLibrary.simpleMessage("مخفي"),
    ...
    "instantBooking": MessageLookupByLibrary.simpleMessage("حجز فوري"),
    ...
    "invalidBooking": MessageLookupByLibrary.simpleMessage("الحجز غير صالح."),
    ...
    "messageToListingOwner": MessageLookupByLibrary.simpleMessage(
      "رسالتك القصيرة إلى مالك الإعلان (اختياري)",
    ),
    ...
    "missingFirestoreIndexDescription": MessageLookupByLibrary.simpleMessage(
      "يتطلب هذا الاستعلام فهرسًا. يرجى تسجيل الدخول إلى وحدة تحكم Firebase وإنشاء الفهرس بالنقر على الزر أدناه. عليك الانتظار قليلاً حتى يتم تفعيله.",
    ),
    "missingFirestoreIndexTitle": MessageLookupByLibrary.simpleMessage(
      "تم اكتشاف فهرس Firestore مفقود!",
    ),
    ...
    "onHold": MessageLookupByLibrary.simpleMessage("قيد الانتظار"),
    ...
    "pendingPayment": MessageLookupByLibrary.simpleMessage("في انتظار الدفع"),
    ...
    "pleaseAdjustYourCart": MessageLookupByLibrary.simpleMessage(
      "يرجى تعديل السلة قبل المتابعة إلى الدفع.",
    ),
    ...
    "quoteLabel": MessageLookupByLibrary.simpleMessage("عرض سعر"),
    ...
    "refunded": MessageLookupByLibrary.simpleMessage("تم استرداد المبلغ"),
    ...
    "rentalsCategories": MessageLookupByLibrary.simpleMessage("فئات الإيجارات"),
    ...
    "reversed": MessageLookupByLibrary.simpleMessage("تم عكس العملية"),
    ...
    "sale": m59,
    "saleFromDate": MessageLookupByLibrary.simpleMessage("تاريخ بدء التخفيض"),
    "salePrice": MessageLookupByLibrary.simpleMessage("سعر البيع"),
    "saleToDate": MessageLookupByLibrary.simpleMessage("تاريخ انتهاء التخفيض"),
    "saleToDateCannotBeEarlier": MessageLookupByLibrary.simpleMessage(
      "لا يمكن أن يكون تاريخ انتهاء التخفيض أسبق من تاريخ بدء التخفيض.",
    ),
    ...
    "scheduleSale": MessageLookupByLibrary.simpleMessage("جدولة التخفيض"),
    ...
    "shopOnly": MessageLookupByLibrary.simpleMessage("المتجر فقط"),
    ...
    "verifiedListing": MessageLookupByLibrary.simpleMessage("قائمة موثقة"),
    ...
    "voided": MessageLookupByLibrary.simpleMessage("تم الإلغاء"),
