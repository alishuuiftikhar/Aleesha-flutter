...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m2(length) =>
      "Media imeongezwa kwenye orodha ya kucheza. ${length} kipengee kipya kimeongezwa.";

  static String m3(attribute) => "${attribute} yoyote";

  static String m4(point) => "Pointi zako zinazopatikana: ${point}";

  static String m5(name) => "Imefaulu kuweka zabuni ya \'${name}\'";

  static String m6(id) => "Uwekaji #${id}";

  static String m7(date) => "Uwekaji uliombwa tarehe: ${date}";

  static String m8(amount) => "Nunua sasa kwa ${amount}";

  static String m9(author) => "Na: ${author}";

  static String m10(fieldName) => " Urefu${fieldName} lazima usiwe chini ya 3.";

  static String m11(currency) => "Umebadilisha sarafu kuwa ${currency}";

  static String m12(number) => "Zimebaki herufi ${number}";

  static String m13(date) => "Kuingia: ${date}";

  static String m14(date) => "Kutoka: ${date}";

  static String m15(priceRate, pointRate) =>
      "${priceRate} = ${pointRate} Pointi";

  static String m16(count) => "Mgeni ${count}";

  static String m17(count) => "Wageni ${count}";

  static String m18(count) => "Kipengee ${count}";

  static String m19(count) => "Vipengee ${count}";

  static String m20(count) => "Bidhaa ${count}";

  static String m21(count) => "Bidhaa ${count}";

  static String m22(count) => "Tiketi ${count}";

  static String m23(count) => "Tiketi ${count}";

  static String m24(country) => "${country} haitumiki";

  static String m25(currency) => "${currency} haitumiki";
  ...
  static String m27(total) => "~${total} kilomita";

  static String m28(timeLeft) => "Inaisha baada ya ${timeLeft}";

  static String m29(captcha) => "Weka ${captcha} ili kuthibitisha:";

  static String m30(message) => "Hitilafu: ${message}";

  static String m31(message) => "Hitilafu: ${message}";

  static String m32(error) => "Hitilafu imetokea: ${error}";

  static String m33(date) => "Tarehe ya Tukio: ${date}";

  static String m34(time) => "Inaisha baada ya ${time}";

  static String m35(total) => "> kilomita${total} ";
  ...
  static String m39(size) => "Upeo wa ukubwa wa faili: ${size} MB";

  static String m40(count) => "Wageni wasiozidi ${count} wanaruhusiwa";

  static String m41(maxQuantity) =>
      "Kiasi cha juu kabisa kinachoruhusiwa kwenye rukwama ni ${maxQuantity}";
  ...
  static String m44(count) => "Angalau herufi ${count} zinahitajika";
  ...
  static String m46(day) => "Kukaa kwa chini ni siku ${day}";

  static String m47(amount) =>
      "Kuponi hii inahitaji ununuzi wa angalau ${amount}.";

  static String m48(value) => "Kiwango cha chini cha muamala: ${value}";

  static String m49(count) => "Wageni wasiopungua ${count} wanahitajika";

  static String m50(store) => "Zaidi kutoka ${store}";

  static String m51(number) => "Lazima inunuliwe katika vikundi vya ${number}";

  static String m52(itemCount) => "Vitu ${itemCount}";

  static String m53(amount) => "Lipa ${amount}";

  static String m54(date) => "Malipo yanayostahili: ${date}";

  static String m55(name) => "${name} imeongezwa kwenye kikapu";

  static String m56(total) => "Kiasi: ${total}";

  static String m57(name) => "Umepokea pesa kutoka kwa ${name}";

  static String m58(count) =>
      "Je, ungependa kuondoa vipengee ${count} kutoka kwenye orodha yako ya matamanio?";

  static String m59(percent) => "Punguzo ${percent}%";

  static String m60(keyword, count) => "${keyword} (${count} bidhaa)";

  static String m61(keyword, count) => "${keyword} (${count} bidhaa)";

  static String m62(totalCartQuantity) =>
      "Kikapu cha ununuzi, vitu ${totalCartQuantity}";

  static String m63(numberOfUnitsSold) => "Imeuzwa: ${numberOfUnitsSold}";

  static String m64(price) => "Inaanzia ${price}";

  static String m65(fieldName) => "Sehemu ya ${fieldName} inahitajika";

  static String m66(total) => "Jumla ya Bidhaa: ${total}";

  static String m67(name) => "Hamisha pesa kwa ${name}";

  static String m68(price) => "Hadi ${price}";

  static String m69(amount) => "Tumia pointi ${amount} ";
  ...
  static String m71(time) => "Itatumika hadi: ${time}";

  static String m72(date) => "Halali hadi ${date}";

  static String m73(number) => "Toleo la ${number}";

  static String m74(balance) => "Salio la Pochi: ${balance}";

  static String m75(message) => "Onyo: ${message}";
  ...
  static String m77(week) => "Wiki ${week}";

  static String m78(name) => "Karibu ${name}";

  static String m79(count) => "Unachagua vipengee ${count} ";

  static String m80(type) => "Umepita ${type}";

  static String m81(point) => "Una pointi ${point}";

  static String m82(price) => "Umeokoa ${price}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "addMediaToPlaylist": MessageLookupByLibrary.simpleMessage(
      "Ongeza Media kwenye Orodha ya Kucheza",
    ),
    "addMediaToPlaylistFailed": MessageLookupByLibrary.simpleMessage(
      "Imeshindwa kuongeza media kwenye orodha ya kucheza.",
    ),
    "addMediaToPlaylistSuccess": MessageLookupByLibrary.simpleMessage(
      "Media imeongezwa kwenye orodha ya kucheza kwa mafanikio.",
    ),
    ...
    "addNewAttribute": MessageLookupByLibrary.simpleMessage("Ongeza sifa mpya"),
    ...
    "auctionItemDidNotMakeItToReservePrice":
        MessageLookupByLibrary.simpleMessage(
          "Bidhaa ya mnada haikufikia bei ya akiba",
        ),
    ...
    "banner": MessageLookupByLibrary.simpleMessage("Bango"),
    ...
    "bookingCancelledSuccessfully": MessageLookupByLibrary.simpleMessage(
      "Uwekaji umefutwa kwa mafanikio",
    ),
    ...
    "bookingDate": MessageLookupByLibrary.simpleMessage("Tarehe ya Uwekaji"),
    "bookingDeletedSuccessfully": MessageLookupByLibrary.simpleMessage(
      "Uwekaji nafasi umefutwa kwa mafanikio",
    ),
    ...
    "cancelBooking": MessageLookupByLibrary.simpleMessage("Ghairi Uwekaji"),
    "cancelBookingFailed": MessageLookupByLibrary.simpleMessage(
      "Imeshindikana kughairi nafasi ya booking.",
    ),
    ...
    "catalogVisibility": MessageLookupByLibrary.simpleMessage(
      "Mwonekano wa katalogi",
    ),
    "catalogVisibilityTooltip": MessageLookupByLibrary.simpleMessage(
      "Mpangilio huu huamua ni kurasa zipi za duka bidhaa zitaorodheshwa.",
    ),
    ...
    "characterRemain": m12,
    "chargeBack": MessageLookupByLibrary.simpleMessage("Malipo Yamekataliwa"),
    ...
    "confirmCancelBooking": MessageLookupByLibrary.simpleMessage(
      "Una uhakika unataka kufuta uwekaji huu?",
    ),
    ...
    "createIndex": MessageLookupByLibrary.simpleMessage("Unda Kielezo"),
    ...
    "deleteBooking": MessageLookupByLibrary.simpleMessage("Futa Uwekaji"),
    "deleteBookingFailed": MessageLookupByLibrary.simpleMessage(
      "Imeshindikana kufuta nafasi ya booking.",
    ),
    ...
    "denied": MessageLookupByLibrary.simpleMessage("Imekataliwa"),
    ...
    "eventsCategories": MessageLookupByLibrary.simpleMessage("Aina za Matukio"),
    ...
    "failed": MessageLookupByLibrary.simpleMessage("Imeshindikana"),
    "failedToCreateReview": MessageLookupByLibrary.simpleMessage(
      "Imeshindwa kuunda hakiki",
    ),
    ...
    "featureImage": MessageLookupByLibrary.simpleMessage("Picha Iliyoangaziwa"),
    ...
    "finalCost": MessageLookupByLibrary.simpleMessage("Gharama ya mwisho"),
    ...
    "getTicket": MessageLookupByLibrary.simpleMessage("Pata Tiketi"),
    ...
    "hidden": MessageLookupByLibrary.simpleMessage("Imefichwa"),
    ...
    "messageToListingOwner": MessageLookupByLibrary.simpleMessage(
      "Ujumbe wako mfupi kwa mmiliki wa tangazo (si lazima)",
    ),
    ...
    "missingFirestoreIndexDescription": MessageLookupByLibrary.simpleMessage(
      "Utafutaji huu unahitaji kielezo. Tafadhali ingia kwenye konsoli ya Firebase na unda kielezo kwa kubofya kitufe hapa chini. Unahitaji kusubiri kidogo ili kiwezeshwe.",
    ),
    "missingFirestoreIndexTitle": MessageLookupByLibrary.simpleMessage(
      "Kielezo cha Firestore kinakosekana!",
    ),
    ...
    "network": MessageLookupByLibrary.simpleMessage("Mtandao"),
    ...
    "noMembershipPlans": MessageLookupByLibrary.simpleMessage(
      "Hakuna mipango ya uanachama inayopatikana",
    ),
    ...
    "onHold": MessageLookupByLibrary.simpleMessage("Imesitishwa"),
    ...
    "pleaseAdjustYourCart": MessageLookupByLibrary.simpleMessage(
      "Tafadhali rekebisha rukwama yako kabla ya kuendelea na malipo.",
    ),
    ...
    "processed": MessageLookupByLibrary.simpleMessage("Imeshughulikiwa"),
    ...
    "quoteLabel": MessageLookupByLibrary.simpleMessage("Nukuu"),
    ...
    "refunded": MessageLookupByLibrary.simpleMessage("Imerejeshewa Pesa"),
    ...
    "reversed": MessageLookupByLibrary.simpleMessage("Imerejeshwa"),
    ...
    "saleFromDate": MessageLookupByLibrary.simpleMessage(
      "Tarehe ya Mauzo Kuanzia",
    ),
    "salePrice": MessageLookupByLibrary.simpleMessage("Bei ya punguzo"),
    "saleToDate": MessageLookupByLibrary.simpleMessage("Tarehe ya Mauzo Hadi"),
    "saleToDateCannotBeEarlier": MessageLookupByLibrary.simpleMessage(
      "Tarehe ya mwisho ya mauzo haiwezi kuwa kabla ya tarehe ya kuanza kwa mauzo.",
    ),
    ...
    "scheduleSale": MessageLookupByLibrary.simpleMessage("Ratiba ya Mauzo"),
    ...
    "serviceCategories": MessageLookupByLibrary.simpleMessage("Aina za Huduma"),
    ...
    "shopOnly": MessageLookupByLibrary.simpleMessage("Duka pekee"),
    ...
    "thisIsSealedBidAuction": MessageLookupByLibrary.simpleMessage(
      "Huu ni mnada wa zabuni zilizofichwa.",
    ),
    ...
    "totalCost": MessageLookupByLibrary.simpleMessage("Gharama jumla"),
    ...
    "voided": MessageLookupByLibrary.simpleMessage("Imefutwa"),
    ...
    "waitingOwnerConfirmation": MessageLookupByLibrary.simpleMessage(
      "Inasubiri uthibitisho wa mmiliki",
    ),
    ...
    "yourRating": MessageLookupByLibrary.simpleMessage("Ukadiriaji Wako"),
