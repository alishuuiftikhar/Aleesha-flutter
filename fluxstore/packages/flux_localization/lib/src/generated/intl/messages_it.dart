...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m2(length) =>
      "Media aggiunta alla playlist. ${length} nuovo/i elemento/i aggiunto/i.";

  static String m3(attribute) => "Qualsiasi ${attribute}";

  static String m4(point) => "I tuoi punti disponibili: ${point}";

  static String m5(name) => "Offerta piazzata con successo per \'${name}\'";

  static String m6(id) => "Prenotazione #${id}";

  static String m7(date) => "Prenotazione richiesta il: ${date}";

  static String m8(amount) => "Acquista ora per ${amount}";

  static String m9(author) => "Di ${author}";

  static String m10(fieldName) =>
      "${fieldName} deve contenere almeno 3 caratteri";

  static String m11(currency) => "Valuta modificata in ${currency}";

  static String m12(number) => "Caratteri rimanenti: ${number}";
  ...
  static String m16(count) => "${count} ospite";

  static String m17(count) => "${count} ospiti";

  static String m18(count) => "${count} articolo";

  static String m19(count) => "${count} articoli";

  static String m20(count) => "${count} prodotto";

  static String m21(count) => "${count} prodotti";

  static String m22(count) => "${count} biglietto";

  static String m23(count) => "${count} biglietti";

  static String m24(country) => "${country} non è supportato";

  static String m25(currency) => "${currency} non è supportata";
  ...
  static String m28(timeLeft) => "Termina tra ${timeLeft}";

  static String m29(captcha) => "Inserisci ${captcha} per confermare:";

  static String m30(message) => "Errore: ${message}";

  static String m31(message) => "Errore: ${message}";

  static String m32(error) => "Si è verificato un errore: ${error}";

  static String m33(date) => "Data evento: ${date}";

  static String m34(time) => "Scade tra ${time}";
  ...
  static String m39(size) => "Dimensione massima file: ${size} MB";

  static String m40(count) => "Sono ammessi al massimo ${count} ospiti";

  static String m41(maxQuantity) =>
      "La quantità massima consentita nel carrello è ${maxQuantity}";
  ...
  static String m44(count) => "Sono richiesti almeno ${count} caratteri";
  ...
  static String m46(day) => "Il soggiorno minimo è di ${day} giorni";

  static String m47(amount) =>
      "Questo coupon richiede un acquisto minimo di ${amount}.";

  static String m48(value) => "Transazione minima: ${value}";

  static String m49(count) => "Sono richiesti almeno ${count} ospite/i";

  static String m50(store) => "Altri prodotti da ${store}";

  static String m51(number) => "Deve essere acquistato in gruppi di ${number}";

  static String m52(itemCount) => "${itemCount} articoli";

  static String m53(amount) => "Paga ${amount}";

  static String m54(date) => "Pagamento dovuto entro: ${date}";

  static String m55(name) => "${name} aggiunto al carrello";

  static String m56(total) => "Qtà: ${total}";

  static String m57(name) => "Ricevuto denaro da ${name}";

  static String m58(count) => "Vuoi rimuovere ${count} articoli dai preferiti?";

  static String m59(percent) => "Sconto ${percent}%";

  static String m60(keyword, count) => "${keyword} (${count} risultato)";

  static String m61(keyword, count) => "${keyword} (${count} risultati)";

  static String m62(totalCartQuantity) =>
      "Carrello, ${totalCartQuantity} articoli";

  static String m63(numberOfUnitsSold) => "Venduto: ${numberOfUnitsSold}";

  static String m64(price) => "A partire da ${price}";

  static String m65(fieldName) => "Il campo ${fieldName} è obbligatorio";

  static String m66(total) => "${total} prodotti";

  static String m67(name) => "Trasferisci denaro a ${name}";

  static String m68(price) => "Fino a ${price}";

  static String m69(amount) => "Usa ${amount} punti";
  ...
  static String m71(time) => "Valido fino al: ${time}";

  static String m72(date) => "Valido fino al ${date}";

  static String m73(number) => "Versione ${number}";

  static String m74(balance) => "Saldo portafoglio: ${balance}";

  static String m75(message) => "Attenzione: ${message}";
  ...
  static String m77(week) => "Settimana ${week}";

  static String m78(name) => "Benvenuto ${name}";

  static String m79(count) => "Stai selezionando ${count} articoli";

  static String m80(type) => "Hai superato ${type}";

  static String m81(point) => "Hai ${point} punti";

  static String m82(price) => "Hai risparmiato ${price}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "auctionItemDidNotMakeItToReservePrice":
        MessageLookupByLibrary.simpleMessage(
          "L’oggetto dell’asta non ha raggiunto il prezzo di riserva",
        ),
    ...
    "bookingDate": MessageLookupByLibrary.simpleMessage(
    ...
    "cannotGetPaymentURL": MessageLookupByLibrary.simpleMessage(
      "Impossibile ottenere l’URL di pagamento",
    ),
    ...
    "catalogVisibilityTooltip": MessageLookupByLibrary.simpleMessage(
      "Questa impostazione determina in quali pagine del negozio verranno elencati i prodotti.",
    ),
    ...
    "characterRemain": m12,
    "chargeBack": MessageLookupByLibrary.simpleMessage("Contestazione"),
    ...
    "createIndex": MessageLookupByLibrary.simpleMessage("Crea Indice"),
    ...
    "denied": MessageLookupByLibrary.simpleMessage("Rifiutato"),
    ...
    "failedToCreateReview": MessageLookupByLibrary.simpleMessage(
      "Creazione della recensione non riuscita",
    ),
    ...
    "finalCost": MessageLookupByLibrary.simpleMessage("Costo finale"),
    ...
    "getTicket": MessageLookupByLibrary.simpleMessage("Ottieni biglietto"),
    ...
    "haveACoupon": MessageLookupByLibrary.simpleMessage("Hai un coupon?"),
    "haveYouGotQuestion": MessageLookupByLibrary.simpleMessage(
      "Hai una domanda? Scrivici!",
    ),
    "hidden": MessageLookupByLibrary.simpleMessage("Nascosto"),
    ...
    "messageToListingOwner": MessageLookupByLibrary.simpleMessage(
      "Il tuo breve messaggio al proprietario dell\'annuncio (facoltativo)",
    ),
    ...
    "missingFirestoreIndexDescription": MessageLookupByLibrary.simpleMessage(
      "Questa query richiede un indice. Accedi alla console Firebase e crea l’indice cliccando sul pulsante qui sotto. Attendi qualche istante affinché venga abilitato.",
    ),
    ...
    "onHold": MessageLookupByLibrary.simpleMessage("In attesa"),
    ...
    "pleaseAdjustYourCart": MessageLookupByLibrary.simpleMessage(
      "Modifica il carrello prima di procedere al pagamento.",
    ),
    ...
    "processed": MessageLookupByLibrary.simpleMessage("Elaborato"),
    ...
    "quoteLabel": MessageLookupByLibrary.simpleMessage("Preventivo"),
    ...
    "refunded": MessageLookupByLibrary.simpleMessage("Rimborsato"),
    ...
    "reversed": MessageLookupByLibrary.simpleMessage("Stornato"),
    ...
    "sale": m59,
    "saleFromDate": MessageLookupByLibrary.simpleMessage("Data inizio vendita"),
    "salePrice": MessageLookupByLibrary.simpleMessage("Prezzo Scontato"),
    "saleToDate": MessageLookupByLibrary.simpleMessage("Data fine vendita"),
    "saleToDateCannotBeEarlier": MessageLookupByLibrary.simpleMessage(
      "La data di fine vendita non può essere precedente alla data di inizio vendita.",
    ),
    ...
    "scheduleSale": MessageLookupByLibrary.simpleMessage("Programma vendita"),
    ...
    "shopAndSearchResults": MessageLookupByLibrary.simpleMessage(
      "Negozio e risultati di ricerca",
    ),
    ...
    "shopOnly": MessageLookupByLibrary.simpleMessage("Solo negozio"),
    ...
    "thisIsSealedBidAuction": MessageLookupByLibrary.simpleMessage(
      "Questa è un’asta a offerta segreta.",
    ),
    ...
    "voided": MessageLookupByLibrary.simpleMessage("Annullato"),
    ...
    "waitingOwnerConfirmation": MessageLookupByLibrary.simpleMessage(
      "In attesa di conferma del proprietario",
    ),
    ...
    "writeTitleOptional": MessageLookupByLibrary.simpleMessage(
      "Scrivi il tuo titolo (opzionale)",
    ),
