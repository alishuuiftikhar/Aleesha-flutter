...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m16(count) => "${count} 位宾客";

  static String m17(count) => "${count} 位宾客";

  static String m18(count) => "${count}项";

  static String m19(count) => "${count}个项目";

  static String m20(count) => "${count}件商品";

  static String m21(count) => "${count}件商品";

  static String m22(count) => "${count} 张票";

  static String m23(count) => "${count} 张票";

  static String m24(country) => "不支持${country}";

  static String m25(currency) => "不支持${currency}";

  static String m26(currency) =>
      "您的 Razorpay 账户不支持 ${currency} 货币。请联系支持以启用国际支付，或更改为支持的货币。";

  static String m27(total) => "约${total}公里";

  static String m28(timeLeft) => "剩余 ${timeLeft}";

  static String m29(captcha) => "输入${captcha}进行确认：";

  static String m30(message) => "错误：${message}";

  static String m31(message) => "错误：${message}";

  static String m32(error) => "发生错误：${error}";

  static String m33(date) => "活动日期：${date}";

  static String m34(time) => "${time} 后过期";

  static String m35(total) => "大于${total}公里";

  static String m36(currentBalance) => "您的钱包余额仅剩${currentBalance}";

  static String m37(message) => "应用程序在请求数据时出现问题，请联系管理员解决：${message}";

  static String m38(currency, amount) => "使用此支付方式的最大金额为${currency} ${amount}";

  static String m39(size) => "最大文件大小：${size} MB";

  static String m40(count) => "最多允许 ${count} 位客人";

  static String m41(maxQuantity) => "购物车中允许的最大数量为${maxQuantity}";

  static String m42(name, formattedPrice) => "${name}：${formattedPrice}";

  static String m43(currency, amount) => "使用此支付方式的最小金额为${currency} ${amount}";

  static String m44(count) => "至少需要 ${count} 个字符";

  static String m45(storeName, minOrderAmount) =>
      " ${storeName} 的最低订购金额为 ${minOrderAmount}。请从该商店添加更多商品！";

  static String m46(day) => "最少入住 ${day} 天";

  static String m47(amount) => "此优惠券要求最低购买金额为 ${amount}。";

  static String m48(value) => "最低交易次数： ${value}";

  static String m49(count) => "至少需要 ${count} 位客人";

  static String m50(store) => "${store}的更多商品";

  static String m51(number) => "必须按${number}件为单位购买";

  static String m52(itemCount) => "${itemCount} 件商品";

  static String m53(amount) => "支付${amount}";

  static String m54(date) => "付款截止日期：${date}";

  static String m55(name) => "已将${name}添加到购物车";

  static String m56(total) => "数量：${total}";

  static String m57(name) => "已收到来自${name}的款项";

  static String m58(count) => "是否要从心愿单中移除${count}件商品？";

  static String m59(percent) => "优惠 ${percent}%";

  static String m60(keyword, count) => "${keyword}（${count}项）";

  static String m61(keyword, count) => "${keyword}（${count}项）";

  static String m62(totalCartQuantity) => "购物车，${totalCartQuantity} 件商品";

  static String m63(numberOfUnitsSold) => "已售出：${numberOfUnitsSold}";

  static String m64(price) => "起价 ${price}";

  static String m65(fieldName) => "${fieldName}为必填项";

  static String m66(total) => "${total} 个商品";

  static String m67(name) => "转账给${name}";

  static String m68(price) => "最高 ${price}";

  static String m69(amount) => "使用 ${amount} 积分";

  static String m70(maxPointDiscount, maxPriceDiscount) =>
      "使用${maxPointDiscount}积分可获得此订单${maxPriceDiscount}的折扣！";

  static String m71(time) => "有效期至: ${time}";

  static String m72(date) => "有效期至 ${date}";

  static String m73(number) => "版本 ${number}";

  static String m74(balance) => "钱包余额：${balance}";

  static String m75(message) => "警告：${message}";

  static String m76(defaultCurrency) => "当前选择的货币不支持钱包功能，请改为${defaultCurrency}";

  static String m77(week) => "第 ${week} 周";

  static String m78(name) => "欢迎，${name}";

  static String m79(count) => "您已选择${count}个商品";

  static String m80(type) => "您已通过 ${type}";

  static String m81(point) => "您有 ${point} 积分";

  static String m82(price) => "您已节省${price}";
