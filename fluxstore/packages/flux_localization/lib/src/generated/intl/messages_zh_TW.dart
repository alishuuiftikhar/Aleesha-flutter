...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m16(count) => "${count} 位賓客";

  static String m17(count) => "${count} 位賓客";

  static String m18(count) => "${count}項";

  static String m19(count) => "${count}項";

  static String m20(count) => "${count}項";

  static String m21(count) => "${count}項";

  static String m22(count) => "${count} 張票";

  static String m23(count) => "${count} 張票";

  static String m24(country) => "不支援${country}";

  static String m25(currency) => "不支援${currency}";

  static String m26(currency) =>
      "您的 Razorpay 帳戶不支援 ${currency} 貨幣。請聯絡客服以啟用國際支付或更換為支援的貨幣。";

  static String m27(total) => "~${total} 公里";

  static String m28(timeLeft) => "結束於 ${timeLeft}";

  static String m29(captcha) => "輸入${captcha}以確認：";

  static String m30(message) => "錯誤：${message}";

  static String m31(message) => "錯誤：${message}";

  static String m32(error) => "發生錯誤：${error}";

  static String m33(date) => "活動日期：${date}";

  static String m34(time) => "將於 ${time} 到期";

  static String m35(total) => ">${total} 公里";

  static String m36(currentBalance) => "您的錢包餘額僅剩${currentBalance}";

  static String m37(message) => "請求資料時應用程式發生問題，請聯絡管理員解決問題：${message}";

  static String m38(currency, amount) => "使用此付款方式的最高金額為${currency} ${amount}";

  static String m39(size) => "最大檔案大小：${size} MB";

  static String m40(count) => "最多允許 ${count} 位客人";

  static String m41(maxQuantity) => "購物車中允許的最大數量為 ${maxQuantity}";

  static String m42(name, formattedPrice) => "${name}： ${formattedPrice}";

  static String m43(currency, amount) => "使用此付款方式的最低金額為${currency} ${amount}";

  static String m44(count) => "至少需要 ${count} 個字元";

  static String m45(storeName, minOrderAmount) =>
      " ${storeName} 的最低訂單金額為 ${minOrderAmount}。請從該商店添加更多商品！";

  static String m46(day) => "最少入住天數為 ${day} 天";

  static String m47(amount) => "此優惠券要求最低購買金額為 ${amount}。";

  static String m48(value) => "最低交易次數： ${value}";

  static String m49(count) => "至少需要 ${count} 位客人";

  static String m50(store) => "${store}的更多商品";

  static String m51(number) => "必須以${number}為一組購買";

  static String m52(itemCount) => "${itemCount} 個項目";

  static String m53(amount) => "支付${amount}";

  static String m54(date) => "付款截止日期：${date}";

  static String m55(name) => "${name}已成功加入購物車";

  static String m56(total) => "數量：${total}";

  static String m57(name) => "收到來自${name}的款項";

  static String m58(count) => "您想從心願清單中刪除 ${count} 件商品嗎？";

  static String m59(percent) => "特價 ${percent}%";

  static String m60(keyword, count) => "${keyword}（${count}項）";

  static String m61(keyword, count) => "${keyword}（${count}項）";

  static String m62(totalCartQuantity) => "購物車，${totalCartQuantity}件商品";

  static String m63(numberOfUnitsSold) => "已售出：${numberOfUnitsSold}";

  static String m64(price) => "起價 ${price}";

  static String m65(fieldName) => "${fieldName}為必填欄位";

  static String m66(total) => "${total}項商品";

  static String m67(name) => "轉帳給${name}";

  static String m68(price) => "最高 ${price}";

  static String m69(amount) => "使用 ${amount} 積分";

  static String m70(maxPointDiscount, maxPriceDiscount) =>
      "使用最多${maxPointDiscount}點積分可獲得此訂單${maxPriceDiscount}的折扣！";

  static String m71(time) => "有效期限至： ${time}";

  static String m72(date) => "有效期至 ${date}";

  static String m73(number) => "版本 ${number}";

  static String m74(balance) => "錢包餘額：${balance}";

  static String m75(message) => "警告：${message}";

  static String m76(defaultCurrency) => "目前選擇的貨幣不適用於錢包功能，請改為${defaultCurrency}";

  static String m77(week) => "第${week}週";

  static String m78(name) => "歡迎${name}";

  static String m79(count) => "您正在選擇 ${count} 項";

  static String m80(type) => "您已通過 ${type}";

  static String m81(point) => "您有${point}點積分";

  static String m82(price) => "您已節省 ${price}";
