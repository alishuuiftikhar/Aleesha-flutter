...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m2(length) =>
      "Phương tiện đã được thêm vào danh sách phát. ${length} mục mới đã được thêm.";

  static String m3(attribute) => "Bất kỳ ${attribute}";

  static String m4(point) => "Điểm hiện có của bạn: ${point}";

  static String m5(name) => "Đặt giá thầu thành công cho \'${name}\'";

  static String m6(id) => "Đặt chỗ #${id}";

  static String m7(date) => "Đã yêu cầu đặt chỗ vào: ${date}";

  static String m8(amount) => "Mua ngay với giá ${amount}";

  static String m9(author) => "Tác giả: ${author}";

  static String m10(fieldName) => "Độ dài ${fieldName} không được nhỏ hơn 3.";

  static String m11(currency) => "Đã thay đổi đơn vị tiền tệ thành ${currency}";

  static String m12(number) => "Còn lại ${number} ký tự";

  static String m13(date) => "Nhận phòng: ${date}";

  static String m14(date) => "Trả phòng: ${date}";

  static String m15(priceRate, pointRate) => "${priceRate} = ${pointRate} Điểm";

  static String m16(count) => "${count} khách";

  static String m17(count) => "${count} khách";

  static String m18(count) => "${count} mục";

  static String m19(count) => "${count} mục";

  static String m20(count) => "${count} sản phẩm";

  static String m21(count) => "${count} sản phẩm";

  static String m22(count) => "${count} vé";

  static String m23(count) => "${count} vé";

  static String m24(country) => "Quốc gia ${country} không được hỗ trợ";

  static String m25(currency) => "${currency} không được hỗ trợ";
  ...
  static String m28(timeLeft) => "Kết thúc sau ${timeLeft}";

  static String m29(captcha) => "Nhập ${captcha} để xác nhận:";

  static String m30(message) => "Lỗi: ${message}";

  static String m31(message) => "Lỗi: ${message}";

  static String m32(error) => "Có lỗi xảy ra: ${error}";

  static String m33(date) => "Ngày sự kiện: ${date}";

  static String m34(time) => "Hết hạn sau ${time}";
  ...
  static String m39(size) => "Kích thước tệp tối đa: ${size} MB";

  static String m40(count) => "Tối đa ${count} khách được phép";

  static String m41(maxQuantity) =>
      "Số lượng tối đa cho phép trong giỏ hàng là ${maxQuantity}";
  ...
  static String m44(count) => "Yêu cầu tối thiểu ${count} ký tự";
  ...
  static String m46(day) => "Thời gian lưu trú tối thiểu là ${day} ngày";

  static String m47(amount) =>
      "Phiếu giảm giá này yêu cầu giá trị mua tối thiểu là ${amount}.";

  static String m48(value) => "Giao dịch tối thiểu: ${value}";

  static String m49(count) => "Yêu cầu tối thiểu ${count} khách";

  static String m50(store) => "Thêm từ ${store}";

  static String m51(number) => "phải mua theo nhóm ${number}";

  static String m52(itemCount) => "${itemCount} sản phẩm";

  static String m53(amount) => "Thanh toán ${amount}";

  static String m54(date) => "Hạn thanh toán: ${date}";

  static String m55(name) => "${name} đã được thêm vào giỏ hàng thành công";

  static String m56(total) => "SL: ${total}";

  static String m57(name) => "Nhận tiền từ ${name}";

  static String m58(count) =>
      "Bạn có muốn xóa ${count} sản phẩm khỏi danh sách mong muốn của mình không?";

  static String m59(percent) => "Giảm ${percent}%";

  static String m60(keyword, count) => "${keyword} (${count} mục)";

  static String m61(keyword, count) => "${keyword} (${count} mục)";

  static String m62(totalCartQuantity) =>
      "Giỏ hàng, ${totalCartQuantity} sản phẩm";

  static String m63(numberOfUnitsSold) => "Đã bán: ${numberOfUnitsSold}";

  static String m64(price) => "Bắt đầu từ ${price}";

  static String m65(fieldName) => "Trường ${fieldName} là bắt buộc";

  static String m66(total) => "${total} sản phẩm";

  static String m67(name) => "Chuyển tiền đến ${name}";

  static String m68(price) => "Tối đa ${price}";

  static String m69(amount) => "Sử dụng ${amount} điểm";
  ...
  static String m71(time) => "Có hiệu lực đến: ${time}";

  static String m72(date) => "Có giá trị đến ${date}";

  static String m73(number) => "Phiên bản ${number}";

  static String m74(balance) => "Số dư ví: ${balance}";

  static String m75(message) => "Cảnh báo: ${message}";
  ...
  static String m77(week) => "Tuần ${week}";

  static String m78(name) => "Chào mừng ${name}";

  static String m79(count) => "Bạn đang chọn ${count} mục";

  static String m80(type) => "Bạn đã vượt qua ${type}";

  static String m81(point) => "Bạn có ${point} điểm";

  static String m82(price) => "Bạn đã tiết kiệm được ${price}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "addMediaToPlaylist": MessageLookupByLibrary.simpleMessage(
      "Thêm phương tiện vào danh sách phát",
    ),
    "addMediaToPlaylistFailed": MessageLookupByLibrary.simpleMessage(
      "Thêm phương tiện vào danh sách phát thất bại.",
    ),
    "addMediaToPlaylistSuccess": MessageLookupByLibrary.simpleMessage(
      "Phương tiện đã được thêm vào danh sách phát thành công.",
    ),
    ...
    "auctionItemDidNotMakeItToReservePrice":
        MessageLookupByLibrary.simpleMessage(
          "Món đấu giá không đạt được giá dự phòng",
        ),
    ...
    "bookingDate": MessageLookupByLibrary.simpleMessage("Ngày đặt chỗ"),
    "bookingDeletedSuccessfully": MessageLookupByLibrary.simpleMessage(
      "Đã xóa đặt chỗ thành công",
    ),
    "bookingDetails": MessageLookupByLibrary.simpleMessage("Chi tiết đặt chỗ"),
    "bookingHistory": MessageLookupByLibrary.simpleMessage("Lịch sử đặt chỗ"),
    "bookingID": m6,
    "bookingLocation": MessageLookupByLibrary.simpleMessage("Địa điểm đặt chỗ"),
    ...
    "cancelBooking": MessageLookupByLibrary.simpleMessage("Hủy đặt chỗ"),
    ...
    "catalogVisibilityTooltip": MessageLookupByLibrary.simpleMessage(
      "Cài đặt này xác định sản phẩm sẽ được liệt kê trên những trang cửa hàng nào.",
    ),
    ...
    "characterRemain": m12,
    "chargeBack": MessageLookupByLibrary.simpleMessage("Bị thu hồi"),
    ...
    "createIndex": MessageLookupByLibrary.simpleMessage("Tạo chỉ mục"),
    ...
    "deleteBooking": MessageLookupByLibrary.simpleMessage("Xóa đặt chỗ"),
    "deleteBookingFailed": MessageLookupByLibrary.simpleMessage(
      "Xóa đặt chỗ không thành công.",
    ),
    ...
    "denied": MessageLookupByLibrary.simpleMessage("Bị từ chối"),
    ...
    "featureImage": MessageLookupByLibrary.simpleMessage("Ảnh nổi bật"),
    ...
    "finalCost": MessageLookupByLibrary.simpleMessage("Chi phí cuối cùng"),
    ...
    "getTicket": MessageLookupByLibrary.simpleMessage("Nhận vé"),
    ...
    "instantBooking": MessageLookupByLibrary.simpleMessage("Đặt ngay"),
    ...
    "messageToListingOwner": MessageLookupByLibrary.simpleMessage(
      "Tin nhắn ngắn của bạn gửi cho chủ tin đăng (không bắt buộc)",
    ),
    ...
    "missingFirestoreIndexDescription": MessageLookupByLibrary.simpleMessage(
      "Truy vấn này cần một chỉ mục. Vui lòng đăng nhập vào Firebase console và tạo chỉ mục bằng cách nhấn nút bên dưới. Bạn cần đợi một chút để chỉ mục được kích hoạt.",
    ),
    "missingFirestoreIndexTitle": MessageLookupByLibrary.simpleMessage(
      "Thiếu chỉ mục Firestore!",
    ),
    ...
    "noMembershipPlans": MessageLookupByLibrary.simpleMessage(
      "Không có gói thành viên nào khả dụng",
    ),
    ...
    "onHold": MessageLookupByLibrary.simpleMessage("Đang chờ"),
    ...
    "pendingPayment": MessageLookupByLibrary.simpleMessage("Chờ thanh toán"),
    ...
    "quoteLabel": MessageLookupByLibrary.simpleMessage("Báo giá"),
    ...
    "reversed": MessageLookupByLibrary.simpleMessage("Đã đảo ngược"),
    ...
    "saleToDateCannotBeEarlier": MessageLookupByLibrary.simpleMessage(
      "Ngày kết thúc khuyến mãi không thể sớm hơn ngày bắt đầu khuyến mãi.",
    ),
    ...
    "scheduleSale": MessageLookupByLibrary.simpleMessage("Lên lịch khuyến mãi"),
    ...
    "totalCost": MessageLookupByLibrary.simpleMessage("Tổng chi phí"),
    ...
    "voided": MessageLookupByLibrary.simpleMessage("Đã hủy"),
    ...
    "writeTitleOptional": MessageLookupByLibrary.simpleMessage(
      "Viết tiêu đề của bạn (Không bắt buộc)",
    ),
    ...
    "yourRating": MessageLookupByLibrary.simpleMessage("Đánh giá của bạn"),
