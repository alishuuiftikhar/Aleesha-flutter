...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m2(length) =>
      "Medij je dodan na playlistu. ${length} novih stavki dodano.";

  static String m3(attribute) => "Bilo koji ${attribute}";

  static String m4(point) => "Vaši dostupni bodovi: ${point}";

  static String m5(name) => "Uspješno postavljena ponuda za \'${name}\'";

  static String m6(id) => "Rezervacija #${id}";

  static String m7(date) => "Rezervacija zatražena: ${date}";

  static String m8(amount) => "Kupite sada za ${amount}";
  ...
  static String m11(currency) => "Valuta promijenjena u ${currency}";

  static String m12(number) => " Preostalo znakova:${number} ";
  ...
  static String m18(count) => "${count} stavka";

  static String m19(count) => "${count} stavki";

  static String m20(count) => "${count} stavka";

  static String m21(count) => "${count} stavki";

  static String m22(count) => "${count} karta";

  static String m23(count) => "${count} karte";

  static String m24(country) => "${country} zemlja nije podržana";

  static String m25(currency) => "${currency} nije podržana";
  ...
  static String m28(timeLeft) => "Završava za ${timeLeft}";

  static String m29(captcha) => "Unesite ${captcha} za potvrdu:";

  static String m30(message) => "Greška: ${message}";

  static String m31(message) => "Greška: ${message}";

  static String m32(error) => "Došlo je do greške: ${error}";

  static String m33(date) => "Datum događaja: ${date}";

  static String m34(time) => "Ističe za ${time}";
  ...
  static String m39(size) => "Maksimalna veličina datoteke: ${size} MB";
  ...
  static String m44(count) => "Potrebno je najmanje ${count} znakova";
  ...
  static String m48(value) => "Minimalna transakcija: ${value}";

  static String m49(count) => "Potrebno je najmanje ${count} gost(a)";

  static String m50(store) => "Više od ${store}";

  static String m51(number) => "mora se kupiti u grupama od ${number}";

  static String m52(itemCount) => "${itemCount} artikala";

  static String m53(amount) => "Plati ${amount}";

  static String m54(date) => "Plaćanje do: ${date}";

  static String m55(name) => "${name} su uspješno dodani u korpu";

  static String m56(total) => "Količina: ${total}";

  static String m57(name) => "Primljen novac od ${name}";

  static String m58(count) =>
      "Želite li ukloniti sljedeći broj stavki: ${count} sa svoje liste želja?";

  static String m59(percent) => "Sniženje ${percent}%";

  static String m60(keyword, count) => "${keyword} (${count} stavka)";

  static String m61(keyword, count) => "${keyword} (${count} stavki)";

  static String m62(totalCartQuantity) =>
      "Korpa, ${totalCartQuantity} artikala";

  static String m63(numberOfUnitsSold) => "Prodano: ${numberOfUnitsSold}";

  static String m64(price) => "Počinje od ${price}";

  static String m65(fieldName) => "Polje ${fieldName} je obavezno";

  static String m66(total) => "${total} proizvoda";

  static String m67(name) => "Prenesite novac na ${name}";

  static String m68(price) => "Do ${price}";

  static String m69(amount) => "Iskoristite ${amount} poena";
  ...
  static String m71(time) => "Vrijedi do: ${time}";

  static String m72(date) => "Važi do ${date}";

  static String m73(number) => "Verzija ${number}";

  static String m74(balance) => "Stanje novčanika: ${balance}";

  static String m75(message) => "Upozorenje: ${message}";
  ...
  static String m77(week) => "Sedmica ${week}";

  static String m78(name) => "Dobro došli ${name}";

  static String m79(count) => "Odabirete sljedeći broj stavki: ${count} ";

  static String m80(type) => "Prošli ste ${type}";

  static String m81(point) => "Imate ${point} bodova";

  static String m82(price) => "Uštedjeli ste ${price}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "auctionItemDidNotMakeItToReservePrice":
        MessageLookupByLibrary.simpleMessage(
          "Aukcijski predmet nije dostigao minimalnu cijenu",
        ),
    ...
    "cancelBookingFailed": MessageLookupByLibrary.simpleMessage(
      "Nije uspjelo otkazivanje rezervacije.",
    ),
    ...
    "canceledReversal": MessageLookupByLibrary.simpleMessage("Povrat poništen"),
    ...
    "cannotGetPaymentURL": MessageLookupByLibrary.simpleMessage(
      "Nije moguće dobiti URL za plaćanje",
    ),
    ...
    "catalogVisibilityTooltip": MessageLookupByLibrary.simpleMessage(
      "Ova postavka određuje na kojim će se stranicama trgovine proizvodi prikazivati.",
    ),
    ...
    "characterRemain": m12,
    "chargeBack": MessageLookupByLibrary.simpleMessage("Povrat sredstava"),
    ...
    "deleteBookingFailed": MessageLookupByLibrary.simpleMessage(
      "Nije uspjelo brisanje rezervacije.",
    ),
    ...
    "failed": MessageLookupByLibrary.simpleMessage("Neuspješno"),
    "failedToCreateReview": MessageLookupByLibrary.simpleMessage(
      "Neuspješno kreiranje recenzije",
    ),
    ...
    "finalCost": MessageLookupByLibrary.simpleMessage("Konačni trošak"),
    ...
    "messageToListingOwner": MessageLookupByLibrary.simpleMessage(
      "Vaša kratka poruka vlasniku oglasa (opcionalno)",
    ),
    ...
    "missingFirestoreIndexDescription": MessageLookupByLibrary.simpleMessage(
      "Ovaj upit zahtijeva indeks. Prijavite se na Firebase konzolu i kreirajte indeks klikom na dugme ispod. Potrebno je sačekati trenutak da bude omogućen.",
    ),
    ...
    "pleaseAdjustYourCart": MessageLookupByLibrary.simpleMessage(
      "Molimo prilagodite svoju korpu prije nego što nastavite na plaćanje.",
    ),
    ...
    "reservePriceHasBeenMet": MessageLookupByLibrary.simpleMessage(
      "Minimalna cijena je dostignuta",
    ),
    "reservePriceHasNotBeenMet": MessageLookupByLibrary.simpleMessage(
      "Minimalna cijena nije dostignuta",
    ),
    ...
    "shopOnly": MessageLookupByLibrary.simpleMessage("Samo trgovina"),
    ...
    "totalCost": MessageLookupByLibrary.simpleMessage("Ukupni trošak"),
    ...
    "writeTitleOptional": MessageLookupByLibrary.simpleMessage(
      "Napišite svoj naslov (opcionalno)",
    ),
    ...
    "yourRating": MessageLookupByLibrary.simpleMessage("Vaša ocjena"),
