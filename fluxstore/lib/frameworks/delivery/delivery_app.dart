...
class DeliveryApp extends StatefulWidget {
  ...
  const DeliveryApp({super.key, this.user, this.locale, this.isFromMV = false});
                    ...
                    body: MultiProvider(
                      providers: [
                        ChangeNotifierProvider<DeliveryStatModel>(
                          create: (_) => DeliveryStatModel(model2.user),
                          lazy: false,
                        ),
                        ...
                        ChangeNotifierProvider<DeliveryOrderModel>(
                          create: (_) => DeliveryOrderModel(model2.user),
                          lazy: false,
                        ),
                          ...
                          builder: (BuildContext context) =>
                              Consumer<DeliveryAuthenticationModel>(
                                builder: (context, model2, _) => LayoutBuilder(
                                  builder: (context, _) {
                                    if (model2.state !=
                                        DeliveryAuthenticationModelState
                                            .loggedIn) {
                                    ...
                                    return MultiProvider(
                                      providers: [
                                        ...
                                        >(
                                          create: (_) =>
                                              DeliveryOrderModel(model2.user),
                                          lazy: false,
                                        ),
                                        ChangeNotifierProvider<MapModel>(
                                          create: (_) => MapModel(),
