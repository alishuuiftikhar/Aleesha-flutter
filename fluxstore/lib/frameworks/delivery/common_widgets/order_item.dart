    ...
    return Container(
      ...
      child: GestureDetector(
        onTap: () => Navigator.push(
          ...
          MaterialPageRoute(
            builder: (context) =>
                OrderDetailScreen(order: order, onCallBack: onCallBack),
          ),
        ),
        child: Container(
          decoration: BoxDecoration(
            ...
            boxShadow: [
              BoxShadow(
                color: Colors.grey.withValueOpacity(0.05),
                spreadRadius: 2,
                blurRadius: 4,
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  ...
                  CircleAvatar(
                    radius: 23,
                    backgroundColor: order.deliveryStatus!.displayColor(
                      context,
                    ),
                    child: Icon(
              ...
              const SizedBox(height: 10),
              const Divider(height: 10.0, indent: 10, endIndent: 10),
              const SizedBox(height: 10),
              Row(
                children: [
                  Expanded(
                        ...
                        Row(
                          children: [
                            ...
                            Icon(
                              ...
                              color: Theme.of(
                                context,
                              ).colorScheme.secondary.withValueOpacity(0.4),
                              size: 19,
                            ),
                            const SizedBox(width: 20),
                            Flexible(
                  ...
                  Expanded(
                    ...
                    child: TextButton.icon(
                      style: TextButton.styleFrom(
                        ...
                        backgroundColor: theme.primaryColor.withValueOpacity(
                          0.08,
                        ),
                      ),
