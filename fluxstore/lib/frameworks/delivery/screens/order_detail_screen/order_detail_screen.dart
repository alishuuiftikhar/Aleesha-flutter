...
class _OrderDetailScreenState extends State<OrderDetailScreen> {
  ...
  void initState() {
    if (widget.order != null) {
      ...
      final orders = Provider.of<DeliveryOrderModel>(
        context,
        listen: false,
      ).orders;
  ...
  Widget build(BuildContext context) {
    ...
    final user = Provider.of<DeliveryAuthenticationModel>(
      context,
      listen: false,
    ).user;
              ...
              body: SizedBox(
                ...
                child: Center(
                  child: Column(
                    ...
                    children: [
                      const Icon(CupertinoIcons.info_circle, color: Colors.red),
                        ...
                        background: Stack(
                          children: <Widget>[
                            Positioned(
                              ...
                              child: FluxImage(
                                imageUrl:
                                    order.store?.banner ?? kDefaultStoreBanner,
                                fit: ImageTools.boxFit(kVendorConfig.bannerFit),
                              ),
                            ),
                            Positioned(
                              child: Container(
                                color: Colors.black12.withValueOpacity(0.2),
                              ),
                            ),
                          ],
                        ),
                            ...
                            Container(
                              ...
                              child: Center(
                                child: CircleAvatar(
                                  radius: 70,
                                  backgroundColor:
                                      order.deliveryStatus?.displayColor(
                                        context,
                                      ) ??
                                      Colors.white,
                                  child: const Icon(
                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              ...List.generate(order.lineItems.length, (index) {
                                final item = order.lineItems[index];
                                final avatarWidget = ClipRRect(
                                  borderRadius: BorderRadius.circular(40.0),
                                  child: FluxImage(
                                    imageUrl:
                                        item.featuredImage ?? kDefaultImage,
                                    height: 80,
                                    width: 80,
