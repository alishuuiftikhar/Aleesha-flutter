...
import 'package:henox/controller/dashboard/second_dashboard_controller.dart';
...
class _SecondDashboardScreenState extends State<SecondDashboardScreen> with UIMixin {
  SecondDashboardController controller = Get.put(SecondDashboardController());
  ...
  Widget build(BuildContext context) {
    return Layout(
      child: GetBuilder(
        init: controller,
        tag: 'second_dashboard_controller',
        builder: (controller) {
          return Column(
            ...
            children: [
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    MyText.titleMedium("Dashboard 2", fontSize: 18, fontWeight: 600),
                    MyBreadcrumb(
                      children: [
                        MyBreadcrumbItem(name: 'Apps'),
                        MyBreadcrumbItem(name: 'Dashboard 2'),
                      ],
                    ),
                  ],
                ),
              ...
              Padding(
                ...
                child: MyFlex(
                  children: [
                    MyFlexItem(
                        sizes: 'xxl-2 xl-2 lg-4 md-6 xs-12', child: preloaderStates("CUSTOMERS", numberFormatter('54214'), LucideIcons.arrow_up, "2541", LucideIcons.users, contentTheme.success)),
                    MyFlexItem(
                        sizes: 'xxl-2 xl-2 lg-4 md-6 xs-12',
                        child: preloaderStates("ORDERS", numberFormatter('7543'), LucideIcons.arrow_down, " 1.08%", LucideIcons.shopping_basket, contentTheme.info)),
                    MyFlexItem(
                        sizes: 'xxl-2 xl-2 lg-4 md-6 xs-12',
                        child: preloaderStates("REVENUE", "\$${numberFormatter('9254')}", LucideIcons.arrow_down, " 7.00%", Remix.money_dollar_circle_line, contentTheme.danger)),
                    MyFlexItem(sizes: 'xxl-2 xl-2 lg-4 md-6 xs-12', child: preloaderStates("GROWTH", '+ 20.6%', LucideIcons.arrow_up, "4.87%", Remix.donut_chart_line, contentTheme.primary)),
                    MyFlexItem(sizes: 'xxl-2 xl-2 lg-4 md-6 xs-12', child: preloaderStates("CONVERSATION", '9.62%', LucideIcons.arrow_up, "3.07%", LucideIcons.users, contentTheme.warning)),
                    MyFlexItem(sizes: 'xxl-2 xl-2 lg-4 md-6 xs-12', child: preloaderStates("BALANCE", '\$168.5k', LucideIcons.arrow_up, "18.34%", Remix.wallet_3_line, contentTheme.secondary)),
    ...
    Widget totalSalesProcess(String name, double progress, String salesCount) {
      return Column(
        ...
        children: [
          ...
          Row(
            children: [
              Expanded(child: MyProgressBar(width: 400, progress: progress, height: 4, radius: 4, inactiveColor: theme.dividerColor, activeColor: contentTheme.primary)),
              MySpacing.width(16),
  ...
  SfCircularChart totalSalesChart() {
    return SfCircularChart(legend: Legend(overflowMode: LegendItemOverflowMode.wrap), series: controller.salesChart(), tooltipBehavior: controller.tooltipBehavior);
  }
    ...
    return MyCard(
      ...
      child: Row(
        ...
        children: [
          ...
          MyContainer(height: 40, width: 40, clipBehavior: Clip.antiAliasWithSaveLayer, paddingAll: 0, borderRadiusAll: 8, color: color, child: Icon(icon, color: contentTheme.onPrimary))
        ],
      ),
    );
  }
