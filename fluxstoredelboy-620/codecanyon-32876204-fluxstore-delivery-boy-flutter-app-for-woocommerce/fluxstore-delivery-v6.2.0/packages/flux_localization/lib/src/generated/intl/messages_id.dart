...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m2(length) =>
      "Media berhasil ditambahkan ke playlist. ${length} item baru ditambahkan.";

  static String m3(attribute) => "Setiap ${attribute}";

  static String m4(point) => "Poin yang tersedia: ${point}";

  static String m5(name) => "Berhasil mengajukan tawaran untuk \'${name}\'";

  static String m6(id) => "Pemesanan #${id}";

  static String m7(date) => "Pemesanan diminta pada: ${date}";

  static String m8(amount) => "Beli sekarang seharga ${amount}";

  static String m9(author) => "Oleh: ${author}";

  static String m10(fieldName) =>
      "${fieldName} tidak boleh kurang dari 3 karakter";

  static String m11(currency) => "Mata uang diubah menjadi ${currency}";

  static String m12(number) => "Tersisa ${number} karakter";

  static String m13(date) => "Check-in: ${date}";

  static String m14(date) => "Check-out: ${date}";

  static String m15(priceRate, pointRate) => "${priceRate} = ${pointRate} Poin";

  static String m16(count) => "${count} Tamu";

  static String m17(count) => "${count} Tamu";

  static String m18(count) => "${count} barang";

  static String m19(count) => "${count} barang";

  static String m20(count) => "${count} produk";

  static String m21(count) => "${count} produk";

  static String m22(count) => "${count} Tiket";

  static String m23(count) => "${count} Tiket";

  static String m24(country) => "${country} tidak didukung";

  static String m25(currency) => "${currency} tidak didukung";
  ...
  static String m29(captcha) => "Masukkan ${captcha} untuk mengonfirmasi:";

  static String m30(message) => "Error: ${message}";

  static String m31(message) => "Kesalahan: ${message}";

  static String m32(error) => "Terjadi kesalahan: ${error}";

  static String m33(date) => "Tanggal Acara: ${date}";

  static String m34(time) => "Berakhir dalam ${time}";
  ...
  static String m39(size) => "Ukuran file maksimum: ${size} MB";

  static String m40(count) => "Maksimal ${count} tamu diizinkan";

  static String m41(maxQuantity) =>
      "Jumlah maksimum yang diizinkan di keranjang adalah ${maxQuantity}";
  ...
  static String m44(count) => "Minimal ${count} karakter diperlukan";
  ...
  static String m46(day) => "Masa inap minimum adalah ${day} hari";
  ...
  static String m49(count) => "Minimal ${count} tamu diperlukan";

  static String m50(store) => "Lainnya dari ${store}";

  static String m51(number) => "Harus dibeli dalam kelompok ${number}";

  static String m52(itemCount) => "${itemCount} item";

  static String m53(amount) => "Bayar ${amount}";

  static String m54(date) => "Pembayaran jatuh tempo: ${date}";

  static String m55(name) => "${name} berhasil ditambahkan ke keranjang";

  static String m56(total) => "Jumlah: ${total}";

  static String m57(name) => "Menerima uang dari ${name}";

  static String m58(count) =>
      "Apakah Anda ingin menghapus ${count} item dari daftar keinginan?";

  static String m59(percent) => "Diskon ${percent}%";

  static String m60(keyword, count) => "${keyword} (${count} barang)";

  static String m61(keyword, count) => "${keyword} (${count} barang)";
  ...
  static String m64(price) => "Mulai dari ${price}";

  static String m65(fieldName) => "Bidang ${fieldName} wajib diisi";

  static String m66(total) => "${total} produk";

  static String m67(name) => "Transfer uang ke ${name}";

  static String m68(price) => "Hingga ${price}";

  static String m69(amount) => "Gunakan ${amount} poin";
  ...
  static String m71(time) => "Berlaku sampai: ${time}";

  static String m72(date) => "Berlaku hingga ${date}";

  static String m73(number) => "Versi ${number}";

  static String m74(balance) => "Saldo dompet: ${balance}";

  static String m75(message) => "Peringatan: ${message}";
  ...
  static String m79(count) => "Anda memilih ${count} item";

  static String m80(type) => "Anda telah melewati ${type}";

  static String m81(point) => "Anda memiliki ${point} poin";

  static String m82(price) => "Anda menghemat ${price}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "addMediaToPlaylistFailed": MessageLookupByLibrary.simpleMessage(
      "Gagal menambahkan media ke playlist.",
    ),
    "addMediaToPlaylistSuccess": MessageLookupByLibrary.simpleMessage(
      "Media berhasil ditambahkan ke playlist.",
    ),
    ...
    "auctionItemDidNotMakeItToReservePrice":
        MessageLookupByLibrary.simpleMessage(
          "Barang lelang tidak mencapai harga cadangan",
        ),
    ...
    "bookingDate": MessageLookupByLibrary.simpleMessage("Tanggal Pemesanan"),
    "bookingDeletedSuccessfully": MessageLookupByLibrary.simpleMessage(
      "Pemesanan berhasil dihapus",
    ),
    "bookingDetails": MessageLookupByLibrary.simpleMessage("Detail Pemesanan"),
    "bookingHistory": MessageLookupByLibrary.simpleMessage("Riwayat Pemesanan"),
    "bookingID": m6,
    "bookingLocation": MessageLookupByLibrary.simpleMessage("Lokasi Pemesanan"),
    ...
    "cancelBooking": MessageLookupByLibrary.simpleMessage("Batalkan Pemesanan"),
    ...
    "cannotGetPaymentURL": MessageLookupByLibrary.simpleMessage(
      "Tidak dapat mengambil URL pembayaran",
    ),
    ...
    "catalogVisibilityTooltip": MessageLookupByLibrary.simpleMessage(
      "Pengaturan ini menentukan halaman toko mana tempat produk akan ditampilkan.",
    ),
    ...
    "characterRemain": m12,
    "chargeBack": MessageLookupByLibrary.simpleMessage("Penarikan Kembali"),
    ...
    "createIndex": MessageLookupByLibrary.simpleMessage("Buat Indeks"),
    ...
    "deleteBooking": MessageLookupByLibrary.simpleMessage("Hapus Pemesanan"),
    ...
    "featureImage": MessageLookupByLibrary.simpleMessage("Gambar Unggulan"),
    ...
    "finalCost": MessageLookupByLibrary.simpleMessage("Biaya akhir"),
    ...
    "instantBooking": MessageLookupByLibrary.simpleMessage("Pemesanan Instan"),
    ...
    "messageToListingOwner": MessageLookupByLibrary.simpleMessage(
      "Pesan singkat Anda untuk pemilik listing (opsional)",
    ),
    ...
    "missingFirestoreIndexDescription": MessageLookupByLibrary.simpleMessage(
      "Kueri ini memerlukan indeks. Silakan masuk ke konsol Firebase dan buat indeks dengan mengklik tombol di bawah. Anda perlu menunggu sebentar hingga indeks diaktifkan.",
    ),
    "missingFirestoreIndexTitle": MessageLookupByLibrary.simpleMessage(
      "Indeks Firestore hilang terdeteksi!",
    ),
    ...
    "noMembershipPlans": MessageLookupByLibrary.simpleMessage(
      "Tidak ada paket keanggotaan yang tersedia",
    ),
    ...
    "onHold": MessageLookupByLibrary.simpleMessage("Ditahan"),
    ...
    "pleaseAdjustYourCart": MessageLookupByLibrary.simpleMessage(
      "Silakan sesuaikan keranjang Anda sebelum melanjutkan ke pembayaran.",
    ),
    ...
    "quoteLabel": MessageLookupByLibrary.simpleMessage("Penawaran"),
    ...
    "reversed": MessageLookupByLibrary.simpleMessage("Dibalikkan"),
    ...
    "saleToDateCannotBeEarlier": MessageLookupByLibrary.simpleMessage(
      "Tanggal berakhir diskon tidak boleh lebih awal dari tanggal mulai diskon.",
    ),
    ...
    "scheduleSale": MessageLookupByLibrary.simpleMessage("Jadwalkan Diskon"),
    ...
    "thisIsSealedBidAuction": MessageLookupByLibrary.simpleMessage(
      "Ini adalah lelang penawaran tertutup.",
    ),
