...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m2(length) =>
      "Media lisätty soittolistaan. ${length} uutta kohdetta lisätty.";

  static String m3(attribute) => "Mikä tahansa ${attribute}";

  static String m4(point) => "Käytettävissä olevat pisteet: ${point}";

  static String m5(name) =>
      "Tarjous kohteelle \'${name}\' tehtiin onnistuneesti.";

  static String m6(id) => "Varaus #${id}";

  static String m7(date) => "Varauspyyntö tehty: ${date}";

  static String m8(amount) => "Osta nyt hintaan ${amount}";

  static String m9(author) => "Kirjoittanut: ${author}";

  static String m10(fieldName) =>
      "${fieldName} ei voi olla lyhyempi kuin 3 merkkiä.";

  static String m11(currency) => "Valuutta vaihdettu: ${currency}";

  static String m12(number) => "${number} merkkiä jäljellä";

  static String m13(date) => "Sisäänkirjautuminen: ${date}";

  static String m14(date) => "Uloskirjautuminen: ${date}";

  static String m15(priceRate, pointRate) =>
      "${priceRate} = ${pointRate} pistettä";

  static String m16(count) => "${count} vieras";

  static String m17(count) => "${count} vierasta";

  static String m18(count) => "${count} tuote";

  static String m19(count) => "${count} tuotetta";

  static String m20(count) => "${count} tuote";

  static String m21(count) => "${count} tuotetta";

  static String m22(count) => "${count} lippu";

  static String m23(count) => "${count} lippua";

  static String m24(country) => "Maa ${country} ei ole tuettu";

  static String m25(currency) => "Valuuttaa ${currency} ei tueta";
  ...
  static String m28(timeLeft) => "Päättyy ${timeLeft}";

  static String m29(captcha) => "Vahvista kirjoittamalla ${captcha}:";

  static String m30(message) => "Virhe: ${message}";

  static String m31(message) => "Virhe: ${message}";

  static String m32(error) => "Tapahtui virhe: ${error}";

  static String m33(date) => "Tapahtumapäivä: ${date}";

  static String m34(time) => "Vanhenee ${time} kuluttua";
  ...
  static String m39(size) => "Tiedoston enimmäiskoko: ${size} Mt";

  static String m40(count) => "Enintään ${count} vierasta sallittu";

  static String m41(maxQuantity) =>
      "Ostoskoriin sallittu enimmäismäärä on ${maxQuantity}";
  ...
  static String m44(count) => "Vähintään ${count} merkkiä vaaditaan";
  ...
  static String m46(day) => "Vähimmäismajoitus on ${day} päivää";

  static String m47(amount) =>
      "Tämä kuponki vaatii vähintään ${amount} ostoksen.";

  static String m48(value) => "Minimitapahtuma: ${value}";

  static String m49(count) => "Vähintään ${count} vierasta vaaditaan";

  static String m50(store) => "Lisää kaupasta ${store}";

  static String m51(number) => "Täytyy ostaa ${number} kappaleen ryhmissä";

  static String m52(itemCount) => "${itemCount} kohdetta";

  static String m53(amount) => "Maksa ${amount}";

  static String m54(date) => "Maksu erääntyy: ${date}";

  static String m55(name) => "${name} lisätty ostoskoriin";

  static String m56(total) => "Määrä: ${total}";

  static String m57(name) => "Vastaanotettu rahaa käyttäjältä ${name}";

  static String m58(count) =>
      "Haluatko poistaa ${count} tuotetta toivelistalta?";

  static String m59(percent) => "Ale ${percent}%";

  static String m60(keyword, count) => "${keyword} (${count} tulos)";

  static String m61(keyword, count) => "${keyword} (${count} tulosta)";

  static String m62(totalCartQuantity) =>
      "Ostoskori, ${totalCartQuantity} tuotetta";

  static String m63(numberOfUnitsSold) => "Myyty: ${numberOfUnitsSold}";

  static String m64(price) => "Alkaen ${price}";

  static String m65(fieldName) => "Kenttä ${fieldName} on pakollinen";

  static String m66(total) => "${total} tuotetta";

  static String m67(name) => "Siirrä rahaa käyttäjälle ${name}";

  static String m68(price) => "Jopa ${price}";

  static String m69(amount) => "Käytä ${amount} pistettä";
  ...
  static String m71(time) => "Voimassa asti: ${time}";

  static String m72(date) => "Voimassa ${date} asti";

  static String m73(number) => "Versio ${number}";

  static String m74(balance) => "Lompakon saldo: ${balance}";

  static String m75(message) => "Varoitus: ${message}";
  ...
  static String m77(week) => "Viikko ${week}";

  static String m78(name) => "Tervetuloa ${name}";

  static String m79(count) => "Olet valitsemassa ${count} tuotetta";

  static String m80(type) => "Olet ohittanut ${type}";

  static String m81(point) => "Sinulla on ${point} pistettä";

  static String m82(price) => "Säästit ${price}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "auctionItemDidNotMakeItToReservePrice":
        MessageLookupByLibrary.simpleMessage(
          "Kohde ei saavuttanut varaushintaa huutokaupassa",
        ),
    ...
    "cancelBooking": MessageLookupByLibrary.simpleMessage("Peruuta varaus"),
    "cancelBookingFailed": MessageLookupByLibrary.simpleMessage(
      "Varausta ei voitu peruuttaa.",
    ),
    ...
    "cannotGetPaymentURL": MessageLookupByLibrary.simpleMessage(
      "Maksun URL-osoitetta ei voitu hakea",
    ),
    ...
    "catalogVisibilityTooltip": MessageLookupByLibrary.simpleMessage(
      "Tämä asetus määrittää, millä kauppasivuilla tuotteet näytetään.",
    ),
    ...
    "characterRemain": m12,
    "chargeBack": MessageLookupByLibrary.simpleMessage("Takaisinperintä"),
    ...
    "continueAsGuest": MessageLookupByLibrary.simpleMessage("Jatka vieraana"),
    ...
    "couponRemove": MessageLookupByLibrary.simpleMessage(
      "Kuponki poistettu onnistuneesti",
    ),
    ...
    "createIndex": MessageLookupByLibrary.simpleMessage("Luo indeksi"),
    ...
    "deleteBooking": MessageLookupByLibrary.simpleMessage("Poista varaus"),
    ...
    "denied": MessageLookupByLibrary.simpleMessage("Hylätty"),
    ...
    "failed": MessageLookupByLibrary.simpleMessage("Epäonnistui"),
    "failedToCreateReview": MessageLookupByLibrary.simpleMessage(
      "Arvostelun luominen epäonnistui",
    ),
    ...
    "featureImage": MessageLookupByLibrary.simpleMessage("Pääkuva"),
    ...
    "finalCost": MessageLookupByLibrary.simpleMessage("Lopullinen hinta"),
    ...
    "getTicket": MessageLookupByLibrary.simpleMessage("Hanki lippu"),
    ...
    "hidden": MessageLookupByLibrary.simpleMessage("Piilotettu"),
    ...
    "instantBooking": MessageLookupByLibrary.simpleMessage("Välitön varaus"),
    ...
    "messageToListingOwner": MessageLookupByLibrary.simpleMessage(
      "Lyhyt viestisi ilmoituksen omistajalle (valinnainen)",
    ),
    ...
    "missingFirestoreIndexDescription": MessageLookupByLibrary.simpleMessage(
      "Tämä kysely vaatii indeksin. Kirjaudu Firebase-konsoliin ja luo indeksi napsauttamalla alla olevaa painiketta. Sinun täytyy odottaa hetki, että se otetaan käyttöön.",
    ),
    "missingFirestoreIndexTitle": MessageLookupByLibrary.simpleMessage(
      "Puuttuva Firestore-indeksi havaittu!",
    ),
    ...
    "noMembershipPlans": MessageLookupByLibrary.simpleMessage(
      "Jäsenyysvaihtoehtoja ei ole saatavilla",
    ),
    ...
    "onHold": MessageLookupByLibrary.simpleMessage("Pidossa"),
    ...
    "pendingPayment": MessageLookupByLibrary.simpleMessage("Maksu odottaa"),
    ...
    "pleaseAdjustYourCart": MessageLookupByLibrary.simpleMessage(
      "Muokkaa ostoskoria ennen kassalle siirtymistä.",
    ),
    ...
    "processed": MessageLookupByLibrary.simpleMessage("Käsitelty"),
    ...
    "quantityMustBeGreaterThanZero": MessageLookupByLibrary.simpleMessage(
      "Määrän on oltava suurempi kuin nolla",
    ),
    "quantityProductExceedInStock": MessageLookupByLibrary.simpleMessage(
      "Valittu määrä ylittää varastosaldon",
    ),
    "quoteLabel": MessageLookupByLibrary.simpleMessage("Tarjouspyyntö"),
    ...
    "refunded": MessageLookupByLibrary.simpleMessage("Hyvitetty"),
    ...
    "reversed": MessageLookupByLibrary.simpleMessage("Peruutettu"),
    ...
    "sale": m59,
    "saleFromDate": MessageLookupByLibrary.simpleMessage("Alennus alkaen"),
    "salePrice": MessageLookupByLibrary.simpleMessage("Alennushinta"),
    "saleToDate": MessageLookupByLibrary.simpleMessage("Alennus asti"),
    "saleToDateCannotBeEarlier": MessageLookupByLibrary.simpleMessage(
      "Alennuksen loppupäivä ei voi olla aikaisempi kuin alkamispäivä.",
    ),
    ...
    "scheduleSale": MessageLookupByLibrary.simpleMessage("Alennuksen ajastus"),
    ...
    "shopOnly": MessageLookupByLibrary.simpleMessage("Vain kauppa"),
    ...
    "thisIsSealedBidAuction": MessageLookupByLibrary.simpleMessage(
      "Tämä on suljettu tarjoushuutokauppa.",
    ),
    ...
    "totalCost": MessageLookupByLibrary.simpleMessage("Kokonaishinta"),
    ...
    "voided": MessageLookupByLibrary.simpleMessage("Mitätöity"),
    ...
    "writeTitleOptional": MessageLookupByLibrary.simpleMessage(
      "Kirjoita otsikkosi (valinnainen)",
    ),
    ...
    "yourRating": MessageLookupByLibrary.simpleMessage("Arviosi"),
