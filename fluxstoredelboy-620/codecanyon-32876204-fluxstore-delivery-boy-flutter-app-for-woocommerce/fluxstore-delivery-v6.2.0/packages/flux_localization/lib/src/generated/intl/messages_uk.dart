...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m2(length) =>
      "Медіа додано до плейлиста. Додано ${length} нових елемент(ів).";

  static String m3(attribute) => "Будь-який ${attribute}";

  static String m4(point) => "Доступні бали: ${point}";

  static String m5(name) => "Ставку на \'${name}\' успішно зроблено";

  static String m6(id) => "Бронювання №${id}";

  static String m7(date) => "Запит на бронювання: ${date}";

  static String m8(amount) => "Купити зараз за ${amount}";

  static String m9(author) => "Автор: ${author}";

  static String m10(fieldName) =>
      "${fieldName} не може бути коротшим за 3 символи";

  static String m11(currency) => "Валюта змінена на ${currency}";

  static String m12(number) => "Залишилось символів: ${number}";

  static String m13(date) => "Чек-ін: ${date}";

  static String m14(date) => "Чек-аут: ${date}";

  static String m15(priceRate, pointRate) =>
      "${priceRate} = ${pointRate} балів";

  static String m16(count) => "${count} гість";

  static String m17(count) => "${count} гості";

  static String m18(count) => "${count} товар";

  static String m19(count) => "${count} товарів";

  static String m20(count) => "${count} товар";

  static String m21(count) => "${count} товарів";

  static String m22(count) => "${count} квиток";

  static String m23(count) => "${count} квитки";

  static String m24(country) => "Країна ${country} не підтримується";

  static String m25(currency) => "${currency} не підтримується";
  ...
  static String m28(timeLeft) => "Закінчується через ${timeLeft}";

  static String m29(captcha) => "Введіть ${captcha} для підтвердження:";

  static String m30(message) => "Помилка: ${message}";

  static String m31(message) => "Помилка: ${message}";

  static String m32(error) => "Виникла помилка: ${error}";

  static String m33(date) => "Дата події: ${date}";

  static String m34(time) => "Закінчується через ${time}";
  ...
  static String m39(size) => "Максимальний розмір файлу: ${size} МБ";

  static String m40(count) => "Дозволено максимум ${count} гостей";

  static String m41(maxQuantity) =>
      "Максимальна дозволена кількість у кошику — ${maxQuantity}";
  ...
  static String m44(count) => "Потрібно щонайменше ${count} символів";
  ...
  static String m46(day) => "Мінімальний термін проживання — ${day} днів";

  static String m47(amount) =>
      "Цей купон вимагає мінімальної покупки на суму ${amount}.";

  static String m48(value) => "Мінімальна транзакція: ${value}";

  static String m49(count) => "Потрібно щонайменше ${count} гостя(ів)";

  static String m50(store) => "Більше від ${store}";

  static String m51(number) => "Необхідно купувати групами по ${number}";

  static String m52(itemCount) => "${itemCount} товарів";

  static String m53(amount) => "Оплатити ${amount}";

  static String m54(date) => "Оплата до: ${date}";

  static String m55(name) => "${name} успішно додано до кошика";

  static String m56(total) => "Кількість: ${total}";

  static String m57(name) => "Отримано кошти від ${name}";

  static String m58(count) =>
      "Бажаєте видалити ${count} товарів зі списку бажань?";

  static String m59(percent) => "Знижка ${percent}%";

  static String m60(keyword, count) => "${keyword} (${count} товар)";

  static String m61(keyword, count) => "${keyword} (${count} товарів)";

  static String m62(totalCartQuantity) => "Кошик, ${totalCartQuantity} товарів";

  static String m63(numberOfUnitsSold) => "Продано: ${numberOfUnitsSold}";

  static String m64(price) => "Від ${price}";

  static String m65(fieldName) => "Поле ${fieldName} є обов\'язковим";

  static String m66(total) => "${total} товарів";

  static String m67(name) => "Переказати кошти ${name}";

  static String m68(price) => "До ${price}";

  static String m69(amount) => "Використати ${amount} балів";
  ...
  static String m71(time) => "Дійсний до: ${time}";

  static String m72(date) => "Дійсний до ${date}";

  static String m73(number) => "Версія ${number}";

  static String m74(balance) => "Баланс гаманця: ${balance}";

  static String m75(message) => "Попередження: ${message}";
  ...
  static String m77(week) => "Тиждень ${week}";

  static String m78(name) => "Ласкаво просимо, ${name}";

  static String m79(count) => "Ви обираєте ${count} товарів";

  static String m80(type) => "Ви пройшли ${type}";

  static String m81(point) => "У вас є ${point} балів";

  static String m82(price) => "Ви заощадили ${price}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "auctionItemDidNotMakeItToReservePrice":
        MessageLookupByLibrary.simpleMessage(
          "Лот на аукціоні не досяг резервної ціни",
        ),
    ...
    "bookingDate": MessageLookupByLibrary.simpleMessage("Дата бронювання"),
    "bookingDeletedSuccessfully": MessageLookupByLibrary.simpleMessage(
      "Бронювання успішно видалено",
    ),
    "bookingDetails": MessageLookupByLibrary.simpleMessage("Деталі бронювання"),
    "bookingHistory": MessageLookupByLibrary.simpleMessage("Історія бронювань"),
    "bookingID": m6,
    "bookingLocation": MessageLookupByLibrary.simpleMessage("Місце бронювання"),
    ...
    "cannotGetPaymentURL": MessageLookupByLibrary.simpleMessage(
      "Не вдалося отримати URL для оплати",
    ),
    ...
    "catalogVisibilityTooltip": MessageLookupByLibrary.simpleMessage(
      "Цей параметр визначає, на яких сторінках магазину буде показано товари.",
    ),
    ...
    "characterRemain": m12,
    "chargeBack": MessageLookupByLibrary.simpleMessage("Повернення коштів"),
    ...
    "confirmDeleteBooking": MessageLookupByLibrary.simpleMessage(
      "Ви впевнені, що хочете видалити це бронювання?",
    ),
    ...
    "createIndex": MessageLookupByLibrary.simpleMessage("Створити індекс"),
    ...
    "denied": MessageLookupByLibrary.simpleMessage("Відхилено"),
    ...
    "eventsCategories": MessageLookupByLibrary.simpleMessage("Категорії подій"),
    ...
    "featureImage": MessageLookupByLibrary.simpleMessage("Головне зображення"),
    ...
    "finalCost": MessageLookupByLibrary.simpleMessage("Підсумкова вартість"),
    ...
    "getTicket": MessageLookupByLibrary.simpleMessage("Отримати квиток"),
    ...
    "haveACoupon": MessageLookupByLibrary.simpleMessage("Є купон?"),
    ...
    "messageToListingOwner": MessageLookupByLibrary.simpleMessage(
      "Ваше коротке повідомлення власнику оголошення (необов’язково)",
    ),
    ...
    "missingFirestoreIndexDescription": MessageLookupByLibrary.simpleMessage(
      "Цей запит вимагає індексу. Будь ласка, увійдіть у консоль Firebase і створіть індекс, натиснувши кнопку нижче. Потрібно трохи зачекати, поки він стане доступним.",
    ),
    "missingFirestoreIndexTitle": MessageLookupByLibrary.simpleMessage(
      "Виявлено відсутній індекс Firestore!",
    ),
    ...
    "noMembershipPlans": MessageLookupByLibrary.simpleMessage(
      "Немає доступних планів підписки",
    ),
    ...
    "onHold": MessageLookupByLibrary.simpleMessage("На утриманні"),
    ...
    "pendingPayment": MessageLookupByLibrary.simpleMessage("Очікує на оплату"),
    ...
    "pleaseAdjustYourCart": MessageLookupByLibrary.simpleMessage(
      "Будь ласка, змініть вміст кошика перед оформленням замовлення.",
    ),
    ...
    "processed": MessageLookupByLibrary.simpleMessage("Оброблено"),
    ...
    "quoteLabel": MessageLookupByLibrary.simpleMessage("Запит ціни"),
    ...
    "refunded": MessageLookupByLibrary.simpleMessage("Повернено"),
    ...
    "reversed": MessageLookupByLibrary.simpleMessage("Скасовано"),
    ...
    "shopOnly": MessageLookupByLibrary.simpleMessage("Лише магазин"),
    ...
    "thisIsSealedBidAuction": MessageLookupByLibrary.simpleMessage(
      "Це аукціон із закритими ставками.",
    ),
    ...
    "totalCost": MessageLookupByLibrary.simpleMessage("Загальна вартість"),
    ...
    "voided": MessageLookupByLibrary.simpleMessage("Анульовано"),
    ...
    "writeTitleOptional": MessageLookupByLibrary.simpleMessage(
      "Введіть заголовок (необов’язково)",
    ),
    ...
    "yourRating": MessageLookupByLibrary.simpleMessage("Ваша оцінка"),
