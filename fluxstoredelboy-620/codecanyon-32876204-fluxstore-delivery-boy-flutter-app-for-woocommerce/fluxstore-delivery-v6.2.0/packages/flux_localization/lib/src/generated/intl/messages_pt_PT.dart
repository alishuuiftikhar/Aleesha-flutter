...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m2(length) =>
      "Multimédia adicionada à lista de reprodução. ${length} novo(s) item(ns) adicionado(s).";

  static String m3(attribute) => "Qualquer ${attribute}";

  static String m4(point) => "Os seus pontos disponíveis: ${point}";

  static String m5(name) => "Lance feito com sucesso para \'${name}\'";

  static String m6(id) => "Reserva #${id}";

  static String m7(date) => "Reserva solicitada em: ${date}";

  static String m8(amount) => "Compre agora por ${amount}";
  ...
  static String m11(currency) => "Moeda alterada para ${currency}";

  static String m12(number) => "${number} caracteres restantes";
  ...
  static String m16(count) => "${count} Hóspede";

  static String m17(count) => "${count} Hóspedes";

  static String m18(count) => "${count} item";

  static String m19(count) => "${count} itens";

  static String m20(count) => "${count} item";

  static String m21(count) => "${count} itens";

  static String m22(count) => "${count} Bilhete";

  static String m23(count) => "${count} Bilhetes";

  static String m24(country) => "O país ${country} não é suportado";

  static String m25(currency) => "${currency} não é suportado";
  ...
  static String m28(timeLeft) => "Termina em ${timeLeft}";

  static String m29(captcha) => "Introduza ${captcha} para confirmar:";

  static String m30(message) => "Erro: ${message}";

  static String m31(message) => "Erro: ${message}";

  static String m32(error) => "Ocorreu um erro: ${error}";

  static String m33(date) => "Data do Evento: ${date}";

  static String m34(time) => "A expirar em ${time}";
  ...
  static String m39(size) => "Tamanho máximo do ficheiro: ${size} MB";

  static String m40(count) => "São permitidos no máximo ${count} hóspedes";

  static String m41(maxQuantity) =>
      "A quantidade máxima permitida no carrinho é ${maxQuantity}";
  ...
  static String m44(count) => "São necessários no mínimo ${count} caracteres";

  static String m45(storeName, minOrderAmount) => "";

  static String m46(day) => "A estadia mínima é de ${day} dias";

  static String m47(amount) => "";

  static String m48(value) => "";

  static String m49(count) => "É necessário um mínimo de ${count} hóspede(s)";

  static String m50(store) => "Mais de ${store}";

  static String m51(number) => "Deve ser comprado em grupos de ${number}";

  static String m52(itemCount) => "${itemCount} itens";

  static String m53(amount) => "Pagar ${amount}";

  static String m54(date) => "Pagamento até: ${date}";

  static String m55(name) => "${name} foi adicionado ao carrinho com sucesso";

  static String m56(total) => "Qtd: ${total}";

  static String m57(name) => "Recebeu dinheiro de ${name}";

  static String m58(count) =>
      "Pretende remover ${count} item(ns) da sua lista de desejos?";

  static String m59(percent) => "Desconto ${percent}%";

  static String m60(keyword, count) => "${keyword} (${count} item)";

  static String m61(keyword, count) => "${keyword} (${count} itens)";

  static String m62(totalCartQuantity) =>
      "Carrinho de compras, ${totalCartQuantity} itens";

  static String m63(numberOfUnitsSold) => "Vendido: ${numberOfUnitsSold}";

  static String m64(price) => "A partir de ${price}";

  static String m65(fieldName) => "O campo ${fieldName} é obrigatório";

  static String m66(total) => "${total} produtos";

  static String m67(name) => "Transferir dinheiro para ${name}";

  static String m68(price) => "Até ${price}";

  static String m69(amount) => "Use ${amount} pontos";
  ...
  static String m72(date) => "Válido até ${date}";

  static String m73(number) => "Versão ${number}";

  static String m74(balance) => "Saldo da carteira: ${balance}";

  static String m75(message) => "Aviso: ${message}";
  ...
  static String m77(week) => "Semana ${week}";

  static String m78(name) => "Bem-vindo ${name}";

  static String m79(count) => "Está a selecionar ${count} item(ns)";

  static String m80(type) => "";

  static String m81(point) => "Tem ${point} pontos";

  static String m82(price) => "Poupa ${price}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "addMediaToPlaylist": MessageLookupByLibrary.simpleMessage(
      "Adicionar multimédia à lista de reprodução",
    ),
    "addMediaToPlaylistFailed": MessageLookupByLibrary.simpleMessage(
      "Falha ao adicionar multimédia à lista de reprodução.",
    ),
    "addMediaToPlaylistSuccess": MessageLookupByLibrary.simpleMessage(
      "Multimédia adicionada à lista de reprodução com sucesso.",
    ),
    ...
    "approvedPaid": MessageLookupByLibrary.simpleMessage("Aprovado - Pago"),
    ...
    "auctionItemDidNotMakeItToReservePrice":
        MessageLookupByLibrary.simpleMessage(
          "O artigo do leilão não atingiu o preço de reserva",
        ),
    ...
    "bookingDate": MessageLookupByLibrary.simpleMessage("Data da Reserva"),
    ...
    "bookingID": m6,
    "bookingLocation": MessageLookupByLibrary.simpleMessage("Local da Reserva"),
    ...
    "cancelBooking": MessageLookupByLibrary.simpleMessage("Cancelar Reserva"),
    ...
    "cannotGetPaymentURL": MessageLookupByLibrary.simpleMessage(
      "Não foi possível obter o URL de pagamento",
    ),
    ...
    "catalogVisibilityTooltip": MessageLookupByLibrary.simpleMessage(
      "Esta definição determina em que páginas da loja os produtos serão apresentados.",
    ),
    ...
    "characterRemain": m12,
    "chargeBack": MessageLookupByLibrary.simpleMessage("Estorno"),
    ...
    "confirmDeleteBooking": MessageLookupByLibrary.simpleMessage(
      "Tem a certeza de que pretende eliminar esta reserva?",
    ),
    ...
    "createIndex": MessageLookupByLibrary.simpleMessage("Criar Índice"),
    ...
    "denied": MessageLookupByLibrary.simpleMessage("Recusado"),
    ...
    "featureImage": MessageLookupByLibrary.simpleMessage("Imagem em Destaque"),
    ...
    "finalCost": MessageLookupByLibrary.simpleMessage("Custo final"),
    ...
    "getTicket": MessageLookupByLibrary.simpleMessage("Obter Bilhete"),
    ...
    "haveACoupon": MessageLookupByLibrary.simpleMessage("Tem um cupão?"),
    ...
    "instantBooking": MessageLookupByLibrary.simpleMessage("Reserva imediata"),
    ...
    "invalidBooking": MessageLookupByLibrary.simpleMessage("Reserva inválida."),
    ...
    "messageToListingOwner": MessageLookupByLibrary.simpleMessage(
      "A sua mensagem curta para o proprietário do anúncio (opcional)",
    ),
    ...
    "missingFirestoreIndexDescription": MessageLookupByLibrary.simpleMessage(
      "Esta pesquisa requer um índice. Por favor, inicie sessão na consola do Firebase e crie o índice clicando no botão abaixo. Terá de aguardar um momento até que seja ativado.",
    ),
    "missingFirestoreIndexTitle": MessageLookupByLibrary.simpleMessage(
      "Índice do Firestore em falta detetado!",
    ),
    ...
    "noMembershipPlans": MessageLookupByLibrary.simpleMessage(
      "Não há planos de subscrição disponíveis",
    ),
    ...
    "onHold": MessageLookupByLibrary.simpleMessage("Em Espera"),
    ...
    "pleaseAdjustYourCart": MessageLookupByLibrary.simpleMessage(
      "Por favor, ajuste o seu carrinho antes de finalizar a compra.",
    ),
    ...
    "quoteLabel": MessageLookupByLibrary.simpleMessage("Pedido de orçamento"),
    ...
    "reservePriceHasBeenMet": MessageLookupByLibrary.simpleMessage(
      "O preço de reserva foi atingido",
    ),
    "reservePriceHasNotBeenMet": MessageLookupByLibrary.simpleMessage(
      "O preço de reserva não foi atingido",
    ),
    ...
    "reversed": MessageLookupByLibrary.simpleMessage("Revertido"),
    ...
    "saleToDateCannotBeEarlier": MessageLookupByLibrary.simpleMessage(
      "A data de fim da promoção não pode ser anterior à data de início da promoção.",
    ),
    ...
    "scheduleSale": MessageLookupByLibrary.simpleMessage("Agendar promoção"),
    ...
    "thisIsSealedBidAuction": MessageLookupByLibrary.simpleMessage(
      "Este é um leilão de propostas fechadas.",
    ),
    ...
    "waitingOwnerConfirmation": MessageLookupByLibrary.simpleMessage(
      "A aguardar confirmação do proprietário",
    ),
    ...
    "yourRating": MessageLookupByLibrary.simpleMessage("A sua Avaliação"),
