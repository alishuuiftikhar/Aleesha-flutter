...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m16(count) => "${count} host";

  static String m17(count) => "${count} hostů";

  static String m18(count) => "${count} položka";

  static String m19(count) => "${count} položek";

  static String m20(count) => "${count} položka";

  static String m21(count) => "${count} položek";

  static String m22(count) => "${count} vstupenka";

  static String m23(count) => "${count} vstupenky";

  static String m24(country) => "Země ${country} není podporována";

  static String m25(currency) => "Měna ${currency} není podporována";
  ...
  static String m29(captcha) => "Pro potvrzení zadejte ${captcha}:";

  static String m30(message) => "Chyba: ${message}";

  static String m31(message) => "Chyba: ${message}";

  static String m32(error) => "Došlo k chybě: ${error}";

  static String m33(date) => "Datum akce: ${date}";

  static String m34(time) => "Končí za ${time}";
  ...
  static String m39(size) => "Maximální velikost souboru: ${size} MB";

  static String m40(count) => "Povoleno maximálně ${count} hostů";
  ...
  static String m44(count) => "Je vyžadováno minimálně ${count} znaků";
  ...
  static String m46(day) => "Minimální délka pobytu je ${day} dní";

  static String m47(amount) =>
      "Tento kupón vyžaduje minimální nákup v hodnotě ${amount}.";

  static String m48(value) => "Minimální transakce: ${value}";

  static String m49(count) => "Vyžadováno minimálně ${count} hostů";

  static String m50(store) => "Další od ${store}";

  static String m51(number) => "Musí být zakoupeno v množství po ${number}";

  static String m52(itemCount) => "Položky: ${itemCount}";

  static String m53(amount) => "Zaplatit ${amount}";

  static String m54(date) => "Platba do: ${date}";

  static String m55(name) => "Produkt ${name} byl přidán do košíku";

  static String m56(total) => "Množství: ${total}";

  static String m57(name) => "Přijaty peníze od uživatele ${name}";

  static String m58(count) =>
      "Chcete odebrat položky (celkem ${count}) ze seznamu přání?";

  static String m59(percent) => "Sleva ${percent}%";

  static String m60(keyword, count) => "${keyword} (${count} položka)";

  static String m61(keyword, count) => "${keyword} (${count} položek)";

  static String m62(totalCartQuantity) =>
      "Nákupní košík, ${totalCartQuantity} položek";

  static String m63(numberOfUnitsSold) => "Prodáno: ${numberOfUnitsSold}";

  static String m64(price) => "Začíná od ${price}";

  static String m65(fieldName) => "Pole ${fieldName} je povinné";

  static String m66(total) => "${total} produktů";

  static String m67(name) => "Převést peníze uživateli ${name}";

  static String m68(price) => "Až do ${price}";

  static String m69(amount) => "Použijte ${amount} bodů";
  ...
  static String m73(number) => "Verze ${number}";

  static String m74(balance) => "Zůstatek v peněžence: ${balance}";

  static String m75(message) => "Upozornění: ${message}";
  ...
  static String m77(week) => "Týden ${week}";

  static String m78(name) => "Vítejte, ${name}";

  static String m79(count) => "Vybíráte položky (celkem ${count})";

  static String m80(type) => "Splnili jste ${type}";

  static String m81(point) => "Máte ${point} bodů";

  static String m82(price) => "Ušetřili jste ${price}";
