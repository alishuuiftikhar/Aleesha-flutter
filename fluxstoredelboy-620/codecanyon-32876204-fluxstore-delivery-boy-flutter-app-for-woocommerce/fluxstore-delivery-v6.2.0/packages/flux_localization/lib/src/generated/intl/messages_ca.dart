...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m2(length) =>
      "El contingut multimèdia s\'ha afegit a la llista de reproducció. S\'han afegit ${length} element(s) nou(s).";

  static String m3(attribute) => "Qualsevol ${attribute}";

  static String m4(point) => "Els teus punts disponibles: ${point}";

  static String m5(name) => "Oferta realitzada amb èxit per \'${name}\'";

  static String m6(id) => "Reserva #${id}";

  static String m7(date) => "Reserva sol·licitada el: ${date}";

  static String m8(amount) => "Compra ara per ${amount}";
  ...
  static String m11(currency) => "S\'ha canviat la moneda a ${currency}";

  static String m12(number) => " Queden${number} caràcters";
  ...
  static String m16(count) => "${count} convidat";

  static String m17(count) => "${count} convidats";

  static String m18(count) => "${count} element";

  static String m19(count) => "${count} elements";

  static String m20(count) => "${count} element";

  static String m21(count) => "${count} elements";

  static String m22(count) => "${count} entrada";

  static String m23(count) => "${count} entrades";

  static String m24(country) => "El país ${country} no està suportat";

  static String m25(currency) => "${currency} no està suportat";
  ...
  static String m28(timeLeft) => "Acaba en ${timeLeft}";

  static String m29(captcha) => "Introdueix ${captcha} per confirmar:";

  static String m30(message) => "Error: ${message}";

  static String m31(message) => "Error: ${message}";

  static String m32(error) => "S\'ha produït un error: ${error}";

  static String m33(date) => "Data de l\'esdeveniment: ${date}";

  static String m34(time) => "Caduca en ${time}";

  static String m35(total) => "Més de ${total} km";
  ...
  static String m39(size) => "Mida màxima del fitxer: ${size} MB";

  static String m40(count) => "Es permet un màxim de ${count} hostes";

  static String m41(maxQuantity) =>
      "La quantitat màxima permesa al carretó és ${maxQuantity}";
  ...
  static String m44(count) => "Es requereixen un mínim de ${count} caràcters";
  ...
  static String m46(day) => "L\'estada mínima és de ${day} dies";

  static String m47(amount) =>
      "Aquest cupó requereix una compra mínima de ${amount}.";

  static String m48(value) => "Transacció mínima: ${value}";

  static String m49(count) => "Cal un mínim de ${count} hoste(s)";

  static String m50(store) => "Més de ${store}";

  static String m51(number) => "s\'ha de comprar en grups de ${number}";

  static String m52(itemCount) => "${itemCount} articles";

  static String m53(amount) => "Pagar ${amount}";

  static String m54(date) => "Pagament pendent: ${date}";

  static String m55(name) => " S\'han afegit${name} al carretó correctament";

  static String m56(total) => "Quantitat: ${total}";

  static String m57(name) => "S\'ha rebut diners de ${name}";

  static String m58(count) =>
      "Vols eliminar ${count} element(s) de la teva llista de desitjos?";

  static String m59(percent) => "${percent}% de descompte";

  static String m60(keyword, count) => "${keyword} (${count} element)";

  static String m61(keyword, count) => "${keyword} (${count} elements)";

  static String m62(totalCartQuantity) =>
      "Carret de compra, ${totalCartQuantity} articles";

  static String m63(numberOfUnitsSold) => "Venut: ${numberOfUnitsSold}";

  static String m64(price) => "A partir de ${price}";

  static String m65(fieldName) => "El camp ${fieldName} és obligatori";

  static String m66(total) => "${total} productes";

  static String m67(name) => "Transfereix diners a ${name}";

  static String m68(price) => "Fins a ${price}";

  static String m69(amount) => "Utilitza ${amount} punts";
  ...
  static String m71(time) => "Vàlid fins: ${time}";

  static String m72(date) => "Vàlid fins al ${date}";

  static String m73(number) => "Versió ${number}";

  static String m74(balance) => "Saldo de Wallet: ${balance}";

  static String m75(message) => "Avís: ${message}";
  ...
  static String m77(week) => "Setmana ${week}";

  static String m78(name) => "Benvingut/da ${name}";

  static String m79(count) => "Estàs seleccionant ${count} element(s)";

  static String m80(type) => "Has superat ${type}";

  static String m81(point) => "Tens ${point} punts";

  static String m82(price) => "Has estalviat ${price}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "addMediaToPlaylist": MessageLookupByLibrary.simpleMessage(
      "Afegeix contingut multimèdia a la llista de reproducció",
    ),
    "addMediaToPlaylistFailed": MessageLookupByLibrary.simpleMessage(
      "No s\'ha pogut afegir el contingut multimèdia a la llista de reproducció.",
    ),
    "addMediaToPlaylistSuccess": MessageLookupByLibrary.simpleMessage(
      "El contingut multimèdia s\'ha afegit correctament a la llista de reproducció.",
    ),
    ...
    "approvedPaid": MessageLookupByLibrary.simpleMessage("Aprovat - Pagat"),
    ...
    "auctionItemDidNotMakeItToReservePrice":
        MessageLookupByLibrary.simpleMessage(
          "L\'article de la subhasta no ha arribat al preu de reserva",
        ),
    ...
    "bookingDate": MessageLookupByLibrary.simpleMessage("Data de la reserva"),
    ...
    "cancelBooking": MessageLookupByLibrary.simpleMessage("Cancel·lar reserva"),
    ...
    "cannotGetPaymentURL": MessageLookupByLibrary.simpleMessage(
      "No es pot obtenir l\'URL de pagament",
    ),
    ...
    "catalogVisibility": MessageLookupByLibrary.simpleMessage(
      "Visibilitat del catàleg",
    ),
    "catalogVisibilityTooltip": MessageLookupByLibrary.simpleMessage(
      "Aquesta configuració determina en quines pàgines de la botiga es mostraran els productes.",
    ),
    ...
    "characterRemain": m12,
    "chargeBack": MessageLookupByLibrary.simpleMessage("Reclamació de càrrec"),
    ...
    "continueToPreview": MessageLookupByLibrary.simpleMessage(
      "Continua a la previsualització",
    ),
    ...
    "createIndex": MessageLookupByLibrary.simpleMessage("Crear índex"),
    ...
    "deleteBooking": MessageLookupByLibrary.simpleMessage("Eliminar reserva"),
    "deleteBookingFailed": MessageLookupByLibrary.simpleMessage(
      "No s\'ha pogut suprimir la reserva.",
    ),
    ...
    "denied": MessageLookupByLibrary.simpleMessage("Denegat"),
    ...
    "failed": MessageLookupByLibrary.simpleMessage("Fallat"),
    "failedToCreateReview": MessageLookupByLibrary.simpleMessage(
      "No s\'ha pogut crear la ressenya",
    ),
    ...
    "featureImage": MessageLookupByLibrary.simpleMessage("Imatge destacada"),
    ...
    "getTicket": MessageLookupByLibrary.simpleMessage("Obtenir entrada"),
    ...
    "haveACoupon": MessageLookupByLibrary.simpleMessage("Tens un cupó?"),
    "haveYouGotQuestion": MessageLookupByLibrary.simpleMessage(
      "Tens alguna pregunta? Escriu-nos!",
    ),
    "hidden": MessageLookupByLibrary.simpleMessage("Ocult"),
    ...
    "messageToListingOwner": MessageLookupByLibrary.simpleMessage(
      "El teu missatge breu al propietari de l\'anunci (opcional)",
    ),
    ...
    "missingFirestoreIndexDescription": MessageLookupByLibrary.simpleMessage(
      "Aquesta consulta requereix un índex. Inicieu sessió a la consola de Firebase i creeu l\'índex fent clic al botó de sota. Cal esperar uns moments perquè s\'activi.",
    ),
    "missingFirestoreIndexTitle": MessageLookupByLibrary.simpleMessage(
      "S\'ha detectat un índex de Firestore que falta!",
    ),
    ...
    "network": MessageLookupByLibrary.simpleMessage("Xarxa"),
    ...
    "noMembershipPlans": MessageLookupByLibrary.simpleMessage(
      "No hi ha plans de subscripció disponibles",
    ),
    ...
    "onHold": MessageLookupByLibrary.simpleMessage("En espera"),
    ...
    "pendingPayment": MessageLookupByLibrary.simpleMessage("Pagament pendent"),
    ...
    "pleaseAdjustYourCart": MessageLookupByLibrary.simpleMessage(
      "Si us plau, ajusta el teu carret abans de finalitzar la compra.",
    ),
    ...
    "processed": MessageLookupByLibrary.simpleMessage("Processat"),
    ...
    "quantityMustBeGreaterThanZero": MessageLookupByLibrary.simpleMessage(
      "La quantitat ha de ser superior a zero",
    ),
    "quantityProductExceedInStock": MessageLookupByLibrary.simpleMessage(
      "La quantitat actual és més gran que la quantitat en estoc",
    ),
    "quoteLabel": MessageLookupByLibrary.simpleMessage("Pressupost"),
    ...
    "refunded": MessageLookupByLibrary.simpleMessage("Reemborsat"),
    ...
    "reservePriceHasBeenMet": MessageLookupByLibrary.simpleMessage(
      "S\'ha assolit el preu de reserva",
    ),
    "reservePriceHasNotBeenMet": MessageLookupByLibrary.simpleMessage(
      "No s\'ha assolit el preu de reserva",
    ),
    ...
    "reversed": MessageLookupByLibrary.simpleMessage("Revertit"),
    ...
    "scheduleSale": MessageLookupByLibrary.simpleMessage("Programar oferta"),
    ...
    "shopOnly": MessageLookupByLibrary.simpleMessage("Només botiga"),
    ...
    "thisIsSealedBidAuction": MessageLookupByLibrary.simpleMessage(
      "Aquesta és una subhasta de sobres tancats.",
    ),
    ...
    "voided": MessageLookupByLibrary.simpleMessage("Anul·lat"),
    ...
    "waitingOwnerConfirmation": MessageLookupByLibrary.simpleMessage(
      "Esperant confirmació del propietari",
    ),
    ...
    "yourRating": MessageLookupByLibrary.simpleMessage("La teva valoració"),
