...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m16(count) => "${count} oaspete";

  static String m17(count) => "${count} oaspeți";

  static String m18(count) => "${count} articol";

  static String m19(count) => "${count} articole";

  static String m20(count) => "${count} produs";

  static String m21(count) => "${count} produse";

  static String m22(count) => "${count} bilet";

  static String m23(count) => "${count} bilete";

  static String m24(country) => "Țara ${country} nu este acceptată";

  static String m25(currency) => "${currency} nu este acceptată";
  ...
  static String m28(timeLeft) => "Se termină în ${timeLeft}";

  static String m29(captcha) => "Introdu ${captcha} pentru a confirma:";

  static String m30(message) => "Eroare: ${message}";

  static String m31(message) => "Eroare: ${message}";

  static String m32(error) => "A apărut o eroare: ${error}";

  static String m33(date) => "Data evenimentului: ${date}";

  static String m34(time) => "Expiră în ${time}";
  ...
  static String m39(size) => "Dimensiune maximă fișier: ${size} MB";

  static String m40(count) => "Sunt permise maximum ${count} persoane";
  ...
  static String m44(count) => "Sunt necesare minimum ${count} caractere";
  ...
  static String m46(day) => "Sejurul minim este de ${day} zile";

  static String m47(amount) =>
      "Acest cupon necesită o achiziție minimă de ${amount}.";

  static String m48(value) => "Tranzacție minimă: ${value}";

  static String m49(count) => "Este necesar un minim de ${count} persoană(e)";

  static String m50(store) => "Mai multe de la ${store}";

  static String m51(number) => "Trebuie cumpărat în grupuri de ${number}";

  static String m52(itemCount) => "${itemCount} articole";

  static String m53(amount) => "Plătește ${amount}";

  static String m54(date) => "Plata scadentă: ${date}";

  static String m55(name) => "${name} a fost adăugat în coș cu succes";

  static String m56(total) => "Cantitate: ${total}";

  static String m57(name) => "A primit bani de la ${name}";

  static String m58(count) =>
      "Vrei să elimini ${count} produs(e) din lista ta de dorințe?";

  static String m59(percent) => "Reducere ${percent}%";

  static String m60(keyword, count) => "${keyword} (${count} articol)";

  static String m61(keyword, count) => "${keyword} (${count} articole)";

  static String m62(totalCartQuantity) =>
      "Coș de cumpărături, ${totalCartQuantity} articole";

  static String m63(numberOfUnitsSold) => "Vândut: ${numberOfUnitsSold}";

  static String m64(price) => "Începând de la ${price}";

  static String m65(fieldName) => "Câmpul ${fieldName} este obligatoriu";

  static String m66(total) => "${total} produse";

  static String m67(name) => "Transferă bani către ${name}";

  static String m68(price) => "Până la ${price}";

  static String m69(amount) => "Folosiți ${amount} puncte";
  ...
  static String m71(time) => "Valabil până la: ${time}";

  static String m72(date) => "Valabil până la ${date}";

  static String m73(number) => "Versiunea ${number}";

  static String m74(balance) => "Sold portofel: ${balance}";

  static String m75(message) => "Atenție: ${message}";
  ...
  static String m77(week) => "Săptămâna ${week}";

  static String m78(name) => "Bun venit, ${name}";

  static String m79(count) => "Selectezi ${count} produs(e)";

  static String m80(type) => "Ai trecut de ${type}";

  static String m81(point) => "Ai ${point} puncte";

  static String m82(price) => "Ai economisit ${price}";
