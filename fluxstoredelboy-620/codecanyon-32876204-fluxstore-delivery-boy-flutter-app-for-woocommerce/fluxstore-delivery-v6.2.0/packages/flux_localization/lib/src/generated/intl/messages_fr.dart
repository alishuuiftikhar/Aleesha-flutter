...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m2(length) =>
      "Média ajouté à la playlist. ${length} nouvel(s) élément(s) ajouté(s).";

  static String m3(attribute) => "Tout ${attribute}";

  static String m4(point) => "Vos points disponibles : ${point}";

  static String m5(name) =>
      "Une enchère a été placée avec succès pour « ${name} ».";

  static String m6(id) => "Réservation n°${id}";

  static String m7(date) => "Réservation demandée le : ${date}";

  static String m8(amount) => "Achetez maintenant pour ${amount}";

  static String m9(author) => "Par ${author}";

  static String m10(fieldName) =>
      "La longueur de ${fieldName} ne doit pas être inférieure à 3 caractères.";

  static String m11(currency) => "Devise changée en ${currency}";

  static String m12(number) => "${number} caractères restants";

  static String m13(date) => "Arrivée : ${date}";

  static String m14(date) => "Départ : ${date}";

  static String m15(priceRate, pointRate) =>
      "${priceRate} = ${pointRate} points";

  static String m16(count) => "${count} invité";

  static String m17(count) => "${count} invités";

  static String m18(count) => "${count} article";

  static String m19(count) => "${count} articles";

  static String m20(count) => "${count} article";

  static String m21(count) => "${count} articles";

  static String m22(count) => "${count} billet";

  static String m23(count) => "${count} billets";

  static String m24(country) => "${country} n\'est pas pris en charge";

  static String m25(currency) => "${currency} n\'est pas pris en charge";
  ...
  static String m28(timeLeft) => "Se termine dans ${timeLeft}";

  static String m29(captcha) => "Saisissez ${captcha} pour confirmer :";

  static String m30(message) => "Erreur : ${message}";

  static String m31(message) => "Erreur : ${message}";

  static String m32(error) => "Une erreur est survenue : ${error}";

  static String m33(date) => "Date de l\'événement : ${date}";

  static String m34(time) => "Expire dans ${time}";
  ...
  static String m39(size) => "Taille maximale du fichier : ${size} Mo";

  static String m40(count) => "${count} invités maximum autorisés";

  static String m41(maxQuantity) =>
      "La quantité maximale autorisée dans le panier est de ${maxQuantity}";
  ...
  static String m44(count) => "Au moins ${count} caractères requis";
  ...
  static String m46(day) => "Le séjour minimum est de ${day} jours";

  static String m47(amount) =>
      "Ce coupon nécessite un achat minimum de ${amount}.";

  static String m48(value) => "Transaction minimale : ${value}";

  static String m49(count) => "${count} invité(s) minimum requis";

  static String m50(store) => "Plus de ${store}";

  static String m51(number) => "Doit être acheté par groupes de ${number}";

  static String m52(itemCount) => "${itemCount} articles";

  static String m53(amount) => "Payer ${amount}";

  static String m54(date) => "Paiement dû le : ${date}";

  static String m55(name) => "${name} a été ajouté au panier avec succès";

  static String m56(total) => "Qté : ${total}";

  static String m57(name) => "Reçu de l\'argent de ${name}";

  static String m58(count) =>
      "Voulez-vous retirer ${count} article(s) de votre liste de souhaits ?";

  static String m59(percent) => "Remise ${percent}%";

  static String m60(keyword, count) => "${keyword} (${count} article)";

  static String m61(keyword, count) => "${keyword} (${count} articles)";

  static String m62(totalCartQuantity) =>
      "Panier, ${totalCartQuantity} articles";

  static String m63(numberOfUnitsSold) => "Vendu : ${numberOfUnitsSold}";

  static String m64(price) => "À partir de ${price}";

  static String m65(fieldName) => "Le champ ${fieldName} est obligatoire";

  static String m66(total) => "${total} produits";

  static String m67(name) => "Transférer de l\'argent à ${name}";

  static String m68(price) => "Jusqu\'à ${price}";

  static String m69(amount) => "Utilisez ${amount} points";
  ...
  static String m71(time) => "Valable jusqu\'au : ${time}";

  static String m72(date) => "Valable jusqu\'au ${date}";

  static String m73(number) => "Version ${number}";

  static String m74(balance) => "Solde du portefeuille : ${balance}";

  static String m75(message) => "Attention : ${message}";
  ...
  static String m77(week) => "Semaine ${week}";

  static String m78(name) => "Bienvenue ${name}";

  static String m79(count) => "Vous sélectionnez ${count} article(s)";

  static String m80(type) => "Vous avez réussi ${type}";

  static String m81(point) => "Vous avez ${point} points";

  static String m82(price) => "Vous avez économisé ${price}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "approvedPaid": MessageLookupByLibrary.simpleMessage("Approuvé - Payé"),
    ...
    "auctionItemDidNotMakeItToReservePrice":
        MessageLookupByLibrary.simpleMessage(
          "L’objet de la vente aux enchères n’a pas atteint le prix de réserve",
        ),
    ...
    "bookingDate": MessageLookupByLibrary.simpleMessage("Date de réservation"),
    ...
    "catalogVisibilityTooltip": MessageLookupByLibrary.simpleMessage(
      "Ce paramètre détermine sur quelles pages de la boutique les produits seront affichés.",
    ),
    ...
    "characterRemain": m12,
    "chargeBack": MessageLookupByLibrary.simpleMessage("Rétrofacturation"),
    ...
    "createIndex": MessageLookupByLibrary.simpleMessage("Créer un index"),
    ...
    "denied": MessageLookupByLibrary.simpleMessage("Refusé"),
    ...
    "failedToCreateReview": MessageLookupByLibrary.simpleMessage(
      "Échec de la création de l’avis",
    ),
    ...
    "featureImage": MessageLookupByLibrary.simpleMessage("Image à la une"),
    ...
    "finalCost": MessageLookupByLibrary.simpleMessage("Coût final"),
    ...
    "getTicket": MessageLookupByLibrary.simpleMessage("Obtenir le billet"),
    ...
    "messageToListingOwner": MessageLookupByLibrary.simpleMessage(
      "Votre court message au propriétaire de l’annonce (facultatif)",
    ),
    ...
    "missingFirestoreIndexDescription": MessageLookupByLibrary.simpleMessage(
      "Cette requête nécessite un index. Veuillez vous connecter à la console Firebase et créer l’index en cliquant sur le bouton ci-dessous. Vous devez attendre un instant pour qu’il soit activé.",
    ),
    "missingFirestoreIndexTitle": MessageLookupByLibrary.simpleMessage(
      "Index Firestore manquant détecté !",
    ),
    ...
    "onHold": MessageLookupByLibrary.simpleMessage("En attente"),
    ...
    "paymentCancelled": MessageLookupByLibrary.simpleMessage("Paiement annulé"),
    ...
    "pleaseAdjustYourCart": MessageLookupByLibrary.simpleMessage(
      "Veuillez ajuster votre panier avant de passer à la caisse.",
    ),
    ...
    "quoteLabel": MessageLookupByLibrary.simpleMessage("Devis"),
    ...
    "refunded": MessageLookupByLibrary.simpleMessage("Remboursé"),
    ...
    "reservePriceHasBeenMet": MessageLookupByLibrary.simpleMessage(
      "Le prix de réserve a été atteint",
    ),
    ...
    "reversed": MessageLookupByLibrary.simpleMessage("Annulé"),
    ...
    "saleToDateCannotBeEarlier": MessageLookupByLibrary.simpleMessage(
      "La date de fin de la vente ne peut pas être antérieure à la date de début de la vente.",
    ),
    ...
    "scheduleSale": MessageLookupByLibrary.simpleMessage("Programmer la vente"),
    ...
    "shopAndSearchResults": MessageLookupByLibrary.simpleMessage(
      "Boutique et résultats de recherche",
    ),
    ...
    "shopOnly": MessageLookupByLibrary.simpleMessage("Boutique uniquement"),
    ...
    "thisIsSealedBidAuction": MessageLookupByLibrary.simpleMessage(
      "Ceci est une vente aux enchères à offres scellées.",
    ),
    ...
    "verifiedListing": MessageLookupByLibrary.simpleMessage("Annonce vérifiée"),
    ...
    "voided": MessageLookupByLibrary.simpleMessage("Annulé"),
