...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m2(length) =>
      "Medie blev tilføjet til playlisten. ${length} nyt/nye element(er) tilføjet.";

  static String m3(attribute) => "Enhver ${attribute}";

  static String m4(point) => "Dine tilgængelige point: ${point}";

  static String m5(name) => "Bud afgivet på \'${name}\'";

  static String m6(id) => "Booking #${id}";

  static String m7(date) => "Booking anmodet den: ${date}";

  static String m8(amount) => "Køb nu for ${amount}";

  static String m9(author) => "Af: ${author}";

  static String m10(fieldName) =>
      "${fieldName} må ikke være kortere end 3 tegn";

  static String m11(currency) => "Ændrede valuta til ${currency}";

  static String m12(number) => "${number} tegn tilbage";
  ...
  static String m16(count) => "${count} gæst";

  static String m17(count) => "${count} gæster";

  static String m18(count) => "${count} vare";

  static String m19(count) => "${count} varer";

  static String m20(count) => "${count} vare";

  static String m21(count) => "${count} varer";

  static String m22(count) => "${count} billet";

  static String m23(count) => "${count} billetter";

  static String m24(country) => "${country} understøttes ikke";

  static String m25(currency) => "${currency} understøttes ikke";
  ...
  static String m28(timeLeft) => "Slutter om ${timeLeft}";

  static String m29(captcha) => "Indtast ${captcha} for at bekræfte:";

  static String m30(message) => "Fejl: ${message}";

  static String m31(message) => "Fejl: ${message}";

  static String m32(error) => "Der opstod en fejl: ${error}";

  static String m33(date) => "Eventdato: ${date}";

  static String m34(time) => "Udløber om ${time}";
  ...
  static String m39(size) => "Maksimal filstørrelse: ${size} MB";

  static String m40(count) => "Maksimalt ${count} gæster tilladt";

  static String m41(maxQuantity) =>
      "Maksimalt tilladte antal i kurven er ${maxQuantity}";
  ...
  static String m44(count) => "Minimum ${count} tegn kræves";
  ...
  static String m46(day) => "Minimumsophold er ${day} dage";

  static String m47(amount) =>
      "Denne kupon kræver et minimumskøb på ${amount}.";

  static String m48(value) => "Minimumstransaktion: ${value}";

  static String m49(count) => "Minimum ${count} gæst(er) påkrævet";

  static String m50(store) => "Mere fra ${store}";

  static String m51(number) => "Skal købes i grupper af ${number}";

  static String m52(itemCount) => "${itemCount} elementer";

  static String m53(amount) => "Betal ${amount}";

  static String m54(date) => "Betaling forfalder: ${date}";

  static String m55(name) => "${name} er blevet tilføjet til indkøbskurven";

  static String m56(total) => "Antal: ${total}";

  static String m57(name) => "Modtog penge fra ${name}";

  static String m58(count) =>
      "Vil du fjerne ${count} vare(r) fra din ønskeliste?";

  static String m59(percent) => "Udsalg ${percent}%";

  static String m60(keyword, count) => "${keyword} (${count} vare)";

  static String m61(keyword, count) => "${keyword} (${count} varer)";

  static String m62(totalCartQuantity) =>
      "Indkøbskurv, ${totalCartQuantity} varer";

  static String m63(numberOfUnitsSold) => "Solgt: ${numberOfUnitsSold}";

  static String m64(price) => "Starter fra ${price}";

  static String m65(fieldName) => "Feltet ${fieldName} er påkrævet";

  static String m66(total) => "${total} produkter";

  static String m67(name) => "Overfør penge til ${name}";

  static String m68(price) => "Op til ${price}";

  static String m69(amount) => "Brug ${amount} point";
  ...
  static String m71(time) => "Gyldig indtil: ${time}";

  static String m72(date) => "Gyldig til ${date}";

  static String m73(number) => "Version ${number}";

  static String m74(balance) => "Saldo: ${balance}";

  static String m75(message) => "Advarsel: ${message}";
  ...
  static String m77(week) => "Uge ${week}";

  static String m78(name) => "Velkommen ${name}";

  static String m79(count) => "Du vælger ${count} vare(r)";

  static String m80(type) => "Du har bestået ${type}";

  static String m81(point) => "Du har ${point} point";

  static String m82(price) => "Du sparede ${price}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "approvedPaid": MessageLookupByLibrary.simpleMessage("Godkendt - betalt"),
    ...
    "auctionItemDidNotMakeItToReservePrice":
        MessageLookupByLibrary.simpleMessage(
          "Auktionsvaren nåede ikke reservationsprisen",
        ),
    ...
    "cancelBooking": MessageLookupByLibrary.simpleMessage("Annuller booking"),
    "cancelBookingFailed": MessageLookupByLibrary.simpleMessage(
      "Det lykkedes ikke at annullere bookingen.",
    ),
    ...
    "catalogVisibilityTooltip": MessageLookupByLibrary.simpleMessage(
      "Denne indstilling bestemmer, hvilke butikssider produkterne vises på.",
    ),
    ...
    "characterRemain": m12,
    "chargeBack": MessageLookupByLibrary.simpleMessage("Tilbagebetaling"),
    ...
    "completed": MessageLookupByLibrary.simpleMessage("Fuldført"),
    ...
    "continueAsGuest": MessageLookupByLibrary.simpleMessage("Fortsæt som gæst"),
    ...
    "couponRemove": MessageLookupByLibrary.simpleMessage("Kupon blev fjernet"),
    ...
    "createIndex": MessageLookupByLibrary.simpleMessage("Opret indeks"),
    ...
    "deleteBooking": MessageLookupByLibrary.simpleMessage("Slet booking"),
    "deleteBookingFailed": MessageLookupByLibrary.simpleMessage(
      "Det lykkedes ikke at slette bookingen.",
    ),
    ...
    "denied": MessageLookupByLibrary.simpleMessage("Afvist"),
    ...
    "featureImage": MessageLookupByLibrary.simpleMessage("Fremhævet billede"),
    ...
    "finalCost": MessageLookupByLibrary.simpleMessage("Endelig pris"),
    ...
    "getTicket": MessageLookupByLibrary.simpleMessage("Få billet"),
    ...
    "haveACoupon": MessageLookupByLibrary.simpleMessage("Har du en kupon?"),
    ...
    "invalidBooking": MessageLookupByLibrary.simpleMessage("Ugyldig booking."),
    ...
    "messageToListingOwner": MessageLookupByLibrary.simpleMessage(
      "Din korte besked til annonceejeren (valgfrit)",
    ),
    ...
    "missingFirestoreIndexDescription": MessageLookupByLibrary.simpleMessage(
      "Denne forespørgsel kræver et indeks. Log ind på Firebase-konsollen og opret indekset ved at klikke på knappen nedenfor. Du skal vente et øjeblik, før det bliver aktiveret.",
    ),
    "missingFirestoreIndexTitle": MessageLookupByLibrary.simpleMessage(
      "Mangler Firestore-indeks!",
    ),
    ...
    "noMembershipPlans": MessageLookupByLibrary.simpleMessage(
      "Ingen medlemskabsplaner tilgængelige",
    ),
    ...
    "onHold": MessageLookupByLibrary.simpleMessage("Sat på pause"),
    ...
    "pendingPayment": MessageLookupByLibrary.simpleMessage("Afventer betaling"),
    ...
    "pleaseAdjustYourCart": MessageLookupByLibrary.simpleMessage(
      "Justér venligst din kurv, før du går til betaling.",
    ),
    ...
    "quantityMustBeGreaterThanZero": MessageLookupByLibrary.simpleMessage(
      "Antallet skal være større end nul",
    ),
    "quantityProductExceedInStock": MessageLookupByLibrary.simpleMessage(
      "Den aktuelle mængde overstiger lagerbeholdningen",
    ),
    "quoteLabel": MessageLookupByLibrary.simpleMessage("Tilbud"),
    ...
    "refunded": MessageLookupByLibrary.simpleMessage("Refunderet"),
    ...
    "reversed": MessageLookupByLibrary.simpleMessage("Tilbageført"),
    ...
    "sale": m59,
    "saleFromDate": MessageLookupByLibrary.simpleMessage("Udsalg fra dato"),
    "salePrice": MessageLookupByLibrary.simpleMessage("Udsalgspris"),
    "saleToDate": MessageLookupByLibrary.simpleMessage("Udsalg til dato"),
    "saleToDateCannotBeEarlier": MessageLookupByLibrary.simpleMessage(
      "Udsalgets slutdato kan ikke være tidligere end udsalgets startdato.",
    ),
    ...
    "scheduleSale": MessageLookupByLibrary.simpleMessage("Planlæg udsalg"),
    ...
    "totalCost": MessageLookupByLibrary.simpleMessage("Samlet pris"),
    ...
    "voided": MessageLookupByLibrary.simpleMessage("Annulleret"),
    ...
    "yourRating": MessageLookupByLibrary.simpleMessage("Din bedømmelse"),
