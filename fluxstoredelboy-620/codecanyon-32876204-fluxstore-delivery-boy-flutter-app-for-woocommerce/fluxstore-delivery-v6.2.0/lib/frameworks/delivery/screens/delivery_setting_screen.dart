...
class _DeliverySettingScreenState extends State<DeliverySettingScreen>
  ...
  void updateDeliveryStatus() {
    ...
    EasyDebounce.debounce(
      ...
      () {
        services.setOffTime(user.cookie!, user.isDriverAvailable ?? false).then(
          (value) {
            if (value != 200) {
              user.isDriverAvailable = !user.isDriverAvailable!;
              setState(() {});
      ...
      body: SizedBox(
        ...
        child: Stack(
          children: [
            Card(
              elevation: 20,
              shadowColor: Colors.grey.withValueOpacity(0.1),
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    /// This option not support WCFM platform
            ...
            Column(
              children: [
                    ...
                    child: Consumer<DeliveryAuthenticationModel>(
                      builder: (_, model, __) => CircleAvatar(
                        ...
                        backgroundImage: NetworkImage(
                          model.user?.picture ?? kDefaultImage,
                        ),
                      ),
                    ),
                  ),
                ...
                Consumer<DeliveryAuthenticationModel>(
                  builder: (_, model, __) =>
                      model.state == DeliveryAuthenticationModelState.loggedIn
                      ? Center(
                          child: Text(
